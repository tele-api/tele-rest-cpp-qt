...
/*
 * OAIBusinessConnection.h
 *
 * Describes the connection of the bot with a business account.
 */

#ifndef OAIBusinessConnection_H
#define OAIBusinessConnection_H
...
namespace tele_rest {
class OAIUser;
class OAIBusinessBotRights;

class OAIBusinessConnection : public OAIObject {
public:
    OAIBusinessConnection();
    OAIBusinessConnection(QString json);
    ~OAIBusinessConnection() override;
    ...
    OAIBusinessBotRights getRights() const;
    void setRights(const OAIBusinessBotRights &rights);
...
Q_DECLARE_METATYPE(tele_rest::OAIBusinessConnection)

#endif // OAIBusinessConnection_H
