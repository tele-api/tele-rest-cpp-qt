...
/*
 * OAISetGameScoreRequest.h
 *
 * Request parameters for setGameScore
 */

#ifndef OAISetGameScoreRequest_H
#define OAISetGameScoreRequest_H
...
class OAISetGameScoreRequest : public OAIObject {
public:
    OAISetGameScoreRequest();
    OAISetGameScoreRequest(QString json);
    ~OAISetGameScoreRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetGameScoreRequest)

#endif // OAISetGameScoreRequest_H
