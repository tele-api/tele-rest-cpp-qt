...
/*
 * OAISendVideoRequest.h
 *
 * Request parameters for sendVideo
 */

#ifndef OAISendVideoRequest_H
#define OAISendVideoRequest_H
...
class OAISendVideoRequest : public OAIObject {
public:
    OAISendVideoRequest();
    OAISendVideoRequest(QString json);
    ~OAISendVideoRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendVideoRequest)

#endif // OAISendVideoRequest_H
