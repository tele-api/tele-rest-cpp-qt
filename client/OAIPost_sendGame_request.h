...
/*
 * OAIPost_sendGame_request.h
 *
 * 
 */

#ifndef OAIPost_sendGame_request_H
#define OAIPost_sendGame_request_H
...
class OAIPost_sendGame_request : public OAIObject {
public:
    OAIPost_sendGame_request();
    OAIPost_sendGame_request(QString json);
    ~OAIPost_sendGame_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendGame_request)

#endif // OAIPost_sendGame_request_H
