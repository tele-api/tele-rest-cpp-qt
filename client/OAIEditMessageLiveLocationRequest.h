...
/*
 * OAIEditMessageLiveLocationRequest.h
 *
 * Request parameters for editMessageLiveLocation
 */

#ifndef OAIEditMessageLiveLocationRequest_H
#define OAIEditMessageLiveLocationRequest_H
...
class OAIEditMessageLiveLocationRequest : public OAIObject {
public:
    OAIEditMessageLiveLocationRequest();
    OAIEditMessageLiveLocationRequest(QString json);
    ~OAIEditMessageLiveLocationRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIEditMessageLiveLocationRequest)

#endif // OAIEditMessageLiveLocationRequest_H
