...
/*
 * OAIPost_createInvoiceLink_request.h
 *
 * 
 */

#ifndef OAIPost_createInvoiceLink_request_H
#define OAIPost_createInvoiceLink_request_H
...
class OAIPost_createInvoiceLink_request : public OAIObject {
public:
    OAIPost_createInvoiceLink_request();
    OAIPost_createInvoiceLink_request(QString json);
    ~OAIPost_createInvoiceLink_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_createInvoiceLink_request)

#endif // OAIPost_createInvoiceLink_request_H
