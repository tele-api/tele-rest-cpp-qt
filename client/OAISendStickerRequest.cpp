...
#include "OAISendStickerRequest.h"
...
OAISendStickerRequest::OAISendStickerRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendStickerRequest::OAISendStickerRequest() {
    this->initializeModel();
}

OAISendStickerRequest::~OAISendStickerRequest() {}

void OAISendStickerRequest::initializeModel() {
...
void OAISendStickerRequest::fromJson(QString jsonString) {
...
void OAISendStickerRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendStickerRequest::asJson() const {
...
QJsonObject OAISendStickerRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAISendStickerRequest::getChatId() const {
    return m_chat_id;
}
void OAISendStickerRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendStickerRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendStickerRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAISendStickerRequest::getSticker() const {
    return m_sticker;
}
void OAISendStickerRequest::setSticker(const QString &sticker) {
    m_sticker = sticker;
    m_sticker_isSet = true;
}

bool OAISendStickerRequest::is_sticker_Set() const{
    return m_sticker_isSet;
}

bool OAISendStickerRequest::is_sticker_Valid() const{
    return m_sticker_isValid;
}

QString OAISendStickerRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAISendStickerRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAISendStickerRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAISendStickerRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAISendStickerRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendStickerRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendStickerRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendStickerRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAISendStickerRequest::getEmoji() const {
    return m_emoji;
}
void OAISendStickerRequest::setEmoji(const QString &emoji) {
    m_emoji = emoji;
    m_emoji_isSet = true;
}

bool OAISendStickerRequest::is_emoji_Set() const{
    return m_emoji_isSet;
}

bool OAISendStickerRequest::is_emoji_Valid() const{
    return m_emoji_isValid;
}

bool OAISendStickerRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendStickerRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendStickerRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendStickerRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendStickerRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendStickerRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendStickerRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendStickerRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendStickerRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendStickerRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendStickerRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendStickerRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendStickerRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendStickerRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendStickerRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendStickerRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendStickerRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendStickerRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendStickerRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendStickerRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAISendMessageRequest_reply_markup OAISendStickerRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAISendStickerRequest::setReplyMarkup(const OAISendMessageRequest_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAISendStickerRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAISendStickerRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAISendStickerRequest::isSet() const {
...
bool OAISendStickerRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_chat_id_isValid && m_sticker_isValid && true;
}
