...
/*
 * OAIPost_readBusinessMessage_request.h
 *
 * 
 */

#ifndef OAIPost_readBusinessMessage_request_H
#define OAIPost_readBusinessMessage_request_H
...
class OAIPost_readBusinessMessage_request : public OAIObject {
public:
    OAIPost_readBusinessMessage_request();
    OAIPost_readBusinessMessage_request(QString json);
    ~OAIPost_readBusinessMessage_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_readBusinessMessage_request)

#endif // OAIPost_readBusinessMessage_request_H
