...
/*
 * OAIEditMessageCaptionRequest.h
 *
 * Request parameters for editMessageCaption
 */

#ifndef OAIEditMessageCaptionRequest_H
#define OAIEditMessageCaptionRequest_H
...
class OAIEditMessageCaptionRequest : public OAIObject {
public:
    OAIEditMessageCaptionRequest();
    OAIEditMessageCaptionRequest(QString json);
    ~OAIEditMessageCaptionRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIEditMessageCaptionRequest)

#endif // OAIEditMessageCaptionRequest_H
