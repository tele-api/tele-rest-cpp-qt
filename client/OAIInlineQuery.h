...
public:
    ...
    QString getChatType() const;
    void setChatType(const QString &chat_type);
    bool is_chat_type_Set() const;
    bool is_chat_type_Valid() const;
...
private:
    ...
    QString m_chat_type;
    bool m_chat_type_isSet;
    bool m_chat_type_isValid;
...
Q_DECLARE_METATYPE(tele_rest::OAIInlineQuery)
