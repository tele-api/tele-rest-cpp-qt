...
#include "OAICopyMessagesRequest.h"
...
OAICopyMessagesRequest::OAICopyMessagesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyMessagesRequest::OAICopyMessagesRequest() {
    this->initializeModel();
}

OAICopyMessagesRequest::~OAICopyMessagesRequest() {}

void OAICopyMessagesRequest::initializeModel() {
...
void OAICopyMessagesRequest::fromJson(QString jsonString) {
...
void OAICopyMessagesRequest::fromJsonObject(QJsonObject json) {
...
QString OAICopyMessagesRequest::asJson() const {
...
QJsonObject OAICopyMessagesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAICopyMessagesRequest::getChatId() const {
    return m_chat_id;
}
void OAICopyMessagesRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAICopyMessagesRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAICopyMessagesRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

OAIForwardMessagesRequest_from_chat_id OAICopyMessagesRequest::getFromChatId() const {
    return m_from_chat_id;
}
void OAICopyMessagesRequest::setFromChatId(const OAIForwardMessagesRequest_from_chat_id &from_chat_id) {
    m_from_chat_id = from_chat_id;
    m_from_chat_id_isSet = true;
}

bool OAICopyMessagesRequest::is_from_chat_id_Set() const{
    return m_from_chat_id_isSet;
}

bool OAICopyMessagesRequest::is_from_chat_id_Valid() const{
    return m_from_chat_id_isValid;
}

QList<qint32> OAICopyMessagesRequest::getMessageIds() const {
    return m_message_ids;
}
void OAICopyMessagesRequest::setMessageIds(const QList<qint32> &message_ids) {
    m_message_ids = message_ids;
    m_message_ids_isSet = true;
}

bool OAICopyMessagesRequest::is_message_ids_Set() const{
    return m_message_ids_isSet;
}

bool OAICopyMessagesRequest::is_message_ids_Valid() const{
    return m_message_ids_isValid;
}

qint32 OAICopyMessagesRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAICopyMessagesRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAICopyMessagesRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAICopyMessagesRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

bool OAICopyMessagesRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAICopyMessagesRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAICopyMessagesRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAICopyMessagesRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAICopyMessagesRequest::isProtectContent() const {
    return m_protect_content;
}
void OAICopyMessagesRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAICopyMessagesRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAICopyMessagesRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAICopyMessagesRequest::isRemoveCaption() const {
    return m_remove_caption;
}
void OAICopyMessagesRequest::setRemoveCaption(const bool &remove_caption) {
    m_remove_caption = remove_caption;
    m_remove_caption_isSet = true;
}

bool OAICopyMessagesRequest::is_remove_caption_Set() const{
    return m_remove_caption_isSet;
}

bool OAICopyMessagesRequest::is_remove_caption_Valid() const{
    return m_remove_caption_isValid;
}

bool OAICopyMessagesRequest::isSet() const {
...
bool OAICopyMessagesRequest::isValid() const {
