...
/*
 * OAIGetGameHighScoresRequest.h
 *
 * Request parameters for getGameHighScores
 */

#ifndef OAIGetGameHighScoresRequest_H
#define OAIGetGameHighScoresRequest_H
...
class OAIGetGameHighScoresRequest : public OAIObject {
public:
    OAIGetGameHighScoresRequest();
    OAIGetGameHighScoresRequest(QString json);
    ~OAIGetGameHighScoresRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIGetGameHighScoresRequest)

#endif // OAIGetGameHighScoresRequest_H
