...
/*
 * OAISendVoiceRequest.h
 *
 * Request parameters for sendVoice
 */

#ifndef OAISendVoiceRequest_H
#define OAISendVoiceRequest_H
...
class OAISendVoiceRequest : public OAIObject {
public:
    OAISendVoiceRequest();
    OAISendVoiceRequest(QString json);
    ~OAISendVoiceRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendVoiceRequest)

#endif // OAISendVoiceRequest_H
