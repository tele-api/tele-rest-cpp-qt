...
/*
 * OAIPost_copyMessage_request.h
 *
 * 
 */

#ifndef OAIPost_copyMessage_request_H
#define OAIPost_copyMessage_request_H
...
class OAIPost_copyMessage_request : public OAIObject {
public:
    OAIPost_copyMessage_request();
    OAIPost_copyMessage_request(QString json);
    ~OAIPost_copyMessage_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_copyMessage_request)

#endif // OAIPost_copyMessage_request_H
