...
/*
 * OAIChatAdministratorRights.h
 *
 * Represents the rights of an administrator in a chat.
 */

#ifndef OAIChatAdministratorRights_H
#define OAIChatAdministratorRights_H
...
class OAIChatAdministratorRights : public OAIObject {
public:
    OAIChatAdministratorRights();
    OAIChatAdministratorRights(QString json);
    ~OAIChatAdministratorRights() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIChatAdministratorRights)

#endif // OAIChatAdministratorRights_H
