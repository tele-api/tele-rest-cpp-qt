...
#include "OAISendInvoiceRequest.h"
...
OAISendInvoiceRequest::OAISendInvoiceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendInvoiceRequest::OAISendInvoiceRequest() {
    this->initializeModel();
}

OAISendInvoiceRequest::~OAISendInvoiceRequest() {}

void OAISendInvoiceRequest::initializeModel() {
...
void OAISendInvoiceRequest::fromJson(QString jsonString) {
...
void OAISendInvoiceRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendInvoiceRequest::asJson() const {
...
QJsonObject OAISendInvoiceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAISendInvoiceRequest::getChatId() const {
    return m_chat_id;
}
void OAISendInvoiceRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendInvoiceRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendInvoiceRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAISendInvoiceRequest::getTitle() const {
    return m_title;
}
void OAISendInvoiceRequest::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAISendInvoiceRequest::is_title_Set() const{
    return m_title_isSet;
}

bool OAISendInvoiceRequest::is_title_Valid() const{
    return m_title_isValid;
}

QString OAISendInvoiceRequest::getDescription() const {
    return m_description;
}
void OAISendInvoiceRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAISendInvoiceRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAISendInvoiceRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAISendInvoiceRequest::getPayload() const {
    return m_payload;
}
void OAISendInvoiceRequest::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAISendInvoiceRequest::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAISendInvoiceRequest::is_payload_Valid() const{
    return m_payload_isValid;
}

QString OAISendInvoiceRequest::getCurrency() const {
    return m_currency;
}
void OAISendInvoiceRequest::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAISendInvoiceRequest::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAISendInvoiceRequest::is_currency_Valid() const{
    return m_currency_isValid;
}

QList<OAILabeledPrice> OAISendInvoiceRequest::getPrices() const {
    return m_prices;
}
void OAISendInvoiceRequest::setPrices(const QList<OAILabeledPrice> &prices) {
    m_prices = prices;
    m_prices_isSet = true;
}

bool OAISendInvoiceRequest::is_prices_Set() const{
    return m_prices_isSet;
}

bool OAISendInvoiceRequest::is_prices_Valid() const{
    return m_prices_isValid;
}

qint32 OAISendInvoiceRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendInvoiceRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendInvoiceRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendInvoiceRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAISendInvoiceRequest::getProviderToken() const {
    return m_provider_token;
}
void OAISendInvoiceRequest::setProviderToken(const QString &provider_token) {
    m_provider_token = provider_token;
    m_provider_token_isSet = true;
}

bool OAISendInvoiceRequest::is_provider_token_Set() const{
    return m_provider_token_isSet;
}

bool OAISendInvoiceRequest::is_provider_token_Valid() const{
    return m_provider_token_isValid;
}

qint32 OAISendInvoiceRequest::getMaxTipAmount() const {
    return m_max_tip_amount;
}
void OAISendInvoiceRequest::setMaxTipAmount(const qint32 &max_tip_amount) {
    m_max_tip_amount = max_tip_amount;
    m_max_tip_amount_isSet = true;
}

bool OAISendInvoiceRequest::is_max_tip_amount_Set() const{
    return m_max_tip_amount_isSet;
}

bool OAISendInvoiceRequest::is_max_tip_amount_Valid() const{
    return m_max_tip_amount_isValid;
}

QList<qint32> OAISendInvoiceRequest::getSuggestedTipAmounts() const {
    return m_suggested_tip_amounts;
}
void OAISendInvoiceRequest::setSuggestedTipAmounts(const QList<qint32> &suggested_tip_amounts) {
    m_suggested_tip_amounts = suggested_tip_amounts;
    m_suggested_tip_amounts_isSet = true;
}

bool OAISendInvoiceRequest::is_suggested_tip_amounts_Set() const{
    return m_suggested_tip_amounts_isSet;
}

bool OAISendInvoiceRequest::is_suggested_tip_amounts_Valid() const{
    return m_suggested_tip_amounts_isValid;
}

QString OAISendInvoiceRequest::getStartParameter() const {
    return m_start_parameter;
}
void OAISendInvoiceRequest::setStartParameter(const QString &start_parameter) {
    m_start_parameter = start_parameter;
    m_start_parameter_isSet = true;
}

bool OAISendInvoiceRequest::is_start_parameter_Set() const{
    return m_start_parameter_isSet;
}

bool OAISendInvoiceRequest::is_start_parameter_Valid() const{
    return m_start_parameter_isValid;
}

QString OAISendInvoiceRequest::getProviderData() const {
    return m_provider_data;
}
void OAISendInvoiceRequest::setProviderData(const QString &provider_data) {
    m_provider_data = provider_data;
    m_provider_data_isSet = true;
}

bool OAISendInvoiceRequest::is_provider_data_Set() const{
    return m_provider_data_isSet;
}

bool OAISendInvoiceRequest::is_provider_data_Valid() const{
    return m_provider_data_isValid;
}

QString OAISendInvoiceRequest::getPhotoUrl() const {
    return m_photo_url;
}
void OAISendInvoiceRequest::setPhotoUrl(const QString &photo_url) {
    m_photo_url = photo_url;
    m_photo_url_isSet = true;
}

bool OAISendInvoiceRequest::is_photo_url_Set() const{
    return m_photo_url_isSet;
}

bool OAISendInvoiceRequest::is_photo_url_Valid() const{
    return m_photo_url_isValid;
}

qint32 OAISendInvoiceRequest::getPhotoSize() const {
    return m_photo_size;
}
void OAISendInvoiceRequest::setPhotoSize(const qint32 &photo_size) {
    m_photo_size = photo_size;
    m_photo_size_isSet = true;
}

bool OAISendInvoiceRequest::is_photo_size_Set() const{
    return m_photo_size_isSet;
}

bool OAISendInvoiceRequest::is_photo_size_Valid() const{
    return m_photo_size_isValid;
}

qint32 OAISendInvoiceRequest::getPhotoWidth() const {
    return m_photo_width;
}
void OAISendInvoiceRequest::setPhotoWidth(const qint32 &photo_width) {
    m_photo_width = photo_width;
    m_photo_width_isSet = true;
}

bool OAISendInvoiceRequest::is_photo_width_Set() const{
    return m_photo_width_isSet;
}

bool OAISendInvoiceRequest::is_photo_width_Valid() const{
    return m_photo_width_isValid;
}

qint32 OAISendInvoiceRequest::getPhotoHeight() const {
    return m_photo_height;
}
void OAISendInvoiceRequest::setPhotoHeight(const qint32 &photo_height) {
    m_photo_height = photo_height;
    m_photo_height_isSet = true;
}

bool OAISendInvoiceRequest::is_photo_height_Set() const{
    return m_photo_height_isSet;
}

bool OAISendInvoiceRequest::is_photo_height_Valid() const{
    return m_photo_height_isValid;
}

bool OAISendInvoiceRequest::isNeedName() const {
    return m_need_name;
}
void OAISendInvoiceRequest::setNeedName(const bool &need_name) {
    m_need_name = need_name;
    m_need_name_isSet = true;
}

bool OAISendInvoiceRequest::is_need_name_Set() const{
    return m_need_name_isSet;
}

bool OAISendInvoiceRequest::is_need_name_Valid() const{
    return m_need_name_isValid;
}

bool OAISendInvoiceRequest::isNeedPhoneNumber() const {
    return m_need_phone_number;
}
void OAISendInvoiceRequest::setNeedPhoneNumber(const bool &need_phone_number) {
    m_need_phone_number = need_phone_number;
    m_need_phone_number_isSet = true;
}

bool OAISendInvoiceRequest::is_need_phone_number_Set() const{
    return m_need_phone_number_isSet;
}

bool OAISendInvoiceRequest::is_need_phone_number_Valid() const{
    return m_need_phone_number_isValid;
}

bool OAISendInvoiceRequest::isNeedEmail() const {
    return m_need_email;
}
void OAISendInvoiceRequest::setNeedEmail(const bool &need_email) {
    m_need_email = need_email;
    m_need_email_isSet = true;
}

bool OAISendInvoiceRequest::is_need_email_Set() const{
    return m_need_email_isSet;
}

bool OAISendInvoiceRequest::is_need_email_Valid() const{
    return m_need_email_isValid;
}

bool OAISendInvoiceRequest::isNeedShippingAddress() const {
    return m_need_shipping_address;
}
void OAISendInvoiceRequest::setNeedShippingAddress(const bool &need_shipping_address) {
    m_need_shipping_address = need_shipping_address;
    m_need_shipping_address_isSet = true;
}

bool OAISendInvoiceRequest::is_need_shipping_address_Set() const{
    return m_need_shipping_address_isSet;
}

bool OAISendInvoiceRequest::is_need_shipping_address_Valid() const{
    return m_need_shipping_address_isValid;
}

bool OAISendInvoiceRequest::isSendPhoneNumberToProvider() const {
    return m_send_phone_number_to_provider;
}
void OAISendInvoiceRequest::setSendPhoneNumberToProvider(const bool &send_phone_number_to_provider) {
    m_send_phone_number_to_provider = send_phone_number_to_provider;
    m_send_phone_number_to_provider_isSet = true;
}

bool OAISendInvoiceRequest::is_send_phone_number_to_provider_Set() const{
    return m_send_phone_number_to_provider_isSet;
}

bool OAISendInvoiceRequest::is_send_phone_number_to_provider_Valid() const{
    return m_send_phone_number_to_provider_isValid;
}

bool OAISendInvoiceRequest::isSendEmailToProvider() const {
    return m_send_email_to_provider;
}
void OAISendInvoiceRequest::setSendEmailToProvider(const bool &send_email_to_provider) {
    m_send_email_to_provider = send_email_to_provider;
    m_send_email_to_provider_isSet = true;
}

bool OAISendInvoiceRequest::is_send_email_to_provider_Set() const{
    return m_send_email_to_provider_isSet;
}

bool OAISendInvoiceRequest::is_send_email_to_provider_Valid() const{
    return m_send_email_to_provider_isValid;
}

bool OAISendInvoiceRequest::isIsFlexible() const {
    return m_is_flexible;
}
void OAISendInvoiceRequest::setIsFlexible(const bool &is_flexible) {
    m_is_flexible = is_flexible;
    m_is_flexible_isSet = true;
}

bool OAISendInvoiceRequest::is_is_flexible_Set() const{
    return m_is_flexible_isSet;
}

bool OAISendInvoiceRequest::is_is_flexible_Valid() const{
    return m_is_flexible_isValid;
}

bool OAISendInvoiceRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendInvoiceRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendInvoiceRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendInvoiceRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendInvoiceRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendInvoiceRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendInvoiceRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendInvoiceRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendInvoiceRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendInvoiceRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendInvoiceRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendInvoiceRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendInvoiceRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendInvoiceRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendInvoiceRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendInvoiceRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendInvoiceRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendInvoiceRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendInvoiceRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendInvoiceRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAIInlineKeyboardMarkup OAISendInvoiceRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAISendInvoiceRequest::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAISendInvoiceRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAISendInvoiceRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAISendInvoiceRequest::isSet() const {
...
bool OAISendInvoiceRequest::isValid() const {
