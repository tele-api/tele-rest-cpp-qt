...
#include "OAIPost_sendContact_request.h"
...
OAIPost_sendContact_request::OAIPost_sendContact_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_sendContact_request::OAIPost_sendContact_request() {
    this->initializeModel();
}

OAIPost_sendContact_request::~OAIPost_sendContact_request() {}

void OAIPost_sendContact_request::initializeModel() {
...
void OAIPost_sendContact_request::fromJson(QString jsonString) {
...
void OAIPost_sendContact_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_sendContact_request::asJson() const {
...
QJsonObject OAIPost_sendContact_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_sendContact_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_sendContact_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_sendContact_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_sendContact_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAIPost_sendContact_request::getPhoneNumber() const {
    return m_phone_number;
}
void OAIPost_sendContact_request::setPhoneNumber(const QString &phone_number) {
    m_phone_number = phone_number;
    m_phone_number_isSet = true;
}

bool OAIPost_sendContact_request::is_phone_number_Set() const{
    return m_phone_number_isSet;
}

bool OAIPost_sendContact_request::is_phone_number_Valid() const{
    return m_phone_number_isValid;
}

QString OAIPost_sendContact_request::getFirstName() const {
    return m_first_name;
}
void OAIPost_sendContact_request::setFirstName(const QString &first_name) {
    m_first_name = first_name;
    m_first_name_isSet = true;
}

bool OAIPost_sendContact_request::is_first_name_Set() const{
    return m_first_name_isSet;
}

bool OAIPost_sendContact_request::is_first_name_Valid() const{
    return m_first_name_isValid;
}

QString OAIPost_sendContact_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_sendContact_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_sendContact_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_sendContact_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAIPost_sendContact_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_sendContact_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_sendContact_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_sendContact_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAIPost_sendContact_request::getLastName() const {
    return m_last_name;
}
void OAIPost_sendContact_request::setLastName(const QString &last_name) {
    m_last_name = last_name;
    m_last_name_isSet = true;
}

bool OAIPost_sendContact_request::is_last_name_Set() const{
    return m_last_name_isSet;
}

bool OAIPost_sendContact_request::is_last_name_Valid() const{
    return m_last_name_isValid;
}

QString OAIPost_sendContact_request::getVcard() const {
    return m_vcard;
}
void OAIPost_sendContact_request::setVcard(const QString &vcard) {
    m_vcard = vcard;
    m_vcard_isSet = true;
}

bool OAIPost_sendContact_request::is_vcard_Set() const{
    return m_vcard_isSet;
}

bool OAIPost_sendContact_request::is_vcard_Valid() const{
    return m_vcard_isValid;
}

bool OAIPost_sendContact_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPost_sendContact_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPost_sendContact_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPost_sendContact_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPost_sendContact_request::isProtectContent() const {
    return m_protect_content;
}
void OAIPost_sendContact_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIPost_sendContact_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIPost_sendContact_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIPost_sendContact_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAIPost_sendContact_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAIPost_sendContact_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAIPost_sendContact_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAIPost_sendContact_request::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAIPost_sendContact_request::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAIPost_sendContact_request::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAIPost_sendContact_request::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAIPost_sendContact_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAIPost_sendContact_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAIPost_sendContact_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAIPost_sendContact_request::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAIPost_sendMessage_request_reply_markup OAIPost_sendContact_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_sendContact_request::setReplyMarkup(const OAIPost_sendMessage_request_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_sendContact_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_sendContact_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_sendContact_request::isSet() const {
...
bool OAIPost_sendContact_request::isValid() const {
