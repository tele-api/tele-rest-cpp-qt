...
/*
 * OAIBackgroundTypeFill.h
 *
 * The background is automatically filled based on the selected colors.
 */

#ifndef OAIBackgroundTypeFill_H
#define OAIBackgroundTypeFill_H
...
class OAIBackgroundTypeFill : public OAIObject {
public:
    OAIBackgroundTypeFill();
    OAIBackgroundTypeFill(QString json);
    ~OAIBackgroundTypeFill() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIBackgroundTypeFill)

#endif // OAIBackgroundTypeFill_H
