...
/*
 * OAIInputPollOption.h
 *
 * This object contains information about one answer option in a poll to be sent.
 */

#ifndef OAIInputPollOption_H
#define OAIInputPollOption_H
...
class OAIInputPollOption : public OAIObject {
public:
    OAIInputPollOption();
    OAIInputPollOption(QString json);
    ~OAIInputPollOption() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInputPollOption)

#endif // OAIInputPollOption_H
