...
#include "OAIPost_editMessageText_200_response_result.h"
...
OAIPost_editMessageText_200_response_result::OAIPost_editMessageText_200_response_result(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_editMessageText_200_response_result::OAIPost_editMessageText_200_response_result() {
    this->initializeModel();
}

OAIPost_editMessageText_200_response_result::~OAIPost_editMessageText_200_response_result() {}

void OAIPost_editMessageText_200_response_result::initializeModel() {
...
void OAIPost_editMessageText_200_response_result::fromJson(QString jsonString) {
...
void OAIPost_editMessageText_200_response_result::fromJsonObject(QJsonObject json) {
...
QString OAIPost_editMessageText_200_response_result::asJson() const {
...
QJsonObject OAIPost_editMessageText_200_response_result::asJsonObject() const {
    QJsonObject obj;
...
qint32 OAIPost_editMessageText_200_response_result::getMessageId() const {
    return m_message_id;
}
void OAIPost_editMessageText_200_response_result::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_message_id_Valid() const{
    return m_message_id_isValid;
}

qint32 OAIPost_editMessageText_200_response_result::getDate() const {
    return m_date;
}
void OAIPost_editMessageText_200_response_result::setDate(const qint32 &date) {
    m_date = date;
    m_date_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_date_Set() const{
    return m_date_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_date_Valid() const{
    return m_date_isValid;
}

OAIChat OAIPost_editMessageText_200_response_result::getChat() const {
    return m_chat;
}
void OAIPost_editMessageText_200_response_result::setChat(const OAIChat &chat) {
    m_chat = chat;
    m_chat_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_chat_Set() const{
    return m_chat_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_chat_Valid() const{
    return m_chat_isValid;
}

qint32 OAIPost_editMessageText_200_response_result::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_editMessageText_200_response_result::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

OAIUser OAIPost_editMessageText_200_response_result::getFrom() const {
    return m_from;
}
void OAIPost_editMessageText_200_response_result::setFrom(const OAIUser &from) {
    m_from = from;
    m_from_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_from_Set() const{
    return m_from_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_from_Valid() const{
    return m_from_isValid;
}

OAIChat OAIPost_editMessageText_200_response_result::getSenderChat() const {
    return m_sender_chat;
}
void OAIPost_editMessageText_200_response_result::setSenderChat(const OAIChat &sender_chat) {
    m_sender_chat = sender_chat;
    m_sender_chat_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_sender_chat_Set() const{
    return m_sender_chat_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_sender_chat_Valid() const{
    return m_sender_chat_isValid;
}

qint32 OAIPost_editMessageText_200_response_result::getSenderBoostCount() const {
    return m_sender_boost_count;
}
void OAIPost_editMessageText_200_response_result::setSenderBoostCount(const qint32 &sender_boost_count) {
    m_sender_boost_count = sender_boost_count;
    m_sender_boost_count_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_sender_boost_count_Set() const{
    return m_sender_boost_count_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_sender_boost_count_Valid() const{
    return m_sender_boost_count_isValid;
}

OAIUser OAIPost_editMessageText_200_response_result::getSenderBusinessBot() const {
    return m_sender_business_bot;
}
void OAIPost_editMessageText_200_response_result::setSenderBusinessBot(const OAIUser &sender_business_bot) {
    m_sender_business_bot = sender_business_bot;
    m_sender_business_bot_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_sender_business_bot_Set() const{
    return m_sender_business_bot_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_sender_business_bot_Valid() const{
    return m_sender_business_bot_isValid;
}

QString OAIPost_editMessageText_200_response_result::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_editMessageText_200_response_result::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIMessageOrigin OAIPost_editMessageText_200_response_result::getForwardOrigin() const {
    return m_forward_origin;
}
void OAIPost_editMessageText_200_response_result::setForwardOrigin(const OAIMessageOrigin &forward_origin) {
    m_forward_origin = forward_origin;
    m_forward_origin_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_forward_origin_Set() const{
    return m_forward_origin_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_forward_origin_Valid() const{
    return m_forward_origin_isValid;
}

bool OAIPost_editMessageText_200_response_result::isIsTopicMessage() const {
    return m_is_topic_message;
}
void OAIPost_editMessageText_200_response_result::setIsTopicMessage(const bool &is_topic_message) {
    m_is_topic_message = is_topic_message;
    m_is_topic_message_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_is_topic_message_Set() const{
    return m_is_topic_message_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_is_topic_message_Valid() const{
    return m_is_topic_message_isValid;
}

bool OAIPost_editMessageText_200_response_result::isIsAutomaticForward() const {
    return m_is_automatic_forward;
}
void OAIPost_editMessageText_200_response_result::setIsAutomaticForward(const bool &is_automatic_forward) {
    m_is_automatic_forward = is_automatic_forward;
    m_is_automatic_forward_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_is_automatic_forward_Set() const{
    return m_is_automatic_forward_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_is_automatic_forward_Valid() const{
    return m_is_automatic_forward_isValid;
}

OAIMessage OAIPost_editMessageText_200_response_result::getReplyToMessage() const {
    return m_reply_to_message;
}
void OAIPost_editMessageText_200_response_result::setReplyToMessage(const OAIMessage &reply_to_message) {
    m_reply_to_message = reply_to_message;
    m_reply_to_message_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_reply_to_message_Set() const{
    return m_reply_to_message_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_reply_to_message_Valid() const{
    return m_reply_to_message_isValid;
}

OAIExternalReplyInfo OAIPost_editMessageText_200_response_result::getExternalReply() const {
    return m_external_reply;
}
void OAIPost_editMessageText_200_response_result::setExternalReply(const OAIExternalReplyInfo &external_reply) {
    m_external_reply = external_reply;
    m_external_reply_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_external_reply_Set() const{
    return m_external_reply_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_external_reply_Valid() const{
    return m_external_reply_isValid;
}

OAITextQuote OAIPost_editMessageText_200_response_result::getQuote() const {
    return m_quote;
}
void OAIPost_editMessageText_200_response_result::setQuote(const OAITextQuote &quote) {
    m_quote = quote;
    m_quote_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_quote_Set() const{
    return m_quote_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_quote_Valid() const{
    return m_quote_isValid;
}

OAIStory OAIPost_editMessageText_200_response_result::getReplyToStory() const {
    return m_reply_to_story;
}
void OAIPost_editMessageText_200_response_result::setReplyToStory(const OAIStory &reply_to_story) {
    m_reply_to_story = reply_to_story;
    m_reply_to_story_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_reply_to_story_Set() const{
    return m_reply_to_story_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_reply_to_story_Valid() const{
    return m_reply_to_story_isValid;
}

OAIUser OAIPost_editMessageText_200_response_result::getViaBot() const {
    return m_via_bot;
}
void OAIPost_editMessageText_200_response_result::setViaBot(const OAIUser &via_bot) {
    m_via_bot = via_bot;
    m_via_bot_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_via_bot_Set() const{
    return m_via_bot_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_via_bot_Valid() const{
    return m_via_bot_isValid;
}

qint32 OAIPost_editMessageText_200_response_result::getEditDate() const {
    return m_edit_date;
}
void OAIPost_editMessageText_200_response_result::setEditDate(const qint32 &edit_date) {
    m_edit_date = edit_date;
    m_edit_date_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_edit_date_Set() const{
    return m_edit_date_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_edit_date_Valid() const{
    return m_edit_date_isValid;
}

bool OAIPost_editMessageText_200_response_result::isHasProtectedContent() const {
    return m_has_protected_content;
}
void OAIPost_editMessageText_200_response_result::setHasProtectedContent(const bool &has_protected_content) {
    m_has_protected_content = has_protected_content;
    m_has_protected_content_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_has_protected_content_Set() const{
    return m_has_protected_content_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_has_protected_content_Valid() const{
    return m_has_protected_content_isValid;
}

bool OAIPost_editMessageText_200_response_result::isIsFromOffline() const {
    return m_is_from_offline;
}
void OAIPost_editMessageText_200_response_result::setIsFromOffline(const bool &is_from_offline) {
    m_is_from_offline = is_from_offline;
    m_is_from_offline_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_is_from_offline_Set() const{
    return m_is_from_offline_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_is_from_offline_Valid() const{
    return m_is_from_offline_isValid;
}

QString OAIPost_editMessageText_200_response_result::getMediaGroupId() const {
    return m_media_group_id;
}
void OAIPost_editMessageText_200_response_result::setMediaGroupId(const QString &media_group_id) {
    m_media_group_id = media_group_id;
    m_media_group_id_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_media_group_id_Set() const{
    return m_media_group_id_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_media_group_id_Valid() const{
    return m_media_group_id_isValid;
}

QString OAIPost_editMessageText_200_response_result::getAuthorSignature() const {
    return m_author_signature;
}
void OAIPost_editMessageText_200_response_result::setAuthorSignature(const QString &author_signature) {
    m_author_signature = author_signature;
    m_author_signature_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_author_signature_Set() const{
    return m_author_signature_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_author_signature_Valid() const{
    return m_author_signature_isValid;
}

qint32 OAIPost_editMessageText_200_response_result::getPaidStarCount() const {
    return m_paid_star_count;
}
void OAIPost_editMessageText_200_response_result::setPaidStarCount(const qint32 &paid_star_count) {
    m_paid_star_count = paid_star_count;
    m_paid_star_count_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_paid_star_count_Set() const{
    return m_paid_star_count_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_paid_star_count_Valid() const{
    return m_paid_star_count_isValid;
}

QString OAIPost_editMessageText_200_response_result::getText() const {
    return m_text;
}
void OAIPost_editMessageText_200_response_result::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_text_Set() const{
    return m_text_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_text_Valid() const{
    return m_text_isValid;
}

QList<OAIMessageEntity> OAIPost_editMessageText_200_response_result::getEntities() const {
    return m_entities;
}
void OAIPost_editMessageText_200_response_result::setEntities(const QList<OAIMessageEntity> &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_entities_Valid() const{
    return m_entities_isValid;
}

OAILinkPreviewOptions OAIPost_editMessageText_200_response_result::getLinkPreviewOptions() const {
    return m_link_preview_options;
}
void OAIPost_editMessageText_200_response_result::setLinkPreviewOptions(const OAILinkPreviewOptions &link_preview_options) {
    m_link_preview_options = link_preview_options;
    m_link_preview_options_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_link_preview_options_Set() const{
    return m_link_preview_options_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_link_preview_options_Valid() const{
    return m_link_preview_options_isValid;
}

QString OAIPost_editMessageText_200_response_result::getEffectId() const {
    return m_effect_id;
}
void OAIPost_editMessageText_200_response_result::setEffectId(const QString &effect_id) {
    m_effect_id = effect_id;
    m_effect_id_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_effect_id_Set() const{
    return m_effect_id_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_effect_id_Valid() const{
    return m_effect_id_isValid;
}

OAIAnimation OAIPost_editMessageText_200_response_result::getAnimation() const {
    return m_animation;
}
void OAIPost_editMessageText_200_response_result::setAnimation(const OAIAnimation &animation) {
    m_animation = animation;
    m_animation_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_animation_Set() const{
    return m_animation_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_animation_Valid() const{
    return m_animation_isValid;
}

OAIAudio OAIPost_editMessageText_200_response_result::getAudio() const {
    return m_audio;
}
void OAIPost_editMessageText_200_response_result::setAudio(const OAIAudio &audio) {
    m_audio = audio;
    m_audio_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_audio_Set() const{
    return m_audio_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_audio_Valid() const{
    return m_audio_isValid;
}

OAIDocument OAIPost_editMessageText_200_response_result::getDocument() const {
    return m_document;
}
void OAIPost_editMessageText_200_response_result::setDocument(const OAIDocument &document) {
    m_document = document;
    m_document_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_document_Set() const{
    return m_document_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_document_Valid() const{
    return m_document_isValid;
}

OAIPaidMediaInfo OAIPost_editMessageText_200_response_result::getPaidMedia() const {
    return m_paid_media;
}
void OAIPost_editMessageText_200_response_result::setPaidMedia(const OAIPaidMediaInfo &paid_media) {
    m_paid_media = paid_media;
    m_paid_media_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_paid_media_Set() const{
    return m_paid_media_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_paid_media_Valid() const{
    return m_paid_media_isValid;
}

QList<OAIPhotoSize> OAIPost_editMessageText_200_response_result::getPhoto() const {
    return m_photo;
}
void OAIPost_editMessageText_200_response_result::setPhoto(const QList<OAIPhotoSize> &photo) {
    m_photo = photo;
    m_photo_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_photo_Set() const{
    return m_photo_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_photo_Valid() const{
    return m_photo_isValid;
}

OAISticker OAIPost_editMessageText_200_response_result::getSticker() const {
    return m_sticker;
}
void OAIPost_editMessageText_200_response_result::setSticker(const OAISticker &sticker) {
    m_sticker = sticker;
    m_sticker_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_sticker_Set() const{
    return m_sticker_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_sticker_Valid() const{
    return m_sticker_isValid;
}

OAIStory OAIPost_editMessageText_200_response_result::getStory() const {
    return m_story;
}
void OAIPost_editMessageText_200_response_result::setStory(const OAIStory &story) {
    m_story = story;
    m_story_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_story_Set() const{
    return m_story_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_story_Valid() const{
    return m_story_isValid;
}

OAIVideo OAIPost_editMessageText_200_response_result::getVideo() const {
    return m_video;
}
void OAIPost_editMessageText_200_response_result::setVideo(const OAIVideo &video) {
    m_video = video;
    m_video_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_video_Set() const{
    return m_video_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_video_Valid() const{
    return m_video_isValid;
}

OAIVideoNote OAIPost_editMessageText_200_response_result::getVideoNote() const {
    return m_video_note;
}
void OAIPost_editMessageText_200_response_result::setVideoNote(const OAIVideoNote &video_note) {
    m_video_note = video_note;
    m_video_note_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_video_note_Set() const{
    return m_video_note_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_video_note_Valid() const{
    return m_video_note_isValid;
}

OAIVoice OAIPost_editMessageText_200_response_result::getVoice() const {
    return m_voice;
}
void OAIPost_editMessageText_200_response_result::setVoice(const OAIVoice &voice) {
    m_voice = voice;
    m_voice_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_voice_Set() const{
    return m_voice_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_voice_Valid() const{
    return m_voice_isValid;
}

QString OAIPost_editMessageText_200_response_result::getCaption() const {
    return m_caption;
}
void OAIPost_editMessageText_200_response_result::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_caption_Valid() const{
    return m_caption_isValid;
}

QList<OAIMessageEntity> OAIPost_editMessageText_200_response_result::getCaptionEntities() const {
    return m_caption_entities;
}
void OAIPost_editMessageText_200_response_result::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

bool OAIPost_editMessageText_200_response_result::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIPost_editMessageText_200_response_result::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

bool OAIPost_editMessageText_200_response_result::isHasMediaSpoiler() const {
    return m_has_media_spoiler;
}
void OAIPost_editMessageText_200_response_result::setHasMediaSpoiler(const bool &has_media_spoiler) {
    m_has_media_spoiler = has_media_spoiler;
    m_has_media_spoiler_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_has_media_spoiler_Set() const{
    return m_has_media_spoiler_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_has_media_spoiler_Valid() const{
    return m_has_media_spoiler_isValid;
}

OAIContact OAIPost_editMessageText_200_response_result::getContact() const {
    return m_contact;
}
void OAIPost_editMessageText_200_response_result::setContact(const OAIContact &contact) {
    m_contact = contact;
    m_contact_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_contact_Set() const{
    return m_contact_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_contact_Valid() const{
    return m_contact_isValid;
}

OAIDice OAIPost_editMessageText_200_response_result::getDice() const {
    return m_dice;
}
void OAIPost_editMessageText_200_response_result::setDice(const OAIDice &dice) {
    m_dice = dice;
    m_dice_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_dice_Set() const{
    return m_dice_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_dice_Valid() const{
    return m_dice_isValid;
}

OAIGame OAIPost_editMessageText_200_response_result::getGame() const {
    return m_game;
}
void OAIPost_editMessageText_200_response_result::setGame(const OAIGame &game) {
    m_game = game;
    m_game_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_game_Set() const{
    return m_game_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_game_Valid() const{
    return m_game_isValid;
}

OAIPoll OAIPost_editMessageText_200_response_result::getPoll() const {
    return m_poll;
}
void OAIPost_editMessageText_200_response_result::setPoll(const OAIPoll &poll) {
    m_poll = poll;
    m_poll_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_poll_Set() const{
    return m_poll_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_poll_Valid() const{
    return m_poll_isValid;
}

OAIVenue OAIPost_editMessageText_200_response_result::getVenue() const {
    return m_venue;
}
void OAIPost_editMessageText_200_response_result::setVenue(const OAIVenue &venue) {
    m_venue = venue;
    m_venue_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_venue_Set() const{
    return m_venue_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_venue_Valid() const{
    return m_venue_isValid;
}

OAILocation OAIPost_editMessageText_200_response_result::getLocation() const {
    return m_location;
}
void OAIPost_editMessageText_200_response_result::setLocation(const OAILocation &location) {
    m_location = location;
    m_location_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_location_Set() const{
    return m_location_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_location_Valid() const{
    return m_location_isValid;
}

QList<OAIUser> OAIPost_editMessageText_200_response_result::getNewChatMembers() const {
    return m_new_chat_members;
}
void OAIPost_editMessageText_200_response_result::setNewChatMembers(const QList<OAIUser> &new_chat_members) {
    m_new_chat_members = new_chat_members;
    m_new_chat_members_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_new_chat_members_Set() const{
    return m_new_chat_members_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_new_chat_members_Valid() const{
    return m_new_chat_members_isValid;
}

OAIUser OAIPost_editMessageText_200_response_result::getLeftChatMember() const {
    return m_left_chat_member;
}
void OAIPost_editMessageText_200_response_result::setLeftChatMember(const OAIUser &left_chat_member) {
    m_left_chat_member = left_chat_member;
    m_left_chat_member_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_left_chat_member_Set() const{
    return m_left_chat_member_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_left_chat_member_Valid() const{
    return m_left_chat_member_isValid;
}

QString OAIPost_editMessageText_200_response_result::getNewChatTitle() const {
    return m_new_chat_title;
}
void OAIPost_editMessageText_200_response_result::setNewChatTitle(const QString &new_chat_title) {
    m_new_chat_title = new_chat_title;
    m_new_chat_title_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_new_chat_title_Set() const{
    return m_new_chat_title_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_new_chat_title_Valid() const{
    return m_new_chat_title_isValid;
}

QList<OAIPhotoSize> OAIPost_editMessageText_200_response_result::getNewChatPhoto() const {
    return m_new_chat_photo;
}
void OAIPost_editMessageText_200_response_result::setNewChatPhoto(const QList<OAIPhotoSize> &new_chat_photo) {
    m_new_chat_photo = new_chat_photo;
    m_new_chat_photo_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_new_chat_photo_Set() const{
    return m_new_chat_photo_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_new_chat_photo_Valid() const{
    return m_new_chat_photo_isValid;
}

bool OAIPost_editMessageText_200_response_result::isDeleteChatPhoto() const {
    return m_delete_chat_photo;
}
void OAIPost_editMessageText_200_response_result::setDeleteChatPhoto(const bool &delete_chat_photo) {
    m_delete_chat_photo = delete_chat_photo;
    m_delete_chat_photo_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_delete_chat_photo_Set() const{
    return m_delete_chat_photo_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_delete_chat_photo_Valid() const{
    return m_delete_chat_photo_isValid;
}

bool OAIPost_editMessageText_200_response_result::isGroupChatCreated() const {
    return m_group_chat_created;
}
void OAIPost_editMessageText_200_response_result::setGroupChatCreated(const bool &group_chat_created) {
    m_group_chat_created = group_chat_created;
    m_group_chat_created_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_group_chat_created_Set() const{
    return m_group_chat_created_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_group_chat_created_Valid() const{
    return m_group_chat_created_isValid;
}

bool OAIPost_editMessageText_200_response_result::isSupergroupChatCreated() const {
    return m_supergroup_chat_created;
}
void OAIPost_editMessageText_200_response_result::setSupergroupChatCreated(const bool &supergroup_chat_created) {
    m_supergroup_chat_created = supergroup_chat_created;
    m_supergroup_chat_created_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_supergroup_chat_created_Set() const{
    return m_supergroup_chat_created_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_supergroup_chat_created_Valid() const{
    return m_supergroup_chat_created_isValid;
}

bool OAIPost_editMessageText_200_response_result::isChannelChatCreated() const {
    return m_channel_chat_created;
}
void OAIPost_editMessageText_200_response_result::setChannelChatCreated(const bool &channel_chat_created) {
    m_channel_chat_created = channel_chat_created;
    m_channel_chat_created_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_channel_chat_created_Set() const{
    return m_channel_chat_created_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_channel_chat_created_Valid() const{
    return m_channel_chat_created_isValid;
}

OAIMessageAutoDeleteTimerChanged OAIPost_editMessageText_200_response_result::getMessageAutoDeleteTimerChanged() const {
    return m_message_auto_delete_timer_changed;
}
void OAIPost_editMessageText_200_response_result::setMessageAutoDeleteTimerChanged(const OAIMessageAutoDeleteTimerChanged &message_auto_delete_timer_changed) {
    m_message_auto_delete_timer_changed = message_auto_delete_timer_changed;
    m_message_auto_delete_timer_changed_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_message_auto_delete_timer_changed_Set() const{
    return m_message_auto_delete_timer_changed_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_message_auto_delete_timer_changed_Valid() const{
    return m_message_auto_delete_timer_changed_isValid;
}

qint32 OAIPost_editMessageText_200_response_result::getMigrateToChatId() const {
    return m_migrate_to_chat_id;
}
void OAIPost_editMessageText_200_response_result::setMigrateToChatId(const qint32 &migrate_to_chat_id) {
    m_migrate_to_chat_id = migrate_to_chat_id;
    m_migrate_to_chat_id_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_migrate_to_chat_id_Set() const{
    return m_migrate_to_chat_id_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_migrate_to_chat_id_Valid() const{
    return m_migrate_to_chat_id_isValid;
}

qint32 OAIPost_editMessageText_200_response_result::getMigrateFromChatId() const {
    return m_migrate_from_chat_id;
}
void OAIPost_editMessageText_200_response_result::setMigrateFromChatId(const qint32 &migrate_from_chat_id) {
    m_migrate_from_chat_id = migrate_from_chat_id;
    m_migrate_from_chat_id_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_migrate_from_chat_id_Set() const{
    return m_migrate_from_chat_id_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_migrate_from_chat_id_Valid() const{
    return m_migrate_from_chat_id_isValid;
}

OAIMaybeInaccessibleMessage OAIPost_editMessageText_200_response_result::getPinnedMessage() const {
    return m_pinned_message;
}
void OAIPost_editMessageText_200_response_result::setPinnedMessage(const OAIMaybeInaccessibleMessage &pinned_message) {
    m_pinned_message = pinned_message;
    m_pinned_message_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_pinned_message_Set() const{
    return m_pinned_message_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_pinned_message_Valid() const{
    return m_pinned_message_isValid;
}

OAIInvoice OAIPost_editMessageText_200_response_result::getInvoice() const {
    return m_invoice;
}
void OAIPost_editMessageText_200_response_result::setInvoice(const OAIInvoice &invoice) {
    m_invoice = invoice;
    m_invoice_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_invoice_Set() const{
    return m_invoice_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_invoice_Valid() const{
    return m_invoice_isValid;
}

OAISuccessfulPayment OAIPost_editMessageText_200_response_result::getSuccessfulPayment() const {
    return m_successful_payment;
}
void OAIPost_editMessageText_200_response_result::setSuccessfulPayment(const OAISuccessfulPayment &successful_payment) {
    m_successful_payment = successful_payment;
    m_successful_payment_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_successful_payment_Set() const{
    return m_successful_payment_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_successful_payment_Valid() const{
    return m_successful_payment_isValid;
}

OAIRefundedPayment OAIPost_editMessageText_200_response_result::getRefundedPayment() const {
    return m_refunded_payment;
}
void OAIPost_editMessageText_200_response_result::setRefundedPayment(const OAIRefundedPayment &refunded_payment) {
    m_refunded_payment = refunded_payment;
    m_refunded_payment_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_refunded_payment_Set() const{
    return m_refunded_payment_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_refunded_payment_Valid() const{
    return m_refunded_payment_isValid;
}

OAIUsersShared OAIPost_editMessageText_200_response_result::getUsersShared() const {
    return m_users_shared;
}
void OAIPost_editMessageText_200_response_result::setUsersShared(const OAIUsersShared &users_shared) {
    m_users_shared = users_shared;
    m_users_shared_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_users_shared_Set() const{
    return m_users_shared_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_users_shared_Valid() const{
    return m_users_shared_isValid;
}

OAIChatShared OAIPost_editMessageText_200_response_result::getChatShared() const {
    return m_chat_shared;
}
void OAIPost_editMessageText_200_response_result::setChatShared(const OAIChatShared &chat_shared) {
    m_chat_shared = chat_shared;
    m_chat_shared_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_chat_shared_Set() const{
    return m_chat_shared_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_chat_shared_Valid() const{
    return m_chat_shared_isValid;
}

OAIGiftInfo OAIPost_editMessageText_200_response_result::getGift() const {
    return m_gift;
}
void OAIPost_editMessageText_200_response_result::setGift(const OAIGiftInfo &gift) {
    m_gift = gift;
    m_gift_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_gift_Set() const{
    return m_gift_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_gift_Valid() const{
    return m_gift_isValid;
}

OAIUniqueGiftInfo OAIPost_editMessageText_200_response_result::getUniqueGift() const {
    return m_unique_gift;
}
void OAIPost_editMessageText_200_response_result::setUniqueGift(const OAIUniqueGiftInfo &unique_gift) {
    m_unique_gift = unique_gift;
    m_unique_gift_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_unique_gift_Set() const{
    return m_unique_gift_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_unique_gift_Valid() const{
    return m_unique_gift_isValid;
}

QString OAIPost_editMessageText_200_response_result::getConnectedWebsite() const {
    return m_connected_website;
}
void OAIPost_editMessageText_200_response_result::setConnectedWebsite(const QString &connected_website) {
    m_connected_website = connected_website;
    m_connected_website_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_connected_website_Set() const{
    return m_connected_website_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_connected_website_Valid() const{
    return m_connected_website_isValid;
}

OAIWriteAccessAllowed OAIPost_editMessageText_200_response_result::getWriteAccessAllowed() const {
    return m_write_access_allowed;
}
void OAIPost_editMessageText_200_response_result::setWriteAccessAllowed(const OAIWriteAccessAllowed &write_access_allowed) {
    m_write_access_allowed = write_access_allowed;
    m_write_access_allowed_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_write_access_allowed_Set() const{
    return m_write_access_allowed_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_write_access_allowed_Valid() const{
    return m_write_access_allowed_isValid;
}

OAIPassportData OAIPost_editMessageText_200_response_result::getPassportData() const {
    return m_passport_data;
}
void OAIPost_editMessageText_200_response_result::setPassportData(const OAIPassportData &passport_data) {
    m_passport_data = passport_data;
    m_passport_data_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_passport_data_Set() const{
    return m_passport_data_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_passport_data_Valid() const{
    return m_passport_data_isValid;
}

OAIProximityAlertTriggered OAIPost_editMessageText_200_response_result::getProximityAlertTriggered() const {
    return m_proximity_alert_triggered;
}
void OAIPost_editMessageText_200_response_result::setProximityAlertTriggered(const OAIProximityAlertTriggered &proximity_alert_triggered) {
    m_proximity_alert_triggered = proximity_alert_triggered;
    m_proximity_alert_triggered_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_proximity_alert_triggered_Set() const{
    return m_proximity_alert_triggered_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_proximity_alert_triggered_Valid() const{
    return m_proximity_alert_triggered_isValid;
}

OAIChatBoostAdded OAIPost_editMessageText_200_response_result::getBoostAdded() const {
    return m_boost_added;
}
void OAIPost_editMessageText_200_response_result::setBoostAdded(const OAIChatBoostAdded &boost_added) {
    m_boost_added = boost_added;
    m_boost_added_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_boost_added_Set() const{
    return m_boost_added_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_boost_added_Valid() const{
    return m_boost_added_isValid;
}

OAIChatBackground OAIPost_editMessageText_200_response_result::getChatBackgroundSet() const {
    return m_chat_background_set;
}
void OAIPost_editMessageText_200_response_result::setChatBackgroundSet(const OAIChatBackground &chat_background_set) {
    m_chat_background_set = chat_background_set;
    m_chat_background_set_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_chat_background_set_Set() const{
    return m_chat_background_set_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_chat_background_set_Valid() const{
    return m_chat_background_set_isValid;
}

OAIForumTopicCreated OAIPost_editMessageText_200_response_result::getForumTopicCreated() const {
    return m_forum_topic_created;
}
void OAIPost_editMessageText_200_response_result::setForumTopicCreated(const OAIForumTopicCreated &forum_topic_created) {
    m_forum_topic_created = forum_topic_created;
    m_forum_topic_created_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_created_Set() const{
    return m_forum_topic_created_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_created_Valid() const{
    return m_forum_topic_created_isValid;
}

OAIForumTopicEdited OAIPost_editMessageText_200_response_result::getForumTopicEdited() const {
    return m_forum_topic_edited;
}
void OAIPost_editMessageText_200_response_result::setForumTopicEdited(const OAIForumTopicEdited &forum_topic_edited) {
    m_forum_topic_edited = forum_topic_edited;
    m_forum_topic_edited_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_edited_Set() const{
    return m_forum_topic_edited_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_edited_Valid() const{
    return m_forum_topic_edited_isValid;
}

QJsonValue OAIPost_editMessageText_200_response_result::getForumTopicClosed() const {
    return m_forum_topic_closed;
}
void OAIPost_editMessageText_200_response_result::setForumTopicClosed(const QJsonValue &forum_topic_closed) {
    m_forum_topic_closed = forum_topic_closed;
    m_forum_topic_closed_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_closed_Set() const{
    return m_forum_topic_closed_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_closed_Valid() const{
    return m_forum_topic_closed_isValid;
}

QJsonValue OAIPost_editMessageText_200_response_result::getForumTopicReopened() const {
    return m_forum_topic_reopened;
}
void OAIPost_editMessageText_200_response_result::setForumTopicReopened(const QJsonValue &forum_topic_reopened) {
    m_forum_topic_reopened = forum_topic_reopened;
    m_forum_topic_reopened_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_reopened_Set() const{
    return m_forum_topic_reopened_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_forum_topic_reopened_Valid() const{
    return m_forum_topic_reopened_isValid;
}

QJsonValue OAIPost_editMessageText_200_response_result::getGeneralForumTopicHidden() const {
    return m_general_forum_topic_hidden;
}
void OAIPost_editMessageText_200_response_result::setGeneralForumTopicHidden(const QJsonValue &general_forum_topic_hidden) {
    m_general_forum_topic_hidden = general_forum_topic_hidden;
    m_general_forum_topic_hidden_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_general_forum_topic_hidden_Set() const{
    return m_general_forum_topic_hidden_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_general_forum_topic_hidden_Valid() const{
    return m_general_forum_topic_hidden_isValid;
}

QJsonValue OAIPost_editMessageText_200_response_result::getGeneralForumTopicUnhidden() const {
    return m_general_forum_topic_unhidden;
}
void OAIPost_editMessageText_200_response_result::setGeneralForumTopicUnhidden(const QJsonValue &general_forum_topic_unhidden) {
    m_general_forum_topic_unhidden = general_forum_topic_unhidden;
    m_general_forum_topic_unhidden_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_general_forum_topic_unhidden_Set() const{
    return m_general_forum_topic_unhidden_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_general_forum_topic_unhidden_Valid() const{
    return m_general_forum_topic_unhidden_isValid;
}

OAIGiveawayCreated OAIPost_editMessageText_200_response_result::getGiveawayCreated() const {
    return m_giveaway_created;
}
void OAIPost_editMessageText_200_response_result::setGiveawayCreated(const OAIGiveawayCreated &giveaway_created) {
    m_giveaway_created = giveaway_created;
    m_giveaway_created_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_created_Set() const{
    return m_giveaway_created_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_created_Valid() const{
    return m_giveaway_created_isValid;
}

OAIGiveaway OAIPost_editMessageText_200_response_result::getGiveaway() const {
    return m_giveaway;
}
void OAIPost_editMessageText_200_response_result::setGiveaway(const OAIGiveaway &giveaway) {
    m_giveaway = giveaway;
    m_giveaway_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_Set() const{
    return m_giveaway_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_Valid() const{
    return m_giveaway_isValid;
}

OAIGiveawayWinners OAIPost_editMessageText_200_response_result::getGiveawayWinners() const {
    return m_giveaway_winners;
}
void OAIPost_editMessageText_200_response_result::setGiveawayWinners(const OAIGiveawayWinners &giveaway_winners) {
    m_giveaway_winners = giveaway_winners;
    m_giveaway_winners_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_winners_Set() const{
    return m_giveaway_winners_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_winners_Valid() const{
    return m_giveaway_winners_isValid;
}

OAIGiveawayCompleted OAIPost_editMessageText_200_response_result::getGiveawayCompleted() const {
    return m_giveaway_completed;
}
void OAIPost_editMessageText_200_response_result::setGiveawayCompleted(const OAIGiveawayCompleted &giveaway_completed) {
    m_giveaway_completed = giveaway_completed;
    m_giveaway_completed_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_completed_Set() const{
    return m_giveaway_completed_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_giveaway_completed_Valid() const{
    return m_giveaway_completed_isValid;
}

OAIPaidMessagePriceChanged OAIPost_editMessageText_200_response_result::getPaidMessagePriceChanged() const {
    return m_paid_message_price_changed;
}
void OAIPost_editMessageText_200_response_result::setPaidMessagePriceChanged(const OAIPaidMessagePriceChanged &paid_message_price_changed) {
    m_paid_message_price_changed = paid_message_price_changed;
    m_paid_message_price_changed_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_paid_message_price_changed_Set() const{
    return m_paid_message_price_changed_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_paid_message_price_changed_Valid() const{
    return m_paid_message_price_changed_isValid;
}

OAIVideoChatScheduled OAIPost_editMessageText_200_response_result::getVideoChatScheduled() const {
    return m_video_chat_scheduled;
}
void OAIPost_editMessageText_200_response_result::setVideoChatScheduled(const OAIVideoChatScheduled &video_chat_scheduled) {
    m_video_chat_scheduled = video_chat_scheduled;
    m_video_chat_scheduled_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_scheduled_Set() const{
    return m_video_chat_scheduled_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_scheduled_Valid() const{
    return m_video_chat_scheduled_isValid;
}

QJsonValue OAIPost_editMessageText_200_response_result::getVideoChatStarted() const {
    return m_video_chat_started;
}
void OAIPost_editMessageText_200_response_result::setVideoChatStarted(const QJsonValue &video_chat_started) {
    m_video_chat_started = video_chat_started;
    m_video_chat_started_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_started_Set() const{
    return m_video_chat_started_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_started_Valid() const{
    return m_video_chat_started_isValid;
}

OAIVideoChatEnded OAIPost_editMessageText_200_response_result::getVideoChatEnded() const {
    return m_video_chat_ended;
}
void OAIPost_editMessageText_200_response_result::setVideoChatEnded(const OAIVideoChatEnded &video_chat_ended) {
    m_video_chat_ended = video_chat_ended;
    m_video_chat_ended_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_ended_Set() const{
    return m_video_chat_ended_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_ended_Valid() const{
    return m_video_chat_ended_isValid;
}

OAIVideoChatParticipantsInvited OAIPost_editMessageText_200_response_result::getVideoChatParticipantsInvited() const {
    return m_video_chat_participants_invited;
}
void OAIPost_editMessageText_200_response_result::setVideoChatParticipantsInvited(const OAIVideoChatParticipantsInvited &video_chat_participants_invited) {
    m_video_chat_participants_invited = video_chat_participants_invited;
    m_video_chat_participants_invited_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_participants_invited_Set() const{
    return m_video_chat_participants_invited_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_video_chat_participants_invited_Valid() const{
    return m_video_chat_participants_invited_isValid;
}

OAIWebAppData OAIPost_editMessageText_200_response_result::getWebAppData() const {
    return m_web_app_data;
}
void OAIPost_editMessageText_200_response_result::setWebAppData(const OAIWebAppData &web_app_data) {
    m_web_app_data = web_app_data;
    m_web_app_data_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_web_app_data_Set() const{
    return m_web_app_data_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_web_app_data_Valid() const{
    return m_web_app_data_isValid;
}

OAIInlineKeyboardMarkup OAIPost_editMessageText_200_response_result::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_editMessageText_200_response_result::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_editMessageText_200_response_result::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_editMessageText_200_response_result::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_editMessageText_200_response_result::isSet() const {
...
bool OAIPost_editMessageText_200_response_result::isValid() const {
