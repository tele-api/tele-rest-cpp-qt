...
/*
 * OAI_savePreparedInlineMessage_post_request.h
 *
 * 
 */

#ifndef OAI_savePreparedInlineMessage_post_request_H
#define OAI_savePreparedInlineMessage_post_request_H
...
class OAI_savePreparedInlineMessage_post_request : public OAIObject {
public:
    OAI_savePreparedInlineMessage_post_request();
    OAI_savePreparedInlineMessage_post_request(QString json);
    ~OAI_savePreparedInlineMessage_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_savePreparedInlineMessage_post_request)

#endif // OAI_savePreparedInlineMessage_post_request_H
