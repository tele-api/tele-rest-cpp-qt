...
OAI_sendMessage_post_request_chat_id OAI_stopPoll_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_stopPoll_post_request::setChatId(const OAI_sendMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
...
QString OAI_stopPoll_post_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAI_stopPoll_post_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAI_stopPoll_post_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAI_stopPoll_post_request::is_business_connection_id_Valid() const{
