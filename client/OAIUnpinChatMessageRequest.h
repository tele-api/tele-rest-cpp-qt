...
/*
 * OAIUnpinChatMessageRequest.h
 *
 * Request parameters for unpinChatMessage
 */

#ifndef OAIUnpinChatMessageRequest_H
#define OAIUnpinChatMessageRequest_H
...
class OAIUnpinChatMessageRequest : public OAIObject {
public:
    OAIUnpinChatMessageRequest();
    OAIUnpinChatMessageRequest(QString json);
    ~OAIUnpinChatMessageRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIUnpinChatMessageRequest)

#endif // OAIUnpinChatMessageRequest_H
