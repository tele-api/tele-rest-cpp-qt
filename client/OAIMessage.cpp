...
qint32 OAIMessage::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIMessage::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIMessage::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIMessage::is_message_thread_id_Valid() const{
...
qint32 OAIMessage::getSenderBoostCount() const {
    return m_sender_boost_count;
}
void OAIMessage::setSenderBoostCount(const qint32 &sender_boost_count) {
    m_sender_boost_count = sender_boost_count;
    m_sender_boost_count_isSet = true;
}

bool OAIMessage::is_sender_boost_count_Set() const{
    return m_sender_boost_count_isSet;
}

bool OAIMessage::is_sender_boost_count_Valid() const{
    return m_sender_boost_count_isValid;
}

OAIUser OAIMessage::getSenderBusinessBot() const {
    return m_sender_business_bot;
}
void OAIMessage::setSenderBusinessBot(const OAIUser &sender_business_bot) {
    m_sender_business_bot = sender_business_bot;
    m_sender_business_bot_isSet = true;
}

bool OAIMessage::is_sender_business_bot_Set() const{
    return m_sender_business_bot_isSet;
}

bool OAIMessage::is_sender_business_bot_Valid() const{
    return m_sender_business_bot_isValid;
}

QString OAIMessage::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIMessage::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIMessage::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIMessage::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIMessageOrigin OAIMessage::getForwardOrigin() const {
    return m_forward_origin;
}
void OAIMessage::setForwardOrigin(const OAIMessageOrigin &forward_origin) {
    m_forward_origin = forward_origin;
    m_forward_origin_isSet = true;
}

bool OAIMessage::is_forward_origin_Set() const{
    return m_forward_origin_isSet;
}

bool OAIMessage::is_forward_origin_Valid() const{
    return m_forward_origin_isValid;
}

bool OAIMessage::isIsTopicMessage() const {
    return m_is_topic_message;
}
void OAIMessage::setIsTopicMessage(const bool &is_topic_message) {
    m_is_topic_message = is_topic_message;
    m_is_topic_message_isSet = true;
}

bool OAIMessage::is_is_topic_message_Set() const{
    return m_is_topic_message_isSet;
}

bool OAIMessage::is_is_topic_message_Valid() const{
    return m_is_topic_message_isValid;
}

bool OAIMessage::isIsAutomaticForward() const {
    return m_is_automatic_forward;
}
void OAIMessage::setIsAutomaticForward(const bool &is_automatic_forward) {
    m_is_automatic_forward = is_automatic_forward;
    m_is_automatic_forward_isSet = true;
}

bool OAIMessage::is_is_automatic_forward_Set() const{
    return m_is_automatic_forward_isSet;
}

bool OAIMessage::is_is_automatic_forward_Valid() const{
...
OAIExternalReplyInfo OAIMessage::getExternalReply() const {
    return m_external_reply;
}
void OAIMessage::setExternalReply(const OAIExternalReplyInfo &external_reply) {
    m_external_reply = external_reply;
    m_external_reply_isSet = true;
}

bool OAIMessage::is_external_reply_Set() const{
    return m_external_reply_isSet;
}

bool OAIMessage::is_external_reply_Valid() const{
    return m_external_reply_isValid;
}

OAITextQuote OAIMessage::getQuote() const {
    return m_quote;
}
void OAIMessage::setQuote(const OAITextQuote &quote) {
    m_quote = quote;
    m_quote_isSet = true;
}

bool OAIMessage::is_quote_Set() const{
    return m_quote_isSet;
}

bool OAIMessage::is_quote_Valid() const{
    return m_quote_isValid;
}

OAIStory OAIMessage::getReplyToStory() const {
    return m_reply_to_story;
}
void OAIMessage::setReplyToStory(const OAIStory &reply_to_story) {
    m_reply_to_story = reply_to_story;
    m_reply_to_story_isSet = true;
}

bool OAIMessage::is_reply_to_story_Set() const{
    return m_reply_to_story_isSet;
}

bool OAIMessage::is_reply_to_story_Valid() const{
...
bool OAIMessage::isHasProtectedContent() const {
    return m_has_protected_content;
}
void OAIMessage::setHasProtectedContent(const bool &has_protected_content) {
    m_has_protected_content = has_protected_content;
    m_has_protected_content_isSet = true;
}

bool OAIMessage::is_has_protected_content_Set() const{
    return m_has_protected_content_isSet;
}

bool OAIMessage::is_has_protected_content_Valid() const{
    return m_has_protected_content_isValid;
}

bool OAIMessage::isIsFromOffline() const {
    return m_is_from_offline;
}
void OAIMessage::setIsFromOffline(const bool &is_from_offline) {
    m_is_from_offline = is_from_offline;
    m_is_from_offline_isSet = true;
}

bool OAIMessage::is_is_from_offline_Set() const{
    return m_is_from_offline_isSet;
}

bool OAIMessage::is_is_from_offline_Valid() const{
...
qint32 OAIMessage::getPaidStarCount() const {
    return m_paid_star_count;
}
void OAIMessage::setPaidStarCount(const qint32 &paid_star_count) {
    m_paid_star_count = paid_star_count;
    m_paid_star_count_isSet = true;
}

bool OAIMessage::is_paid_star_count_Set() const{
    return m_paid_star_count_isSet;
}

bool OAIMessage::is_paid_star_count_Valid() const{
...
OAILinkPreviewOptions OAIMessage::getLinkPreviewOptions() const {
    return m_link_preview_options;
}
void OAIMessage::setLinkPreviewOptions(const OAILinkPreviewOptions &link_preview_options) {
    m_link_preview_options = link_preview_options;
    m_link_preview_options_isSet = true;
}

bool OAIMessage::is_link_preview_options_Set() const{
    return m_link_preview_options_isSet;
}

bool OAIMessage::is_link_preview_options_Valid() const{
    return m_link_preview_options_isValid;
}

QString OAIMessage::getEffectId() const {
    return m_effect_id;
}
void OAIMessage::setEffectId(const QString &effect_id) {
    m_effect_id = effect_id;
    m_effect_id_isSet = true;
}

bool OAIMessage::is_effect_id_Set() const{
    return m_effect_id_isSet;
}

bool OAIMessage::is_effect_id_Valid() const{
...
OAIPaidMediaInfo OAIMessage::getPaidMedia() const {
    return m_paid_media;
}
void OAIMessage::setPaidMedia(const OAIPaidMediaInfo &paid_media) {
    m_paid_media = paid_media;
    m_paid_media_isSet = true;
}

bool OAIMessage::is_paid_media_Set() const{
    return m_paid_media_isSet;
}

bool OAIMessage::is_paid_media_Valid() const{
...
OAIStory OAIMessage::getStory() const {
    return m_story;
}
void OAIMessage::setStory(const OAIStory &story) {
    m_story = story;
    m_story_isSet = true;
}

bool OAIMessage::is_story_Set() const{
    return m_story_isSet;
}

bool OAIMessage::is_story_Valid() const{
...
bool OAIMessage::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIMessage::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIMessage::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIMessage::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

bool OAIMessage::isHasMediaSpoiler() const {
    return m_has_media_spoiler;
}
void OAIMessage::setHasMediaSpoiler(const bool &has_media_spoiler) {
    m_has_media_spoiler = has_media_spoiler;
    m_has_media_spoiler_isSet = true;
}

bool OAIMessage::is_has_media_spoiler_Set() const{
    return m_has_media_spoiler_isSet;
}

bool OAIMessage::is_has_media_spoiler_Valid() const{
...
OAIMessageAutoDeleteTimerChanged OAIMessage::getMessageAutoDeleteTimerChanged() const {
    return m_message_auto_delete_timer_changed;
}
void OAIMessage::setMessageAutoDeleteTimerChanged(const OAIMessageAutoDeleteTimerChanged &message_auto_delete_timer_changed) {
    m_message_auto_delete_timer_changed = message_auto_delete_timer_changed;
    m_message_auto_delete_timer_changed_isSet = true;
}

bool OAIMessage::is_message_auto_delete_timer_changed_Set() const{
    return m_message_auto_delete_timer_changed_isSet;
}

bool OAIMessage::is_message_auto_delete_timer_changed_Valid() const{
...
OAIMaybeInaccessibleMessage OAIMessage::getPinnedMessage() const {
    return m_pinned_message;
}
void OAIMessage::setPinnedMessage(const OAIMaybeInaccessibleMessage &pinned_message) {
...
OAIRefundedPayment OAIMessage::getRefundedPayment() const {
    return m_refunded_payment;
}
void OAIMessage::setRefundedPayment(const OAIRefundedPayment &refunded_payment) {
    m_refunded_payment = refunded_payment;
    m_refunded_payment_isSet = true;
}

bool OAIMessage::is_refunded_payment_Set() const{
    return m_refunded_payment_isSet;
}

bool OAIMessage::is_refunded_payment_Valid() const{
    return m_refunded_payment_isValid;
}

OAIUsersShared OAIMessage::getUsersShared() const {
    return m_users_shared;
}
void OAIMessage::setUsersShared(const OAIUsersShared &users_shared) {
    m_users_shared = users_shared;
    m_users_shared_isSet = true;
}

bool OAIMessage::is_users_shared_Set() const{
    return m_users_shared_isSet;
}

bool OAIMessage::is_users_shared_Valid() const{
    return m_users_shared_isValid;
}

OAIChatShared OAIMessage::getChatShared() const {
    return m_chat_shared;
}
void OAIMessage::setChatShared(const OAIChatShared &chat_shared) {
    m_chat_shared = chat_shared;
    m_chat_shared_isSet = true;
}

bool OAIMessage::is_chat_shared_Set() const{
    return m_chat_shared_isSet;
}

bool OAIMessage::is_chat_shared_Valid() const{
    return m_chat_shared_isValid;
}

OAIGiftInfo OAIMessage::getGift() const {
    return m_gift;
}
void OAIMessage::setGift(const OAIGiftInfo &gift) {
    m_gift = gift;
    m_gift_isSet = true;
}

bool OAIMessage::is_gift_Set() const{
    return m_gift_isSet;
}

bool OAIMessage::is_gift_Valid() const{
    return m_gift_isValid;
}

OAIUniqueGiftInfo OAIMessage::getUniqueGift() const {
    return m_unique_gift;
}
void OAIMessage::setUniqueGift(const OAIUniqueGiftInfo &unique_gift) {
    m_unique_gift = unique_gift;
    m_unique_gift_isSet = true;
}

bool OAIMessage::is_unique_gift_Set() const{
    return m_unique_gift_isSet;
}

bool OAIMessage::is_unique_gift_Valid() const{
...
OAIWriteAccessAllowed OAIMessage::getWriteAccessAllowed() const {
    return m_write_access_allowed;
}
void OAIMessage::setWriteAccessAllowed(const OAIWriteAccessAllowed &write_access_allowed) {
    m_write_access_allowed = write_access_allowed;
    m_write_access_allowed_isSet = true;
}

bool OAIMessage::is_write_access_allowed_Set() const{
    return m_write_access_allowed_isSet;
}

bool OAIMessage::is_write_access_allowed_Valid() const{
...
OAIChatBoostAdded OAIMessage::getBoostAdded() const {
    return m_boost_added;
}
void OAIMessage::setBoostAdded(const OAIChatBoostAdded &boost_added) {
    m_boost_added = boost_added;
    m_boost_added_isSet = true;
}

bool OAIMessage::is_boost_added_Set() const{
    return m_boost_added_isSet;
}

bool OAIMessage::is_boost_added_Valid() const{
    return m_boost_added_isValid;
}

OAIChatBackground OAIMessage::getChatBackgroundSet() const {
    return m_chat_background_set;
}
void OAIMessage::setChatBackgroundSet(const OAIChatBackground &chat_background_set) {
    m_chat_background_set = chat_background_set;
    m_chat_background_set_isSet = true;
}

bool OAIMessage::is_chat_background_set_Set() const{
    return m_chat_background_set_isSet;
}

bool OAIMessage::is_chat_background_set_Valid() const{
    return m_chat_background_set_isValid;
}

OAIForumTopicCreated OAIMessage::getForumTopicCreated() const {
    return m_forum_topic_created;
}
void OAIMessage::setForumTopicCreated(const OAIForumTopicCreated &forum_topic_created) {
    m_forum_topic_created = forum_topic_created;
    m_forum_topic_created_isSet = true;
}

bool OAIMessage::is_forum_topic_created_Set() const{
    return m_forum_topic_created_isSet;
}

bool OAIMessage::is_forum_topic_created_Valid() const{
    return m_forum_topic_created_isValid;
}

OAIForumTopicEdited OAIMessage::getForumTopicEdited() const {
    return m_forum_topic_edited;
}
void OAIMessage::setForumTopicEdited(const OAIForumTopicEdited &forum_topic_edited) {
    m_forum_topic_edited = forum_topic_edited;
    m_forum_topic_edited_isSet = true;
}

bool OAIMessage::is_forum_topic_edited_Set() const{
    return m_forum_topic_edited_isSet;
}

bool OAIMessage::is_forum_topic_edited_Valid() const{
    return m_forum_topic_edited_isValid;
}

QJsonValue OAIMessage::getForumTopicClosed() const {
    return m_forum_topic_closed;
}
void OAIMessage::setForumTopicClosed(const QJsonValue &forum_topic_closed) {
    m_forum_topic_closed = forum_topic_closed;
    m_forum_topic_closed_isSet = true;
}

bool OAIMessage::is_forum_topic_closed_Set() const{
    return m_forum_topic_closed_isSet;
}

bool OAIMessage::is_forum_topic_closed_Valid() const{
    return m_forum_topic_closed_isValid;
}

QJsonValue OAIMessage::getForumTopicReopened() const {
    return m_forum_topic_reopened;
}
void OAIMessage::setForumTopicReopened(const QJsonValue &forum_topic_reopened) {
    m_forum_topic_reopened = forum_topic_reopened;
    m_forum_topic_reopened_isSet = true;
}

bool OAIMessage::is_forum_topic_reopened_Set() const{
    return m_forum_topic_reopened_isSet;
}

bool OAIMessage::is_forum_topic_reopened_Valid() const{
    return m_forum_topic_reopened_isValid;
}

QJsonValue OAIMessage::getGeneralForumTopicHidden() const {
    return m_general_forum_topic_hidden;
}
void OAIMessage::setGeneralForumTopicHidden(const QJsonValue &general_forum_topic_hidden) {
    m_general_forum_topic_hidden = general_forum_topic_hidden;
    m_general_forum_topic_hidden_isSet = true;
}

bool OAIMessage::is_general_forum_topic_hidden_Set() const{
    return m_general_forum_topic_hidden_isSet;
}

bool OAIMessage::is_general_forum_topic_hidden_Valid() const{
    return m_general_forum_topic_hidden_isValid;
}

QJsonValue OAIMessage::getGeneralForumTopicUnhidden() const {
    return m_general_forum_topic_unhidden;
}
void OAIMessage::setGeneralForumTopicUnhidden(const QJsonValue &general_forum_topic_unhidden) {
    m_general_forum_topic_unhidden = general_forum_topic_unhidden;
    m_general_forum_topic_unhidden_isSet = true;
}

bool OAIMessage::is_general_forum_topic_unhidden_Set() const{
    return m_general_forum_topic_unhidden_isSet;
}

bool OAIMessage::is_general_forum_topic_unhidden_Valid() const{
    return m_general_forum_topic_unhidden_isValid;
}

OAIGiveawayCreated OAIMessage::getGiveawayCreated() const {
    return m_giveaway_created;
}
void OAIMessage::setGiveawayCreated(const OAIGiveawayCreated &giveaway_created) {
    m_giveaway_created = giveaway_created;
    m_giveaway_created_isSet = true;
}

bool OAIMessage::is_giveaway_created_Set() const{
    return m_giveaway_created_isSet;
}

bool OAIMessage::is_giveaway_created_Valid() const{
    return m_giveaway_created_isValid;
}

OAIGiveaway OAIMessage::getGiveaway() const {
    return m_giveaway;
}
void OAIMessage::setGiveaway(const OAIGiveaway &giveaway) {
    m_giveaway = giveaway;
    m_giveaway_isSet = true;
}

bool OAIMessage::is_giveaway_Set() const{
    return m_giveaway_isSet;
}

bool OAIMessage::is_giveaway_Valid() const{
    return m_giveaway_isValid;
}

OAIGiveawayWinners OAIMessage::getGiveawayWinners() const {
    return m_giveaway_winners;
}
void OAIMessage::setGiveawayWinners(const OAIGiveawayWinners &giveaway_winners) {
    m_giveaway_winners = giveaway_winners;
    m_giveaway_winners_isSet = true;
}

bool OAIMessage::is_giveaway_winners_Set() const{
    return m_giveaway_winners_isSet;
}

bool OAIMessage::is_giveaway_winners_Valid() const{
    return m_giveaway_winners_isValid;
}

OAIGiveawayCompleted OAIMessage::getGiveawayCompleted() const {
    return m_giveaway_completed;
}
void OAIMessage::setGiveawayCompleted(const OAIGiveawayCompleted &giveaway_completed) {
    m_giveaway_completed = giveaway_completed;
    m_giveaway_completed_isSet = true;
}

bool OAIMessage::is_giveaway_completed_Set() const{
    return m_giveaway_completed_isSet;
}

bool OAIMessage::is_giveaway_completed_Valid() const{
    return m_giveaway_completed_isValid;
}

OAIPaidMessagePriceChanged OAIMessage::getPaidMessagePriceChanged() const {
    return m_paid_message_price_changed;
}
void OAIMessage::setPaidMessagePriceChanged(const OAIPaidMessagePriceChanged &paid_message_price_changed) {
    m_paid_message_price_changed = paid_message_price_changed;
    m_paid_message_price_changed_isSet = true;
}

bool OAIMessage::is_paid_message_price_changed_Set() const{
    return m_paid_message_price_changed_isSet;
}

bool OAIMessage::is_paid_message_price_changed_Valid() const{
    return m_paid_message_price_changed_isValid;
}

OAIVideoChatScheduled OAIMessage::getVideoChatScheduled() const {
    return m_video_chat_scheduled;
}
void OAIMessage::setVideoChatScheduled(const OAIVideoChatScheduled &video_chat_scheduled) {
    m_video_chat_scheduled = video_chat_scheduled;
    m_video_chat_scheduled_isSet = true;
}

bool OAIMessage::is_video_chat_scheduled_Set() const{
    return m_video_chat_scheduled_isSet;
}

bool OAIMessage::is_video_chat_scheduled_Valid() const{
    return m_video_chat_scheduled_isValid;
}

QJsonValue OAIMessage::getVideoChatStarted() const {
    return m_video_chat_started;
}
void OAIMessage::setVideoChatStarted(const QJsonValue &video_chat_started) {
    m_video_chat_started = video_chat_started;
    m_video_chat_started_isSet = true;
}

bool OAIMessage::is_video_chat_started_Set() const{
    return m_video_chat_started_isSet;
}

bool OAIMessage::is_video_chat_started_Valid() const{
    return m_video_chat_started_isValid;
}

OAIVideoChatEnded OAIMessage::getVideoChatEnded() const {
    return m_video_chat_ended;
}
void OAIMessage::setVideoChatEnded(const OAIVideoChatEnded &video_chat_ended) {
    m_video_chat_ended = video_chat_ended;
    m_video_chat_ended_isSet = true;
}

bool OAIMessage::is_video_chat_ended_Set() const{
    return m_video_chat_ended_isSet;
}

bool OAIMessage::is_video_chat_ended_Valid() const{
    return m_video_chat_ended_isValid;
}

OAIVideoChatParticipantsInvited OAIMessage::getVideoChatParticipantsInvited() const {
    return m_video_chat_participants_invited;
}
void OAIMessage::setVideoChatParticipantsInvited(const OAIVideoChatParticipantsInvited &video_chat_participants_invited) {
    m_video_chat_participants_invited = video_chat_participants_invited;
    m_video_chat_participants_invited_isSet = true;
}

bool OAIMessage::is_video_chat_participants_invited_Set() const{
    return m_video_chat_participants_invited_isSet;
}

bool OAIMessage::is_video_chat_participants_invited_Valid() const{
    return m_video_chat_participants_invited_isValid;
}

OAIWebAppData OAIMessage::getWebAppData() const {
    return m_web_app_data;
}
void OAIMessage::setWebAppData(const OAIWebAppData &web_app_data) {
    m_web_app_data = web_app_data;
    m_web_app_data_isSet = true;
}

bool OAIMessage::is_web_app_data_Set() const{
    return m_web_app_data_isSet;
}

bool OAIMessage::is_web_app_data_Valid() const{
