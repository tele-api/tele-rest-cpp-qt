...
OAIInlineQueryResultCachedAudio::OAIInlineQueryResultCachedAudio(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInlineQueryResultCachedAudio::OAIInlineQueryResultCachedAudio() {
    this->initializeModel();
}

OAIInlineQueryResultCachedAudio::~OAIInlineQueryResultCachedAudio() {}

void OAIInlineQueryResultCachedAudio::initializeModel() {
...
void OAIInlineQueryResultCachedAudio::fromJson(QString jsonString) {
...
void OAIInlineQueryResultCachedAudio::fromJsonObject(QJsonObject json) {
...
QString OAIInlineQueryResultCachedAudio::asJson() const {
...
QJsonObject OAIInlineQueryResultCachedAudio::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
QString OAIInlineQueryResultCachedAudio::getType() const {
    return m_type;
}
void OAIInlineQueryResultCachedAudio::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_type_Set() const{
    return m_type_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIInlineQueryResultCachedAudio::getId() const {
    return m_id;
}
void OAIInlineQueryResultCachedAudio::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIInlineQueryResultCachedAudio::getAudioFileId() const {
    return m_audio_file_id;
}
void OAIInlineQueryResultCachedAudio::setAudioFileId(const QString &audio_file_id) {
    m_audio_file_id = audio_file_id;
    m_audio_file_id_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_audio_file_id_Set() const{
    return m_audio_file_id_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_audio_file_id_Valid() const{
    return m_audio_file_id_isValid;
}

QString OAIInlineQueryResultCachedAudio::getCaption() const {
    return m_caption;
}
void OAIInlineQueryResultCachedAudio::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAIInlineQueryResultCachedAudio::getParseMode() const {
    return m_parse_mode;
}
void OAIInlineQueryResultCachedAudio::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIInlineQueryResultCachedAudio::getCaptionEntities() const {
    return m_caption_entities;
}
void OAIInlineQueryResultCachedAudio::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

OAIInlineKeyboardMarkup OAIInlineQueryResultCachedAudio::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIInlineQueryResultCachedAudio::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

OAIInputMessageContent OAIInlineQueryResultCachedAudio::getInputMessageContent() const {
    return m_input_message_content;
}
void OAIInlineQueryResultCachedAudio::setInputMessageContent(const OAIInputMessageContent &input_message_content) {
    m_input_message_content = input_message_content;
    m_input_message_content_isSet = true;
}

bool OAIInlineQueryResultCachedAudio::is_input_message_content_Set() const{
    return m_input_message_content_isSet;
}

bool OAIInlineQueryResultCachedAudio::is_input_message_content_Valid() const{
    return m_input_message_content_isValid;
}

bool OAIInlineQueryResultCachedAudio::isSet() const {
...
bool OAIInlineQueryResultCachedAudio::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_type_isValid && m_id_isValid && m_audio_file_id_isValid && true;
}
