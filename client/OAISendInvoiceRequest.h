...
/*
 * OAISendInvoiceRequest.h
 *
 * Request parameters for sendInvoice
 */

#ifndef OAISendInvoiceRequest_H
#define OAISendInvoiceRequest_H
...
class OAISendInvoiceRequest : public OAIObject {
public:
    OAISendInvoiceRequest();
    OAISendInvoiceRequest(QString json);
    ~OAISendInvoiceRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendInvoiceRequest)

#endif // OAISendInvoiceRequest_H
