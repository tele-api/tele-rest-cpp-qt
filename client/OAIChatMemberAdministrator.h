...
/*
 * OAIChatMemberAdministrator.h
 *
 * Represents a [chat member](https://core.telegram.org/bots/api/#chatmember) that has some additional privileges.
 */

#ifndef OAIChatMemberAdministrator_H
#define OAIChatMemberAdministrator_H
...
class OAIChatMemberAdministrator : public OAIObject {
public:
    OAIChatMemberAdministrator();
    OAIChatMemberAdministrator(QString json);
    ~OAIChatMemberAdministrator() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIChatMemberAdministrator)

#endif // OAIChatMemberAdministrator_H
