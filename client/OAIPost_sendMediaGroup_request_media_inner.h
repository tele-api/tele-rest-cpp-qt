...
/*
 * OAIPost_sendMediaGroup_request_media_inner.h
 *
 * 
 */

#ifndef OAIPost_sendMediaGroup_request_media_inner_H
#define OAIPost_sendMediaGroup_request_media_inner_H
...
class OAIPost_sendMediaGroup_request_media_inner : public OAIObject {
public:
    OAIPost_sendMediaGroup_request_media_inner();
    OAIPost_sendMediaGroup_request_media_inner(QString json);
    ~OAIPost_sendMediaGroup_request_media_inner() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendMediaGroup_request_media_inner)

#endif // OAIPost_sendMediaGroup_request_media_inner_H
