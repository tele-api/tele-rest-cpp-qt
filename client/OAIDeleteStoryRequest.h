...
/*
 * OAIDeleteStoryRequest.h
 *
 * Request parameters for deleteStory
 */

#ifndef OAIDeleteStoryRequest_H
#define OAIDeleteStoryRequest_H
...
class OAIDeleteStoryRequest : public OAIObject {
public:
    OAIDeleteStoryRequest();
    OAIDeleteStoryRequest(QString json);
    ~OAIDeleteStoryRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIDeleteStoryRequest)

#endif // OAIDeleteStoryRequest_H
