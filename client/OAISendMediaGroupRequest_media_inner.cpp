...
OAISendMediaGroupRequest_media_inner::OAISendMediaGroupRequest_media_inner(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMediaGroupRequest_media_inner::OAISendMediaGroupRequest_media_inner() {
    this->initializeModel();
}

OAISendMediaGroupRequest_media_inner::~OAISendMediaGroupRequest_media_inner() {}

void OAISendMediaGroupRequest_media_inner::initializeModel() {
...
void OAISendMediaGroupRequest_media_inner::fromJson(QString jsonString) {
...
void OAISendMediaGroupRequest_media_inner::fromJsonObject(QJsonObject json) {
...
QString OAISendMediaGroupRequest_media_inner::asJson() const {
...
QJsonObject OAISendMediaGroupRequest_media_inner::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
QString OAISendMediaGroupRequest_media_inner::getType() const {
    return m_type;
}
void OAISendMediaGroupRequest_media_inner::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_type_Set() const{
    return m_type_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_type_Valid() const{
    return m_type_isValid;
}

QString OAISendMediaGroupRequest_media_inner::getMedia() const {
    return m_media;
}
void OAISendMediaGroupRequest_media_inner::setMedia(const QString &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_media_Set() const{
    return m_media_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_media_Valid() const{
    return m_media_isValid;
}

QString OAISendMediaGroupRequest_media_inner::getThumbnail() const {
    return m_thumbnail;
}
void OAISendMediaGroupRequest_media_inner::setThumbnail(const QString &thumbnail) {
    m_thumbnail = thumbnail;
    m_thumbnail_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_thumbnail_Set() const{
    return m_thumbnail_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_thumbnail_Valid() const{
    return m_thumbnail_isValid;
}

QString OAISendMediaGroupRequest_media_inner::getCaption() const {
    return m_caption;
}
void OAISendMediaGroupRequest_media_inner::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAISendMediaGroupRequest_media_inner::getParseMode() const {
    return m_parse_mode;
}
void OAISendMediaGroupRequest_media_inner::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAISendMediaGroupRequest_media_inner::getCaptionEntities() const {
    return m_caption_entities;
}
void OAISendMediaGroupRequest_media_inner::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

qint32 OAISendMediaGroupRequest_media_inner::getDuration() const {
    return m_duration;
}
void OAISendMediaGroupRequest_media_inner::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_duration_Valid() const{
    return m_duration_isValid;
}

QString OAISendMediaGroupRequest_media_inner::getPerformer() const {
    return m_performer;
}
void OAISendMediaGroupRequest_media_inner::setPerformer(const QString &performer) {
    m_performer = performer;
    m_performer_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_performer_Set() const{
    return m_performer_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_performer_Valid() const{
    return m_performer_isValid;
}

QString OAISendMediaGroupRequest_media_inner::getTitle() const {
    return m_title;
}
void OAISendMediaGroupRequest_media_inner::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_title_Set() const{
    return m_title_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_title_Valid() const{
    return m_title_isValid;
}

bool OAISendMediaGroupRequest_media_inner::isDisableContentTypeDetection() const {
    return m_disable_content_type_detection;
}
void OAISendMediaGroupRequest_media_inner::setDisableContentTypeDetection(const bool &disable_content_type_detection) {
    m_disable_content_type_detection = disable_content_type_detection;
    m_disable_content_type_detection_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_disable_content_type_detection_Set() const{
    return m_disable_content_type_detection_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_disable_content_type_detection_Valid() const{
    return m_disable_content_type_detection_isValid;
}

bool OAISendMediaGroupRequest_media_inner::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAISendMediaGroupRequest_media_inner::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

bool OAISendMediaGroupRequest_media_inner::isHasSpoiler() const {
    return m_has_spoiler;
}
void OAISendMediaGroupRequest_media_inner::setHasSpoiler(const bool &has_spoiler) {
    m_has_spoiler = has_spoiler;
    m_has_spoiler_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_has_spoiler_Set() const{
    return m_has_spoiler_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_has_spoiler_Valid() const{
    return m_has_spoiler_isValid;
}

QString OAISendMediaGroupRequest_media_inner::getCover() const {
    return m_cover;
}
void OAISendMediaGroupRequest_media_inner::setCover(const QString &cover) {
    m_cover = cover;
    m_cover_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_cover_Set() const{
    return m_cover_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_cover_Valid() const{
    return m_cover_isValid;
}

qint32 OAISendMediaGroupRequest_media_inner::getStartTimestamp() const {
    return m_start_timestamp;
}
void OAISendMediaGroupRequest_media_inner::setStartTimestamp(const qint32 &start_timestamp) {
    m_start_timestamp = start_timestamp;
    m_start_timestamp_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_start_timestamp_Set() const{
    return m_start_timestamp_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_start_timestamp_Valid() const{
    return m_start_timestamp_isValid;
}

qint32 OAISendMediaGroupRequest_media_inner::getWidth() const {
    return m_width;
}
void OAISendMediaGroupRequest_media_inner::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_width_Set() const{
    return m_width_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_width_Valid() const{
    return m_width_isValid;
}

qint32 OAISendMediaGroupRequest_media_inner::getHeight() const {
    return m_height;
}
void OAISendMediaGroupRequest_media_inner::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_height_Set() const{
    return m_height_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_height_Valid() const{
    return m_height_isValid;
}

bool OAISendMediaGroupRequest_media_inner::isSupportsStreaming() const {
    return m_supports_streaming;
}
void OAISendMediaGroupRequest_media_inner::setSupportsStreaming(const bool &supports_streaming) {
    m_supports_streaming = supports_streaming;
    m_supports_streaming_isSet = true;
}

bool OAISendMediaGroupRequest_media_inner::is_supports_streaming_Set() const{
    return m_supports_streaming_isSet;
}

bool OAISendMediaGroupRequest_media_inner::is_supports_streaming_Valid() const{
    return m_supports_streaming_isValid;
}

bool OAISendMediaGroupRequest_media_inner::isSet() const {
...
bool OAISendMediaGroupRequest_media_inner::isValid() const {
