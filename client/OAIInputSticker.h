...
#ifndef OAIInputSticker_H
#define OAIInputSticker_H
...
class OAIInputSticker : public OAIObject {
public:
    OAIInputSticker();
    OAIInputSticker(QString json);
    ~OAIInputSticker() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInputSticker)

#endif // OAIInputSticker_H
