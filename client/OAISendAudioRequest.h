...
/*
 * OAISendAudioRequest.h
 *
 * Request parameters for sendAudio
 */

#ifndef OAISendAudioRequest_H
#define OAISendAudioRequest_H
...
class OAISendAudioRequest : public OAIObject {
public:
    OAISendAudioRequest();
    OAISendAudioRequest(QString json);
    ~OAISendAudioRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendAudioRequest)

#endif // OAISendAudioRequest_H
