...
/*
 * OAISendPollRequest.h
 *
 * Request parameters for sendPoll
 */

#ifndef OAISendPollRequest_H
#define OAISendPollRequest_H
...
class OAISendPollRequest : public OAIObject {
public:
    OAISendPollRequest();
    OAISendPollRequest(QString json);
    ~OAISendPollRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendPollRequest)

#endif // OAISendPollRequest_H
