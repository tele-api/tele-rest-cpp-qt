...
/*
 * OAIPost_sendPoll_request.h
 *
 * 
 */

#ifndef OAIPost_sendPoll_request_H
#define OAIPost_sendPoll_request_H
...
class OAIPost_sendPoll_request : public OAIObject {
public:
    OAIPost_sendPoll_request();
    OAIPost_sendPoll_request(QString json);
    ~OAIPost_sendPoll_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendPoll_request)

#endif // OAIPost_sendPoll_request_H
