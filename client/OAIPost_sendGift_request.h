...
/*
 * OAIPost_sendGift_request.h
 *
 * 
 */

#ifndef OAIPost_sendGift_request_H
#define OAIPost_sendGift_request_H
...
class OAIPost_sendGift_request : public OAIObject {
public:
    OAIPost_sendGift_request();
    OAIPost_sendGift_request(QString json);
    ~OAIPost_sendGift_request() override;
    ...
    OAIPost_sendGift_request_chat_id getChatId() const;
    void setChatId(const OAIPost_sendGift_request_chat_id &chat_id);
...
private:
    ...
    OAIPost_sendGift_request_chat_id m_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendGift_request)

#endif // OAIPost_sendGift_request_H
