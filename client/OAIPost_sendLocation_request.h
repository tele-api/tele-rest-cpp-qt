...
/*
 * OAIPost_sendLocation_request.h
 *
 * 
 */

#ifndef OAIPost_sendLocation_request_H
#define OAIPost_sendLocation_request_H
...
class OAIPost_sendMessage_request_reply_markup;

class OAIPost_sendLocation_request : public OAIObject {
public:
    OAIPost_sendLocation_request();
    OAIPost_sendLocation_request(QString json);
    ~OAIPost_sendLocation_request() override;
    ...
    OAIPost_sendMessage_request_reply_markup getReplyMarkup() const;
    void setReplyMarkup(const OAIPost_sendMessage_request_reply_markup &reply_markup);
...
private:
    ...
    OAIPost_sendMessage_request_reply_markup m_reply_markup;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendLocation_request)

#endif // OAIPost_sendLocation_request_H
