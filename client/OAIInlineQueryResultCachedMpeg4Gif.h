...
/*
 * OAIInlineQueryResultCachedMpeg4Gif.h
 *
 * Represents a link to a video animation (H.264/MPEG-4 AVC video without sound) stored on the Telegram servers. By default, this animated MPEG-4 file will be sent by the user with an optional caption. Alternatively, you can use *input\\_message\\_content* to send a message with the specified content instead of the animation.
 */

#ifndef OAIInlineQueryResultCachedMpeg4Gif_H
#define OAIInlineQueryResultCachedMpeg4Gif_H
...
class OAIInlineQueryResultCachedMpeg4Gif : public OAIObject {
public:
    OAIInlineQueryResultCachedMpeg4Gif();
    OAIInlineQueryResultCachedMpeg4Gif(QString json);
    ~OAIInlineQueryResultCachedMpeg4Gif() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInlineQueryResultCachedMpeg4Gif)

#endif // OAIInlineQueryResultCachedMpeg4Gif_H
