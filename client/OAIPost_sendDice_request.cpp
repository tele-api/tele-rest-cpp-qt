...
#include "OAIPost_sendDice_request.h"
...
OAIPost_sendDice_request::OAIPost_sendDice_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_sendDice_request::OAIPost_sendDice_request() {
    this->initializeModel();
}

OAIPost_sendDice_request::~OAIPost_sendDice_request() {}

void OAIPost_sendDice_request::initializeModel() {
...
void OAIPost_sendDice_request::fromJson(QString jsonString) {
...
void OAIPost_sendDice_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_sendDice_request::asJson() const {
...
QJsonObject OAIPost_sendDice_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_sendDice_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_sendDice_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_sendDice_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_sendDice_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAIPost_sendDice_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_sendDice_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_sendDice_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_sendDice_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAIPost_sendDice_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_sendDice_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_sendDice_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_sendDice_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAIPost_sendDice_request::getEmoji() const {
    return m_emoji;
}
void OAIPost_sendDice_request::setEmoji(const QString &emoji) {
    m_emoji = emoji;
    m_emoji_isSet = true;
}

bool OAIPost_sendDice_request::is_emoji_Set() const{
    return m_emoji_isSet;
}

bool OAIPost_sendDice_request::is_emoji_Valid() const{
    return m_emoji_isValid;
}

bool OAIPost_sendDice_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPost_sendDice_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPost_sendDice_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPost_sendDice_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPost_sendDice_request::isProtectContent() const {
    return m_protect_content;
}
void OAIPost_sendDice_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIPost_sendDice_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIPost_sendDice_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIPost_sendDice_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAIPost_sendDice_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAIPost_sendDice_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAIPost_sendDice_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAIPost_sendDice_request::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAIPost_sendDice_request::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAIPost_sendDice_request::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAIPost_sendDice_request::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAIPost_sendDice_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAIPost_sendDice_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAIPost_sendDice_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAIPost_sendDice_request::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAIPost_sendMessage_request_reply_markup OAIPost_sendDice_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_sendDice_request::setReplyMarkup(const OAIPost_sendMessage_request_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_sendDice_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_sendDice_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_sendDice_request::isSet() const {
...
bool OAIPost_sendDice_request::isValid() const {
