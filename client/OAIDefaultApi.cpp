...
void OAIDefaultApi::postAddStickerToSetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_setWebhook_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postAnswerWebAppQueryCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_answerWebAppQuery_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postApproveChatJoinRequest(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &user_id) {
...
void OAIDefaultApi::postBanChatMember(const OAIPost_banChatMember_request_chat_id &chat_id, const qint32 &user_id, const ::tele_rest::OptionalParam<qint32> &until_date, const ::tele_rest::OptionalParam<bool> &revoke_messages) {
...
void OAIDefaultApi::postBanChatSenderChat(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &sender_chat_id) {
...
void OAIDefaultApi::postCloseForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id, const qint32 &message_thread_id) {
...
void OAIDefaultApi::postCloseGeneralForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id) {
...
void OAIDefaultApi::postCopyMessageCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_copyMessage_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postCopyMessagesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_forwardMessages_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postCreateChatInviteLink(const OAIPost_sendMessage_request_chat_id &chat_id, const ::tele_rest::OptionalParam<QString> &name, const ::tele_rest::OptionalParam<qint32> &expire_date, const ::tele_rest::OptionalParam<qint32> &member_limit, const ::tele_rest::OptionalParam<bool> &creates_join_request) {
...
void OAIDefaultApi::postCreateChatInviteLinkCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_createChatInviteLink_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postCreateChatSubscriptionInviteLink(const OAIPost_createChatSubscriptionInviteLink_request_chat_id &chat_id, const qint32 &subscription_period, const qint32 &subscription_price, const ::tele_rest::OptionalParam<QString> &name) {
...
void OAIDefaultApi::postCreateForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id, const QString &name, const ::tele_rest::OptionalParam<qint32> &icon_color, const ::tele_rest::OptionalParam<QString> &icon_custom_emoji_id) {
...
void OAIDefaultApi::postCreateForumTopicCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_createForumTopic_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postCreateInvoiceLinkCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_exportChatInviteLink_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postDeclineChatJoinRequest(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &user_id) {
...
void OAIDefaultApi::postDeleteChatPhoto(const OAIPost_sendMessage_request_chat_id &chat_id) {
...
void OAIDefaultApi::postDeleteChatStickerSet(const OAIPost_restrictChatMember_request_chat_id &chat_id) {
...
void OAIDefaultApi::postDeleteForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id, const qint32 &message_thread_id) {
...
void OAIDefaultApi::postDeleteMessage(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &message_id) {
...
void OAIDefaultApi::postDeleteMessages(const OAIPost_sendMessage_request_chat_id &chat_id, const QList<qint32> &message_ids) {
...
void OAIDefaultApi::postEditChatSubscriptionInviteLink(const OAIPost_sendMessage_request_chat_id &chat_id, const QString &invite_link, const ::tele_rest::OptionalParam<QString> &name) {
...
void OAIDefaultApi::postEditForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id, const qint32 &message_thread_id, const ::tele_rest::OptionalParam<QString> &name, const ::tele_rest::OptionalParam<QString> &icon_custom_emoji_id) {
...
void OAIDefaultApi::postEditGeneralForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id, const QString &name) {
...
void OAIDefaultApi::postEditMessageCaptionCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_editMessageText_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postEditMessageMedia(const OAIInputMedia &media, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<OAIPost_editMessageText_request_chat_id> &chat_id, const ::tele_rest::OptionalParam<qint32> &message_id, const ::tele_rest::OptionalParam<QString> &inline_message_id, const ::tele_rest::OptionalParam<OAIInlineKeyboardMarkup> &reply_markup) {
...
void OAIDefaultApi::postEditMessageReplyMarkup(const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<OAIPost_editMessageText_request_chat_id> &chat_id, const ::tele_rest::OptionalParam<qint32> &message_id, const ::tele_rest::OptionalParam<QString> &inline_message_id, const ::tele_rest::OptionalParam<OAIInlineKeyboardMarkup> &reply_markup) {
...
void OAIDefaultApi::postEditStoryCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_postStory_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postExportChatInviteLink(const OAIPost_sendMessage_request_chat_id &chat_id) {
...
void OAIDefaultApi::postForwardMessageCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_sendMessage_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetAvailableGiftsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getAvailableGifts_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetBusinessAccountGiftsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getBusinessAccountGifts_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetBusinessAccountStarBalanceCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getBusinessAccountStarBalance_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetBusinessConnectionCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getBusinessConnection_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetChat(const OAIPost_leaveChat_request_chat_id &chat_id) {
...
void OAIDefaultApi::postGetChatCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getChat_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetChatAdministrators(const OAIPost_leaveChat_request_chat_id &chat_id) {
...
void OAIDefaultApi::postGetChatAdministratorsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getChatAdministrators_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetChatMember(const OAIPost_leaveChat_request_chat_id &chat_id, const qint32 &user_id) {
...
void OAIDefaultApi::postGetChatMemberCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getChatMember_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetChatMemberCount(const OAIPost_leaveChat_request_chat_id &chat_id) {
...
void OAIDefaultApi::postGetChatMemberCountCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getChatMemberCount_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetChatMenuButtonCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getChatMenuButton_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetCustomEmojiStickersCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getForumTopicIconStickers_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetFileCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getFile_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetGameHighScoresCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getGameHighScores_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetMeCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getMe_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetMyCommandsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getMyCommands_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetMyDefaultAdministratorRightsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getMyDefaultAdministratorRights_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetMyDescriptionCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getMyDescription_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetMyNameCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getMyName_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetMyShortDescriptionCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getMyShortDescription_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetStarTransactionsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getStarTransactions_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetStickerSetCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getStickerSet_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetUpdatesCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getUpdates_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetUserChatBoosts(const OAIPost_getUserChatBoosts_request_chat_id &chat_id, const qint32 &user_id) {
...
void OAIDefaultApi::postGetUserChatBoostsCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getUserChatBoosts_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetUserProfilePhotosCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getUserProfilePhotos_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postGetWebhookInfoCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_getWebhookInfo_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postHideGeneralForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id) {
...
void OAIDefaultApi::postLeaveChat(const OAIPost_leaveChat_request_chat_id &chat_id) {
...
void OAIDefaultApi::postPinChatMessage(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &message_id, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<bool> &disable_notification) {
...
void OAIDefaultApi::postRemoveChatVerification(const OAIPost_sendMessage_request_chat_id &chat_id) {
...
void OAIDefaultApi::postReopenForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id, const qint32 &message_thread_id) {
...
void OAIDefaultApi::postReopenGeneralForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id) {
...
void OAIDefaultApi::postRestrictChatMember(const OAIPost_restrictChatMember_request_chat_id &chat_id, const qint32 &user_id, const OAIChatPermissions &permissions, const ::tele_rest::OptionalParam<bool> &use_independent_chat_permissions, const ::tele_rest::OptionalParam<qint32> &until_date) {
...
void OAIDefaultApi::postRevokeChatInviteLink(const OAIPost_revokeChatInviteLink_request_chat_id &chat_id, const QString &invite_link) {
...
void OAIDefaultApi::postSavePreparedInlineMessageCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_savePreparedInlineMessage_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postSendAnimation(const OAIPost_sendMessage_request_chat_id &chat_id, const OAIPost_sendAnimation_request_animation &animation, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<qint32> &duration, const ::tele_rest::OptionalParam<qint32> &width, const ::tele_rest::OptionalParam<qint32> &height, const ::tele_rest::OptionalParam<OAIPost_sendAudio_request_thumbnail> &thumbnail, const ::tele_rest::OptionalParam<QString> &caption, const ::tele_rest::OptionalParam<QString> &parse_mode, const ::tele_rest::OptionalParam<QList<OAIMessageEntity>> &caption_entities, const ::tele_rest::OptionalParam<bool> &show_caption_above_media, const ::tele_rest::OptionalParam<bool> &has_spoiler, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters, const ::tele_rest::OptionalParam<OAIPost_sendMessage_request_reply_markup> &reply_markup) {
...
void OAIDefaultApi::postSendAudio(const OAIPost_sendMessage_request_chat_id &chat_id, const OAIPost_sendAudio_request_audio &audio, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<QString> &caption, const ::tele_rest::OptionalParam<QString> &parse_mode, const ::tele_rest::OptionalParam<QList<OAIMessageEntity>> &caption_entities, const ::tele_rest::OptionalParam<qint32> &duration, const ::tele_rest::OptionalParam<QString> &performer, const ::tele_rest::OptionalParam<QString> &title, const ::tele_rest::OptionalParam<OAIPost_sendAudio_request_thumbnail> &thumbnail, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters, const ::tele_rest::OptionalParam<OAIPost_sendMessage_request_reply_markup> &reply_markup) {
...
void OAIDefaultApi::postSendChatAction(const OAIPost_sendMessage_request_chat_id &chat_id, const QString &action, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id) {
...
void OAIDefaultApi::postSendDocument(const OAIPost_sendMessage_request_chat_id &chat_id, const OAIPost_sendDocument_request_document &document, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<OAIPost_sendAudio_request_thumbnail> &thumbnail, const ::tele_rest::OptionalParam<QString> &caption, const ::tele_rest::OptionalParam<QString> &parse_mode, const ::tele_rest::OptionalParam<QList<OAIMessageEntity>> &caption_entities, const ::tele_rest::OptionalParam<bool> &disable_content_type_detection, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters, const ::tele_rest::OptionalParam<OAIPost_sendMessage_request_reply_markup> &reply_markup) {
...
void OAIDefaultApi::postSendMediaGroup(const OAIPost_sendMessage_request_chat_id &chat_id, const QList<OAIPost_sendMediaGroup_request_media_inner> &media, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters) {
...
void OAIDefaultApi::postSendMediaGroupCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_sendMediaGroup_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postSendPhoto(const OAIPost_sendMessage_request_chat_id &chat_id, const OAIPost_sendPhoto_request_photo &photo, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<QString> &caption, const ::tele_rest::OptionalParam<QString> &parse_mode, const ::tele_rest::OptionalParam<QList<OAIMessageEntity>> &caption_entities, const ::tele_rest::OptionalParam<bool> &show_caption_above_media, const ::tele_rest::OptionalParam<bool> &has_spoiler, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters, const ::tele_rest::OptionalParam<OAIPost_sendMessage_request_reply_markup> &reply_markup) {
...
void OAIDefaultApi::postSendVideo(const OAIPost_sendMessage_request_chat_id &chat_id, const OAIPost_sendVideo_request_video &video, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<qint32> &duration, const ::tele_rest::OptionalParam<qint32> &width, const ::tele_rest::OptionalParam<qint32> &height, const ::tele_rest::OptionalParam<OAIPost_sendAudio_request_thumbnail> &thumbnail, const ::tele_rest::OptionalParam<OAIPost_sendVideo_request_cover> &cover, const ::tele_rest::OptionalParam<qint32> &start_timestamp, const ::tele_rest::OptionalParam<QString> &caption, const ::tele_rest::OptionalParam<QString> &parse_mode, const ::tele_rest::OptionalParam<QList<OAIMessageEntity>> &caption_entities, const ::tele_rest::OptionalParam<bool> &show_caption_above_media, const ::tele_rest::OptionalParam<bool> &has_spoiler, const ::tele_rest::OptionalParam<bool> &supports_streaming, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters, const ::tele_rest::OptionalParam<OAIPost_sendMessage_request_reply_markup> &reply_markup) {
...
void OAIDefaultApi::postSendVideoNote(const OAIPost_sendMessage_request_chat_id &chat_id, const OAIPost_sendVideoNote_request_video_note &video_note, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<qint32> &duration, const ::tele_rest::OptionalParam<qint32> &length, const ::tele_rest::OptionalParam<OAIPost_sendAudio_request_thumbnail> &thumbnail, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters, const ::tele_rest::OptionalParam<OAIPost_sendMessage_request_reply_markup> &reply_markup) {
...
void OAIDefaultApi::postSendVoice(const OAIPost_sendMessage_request_chat_id &chat_id, const OAIPost_sendVoice_request_voice &voice, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_thread_id, const ::tele_rest::OptionalParam<QString> &caption, const ::tele_rest::OptionalParam<QString> &parse_mode, const ::tele_rest::OptionalParam<QList<OAIMessageEntity>> &caption_entities, const ::tele_rest::OptionalParam<qint32> &duration, const ::tele_rest::OptionalParam<bool> &disable_notification, const ::tele_rest::OptionalParam<bool> &protect_content, const ::tele_rest::OptionalParam<bool> &allow_paid_broadcast, const ::tele_rest::OptionalParam<QString> &message_effect_id, const ::tele_rest::OptionalParam<OAIReplyParameters> &reply_parameters, const ::tele_rest::OptionalParam<OAIPost_sendMessage_request_reply_markup> &reply_markup) {
...
void OAIDefaultApi::postSetChatAdministratorCustomTitle(const OAIPost_restrictChatMember_request_chat_id &chat_id, const qint32 &user_id, const QString &custom_title) {
...
void OAIDefaultApi::postSetChatDescription(const OAIPost_sendMessage_request_chat_id &chat_id, const ::tele_rest::OptionalParam<QString> &description) {
...
void OAIDefaultApi::postSetChatPermissions(const OAIPost_restrictChatMember_request_chat_id &chat_id, const OAIChatPermissions &permissions, const ::tele_rest::OptionalParam<bool> &use_independent_chat_permissions) {
...
void OAIDefaultApi::postSetChatPhoto(const OAIPost_sendMessage_request_chat_id &chat_id, const QJsonValue &photo) {
...
void OAIDefaultApi::postSetChatStickerSet(const OAIPost_restrictChatMember_request_chat_id &chat_id, const QString &sticker_set_name) {
...
void OAIDefaultApi::postSetChatTitle(const OAIPost_sendMessage_request_chat_id &chat_id, const QString &title) {
...
void OAIDefaultApi::postSetMessageReaction(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &message_id, const ::tele_rest::OptionalParam<QList<OAIReactionType>> &reaction, const ::tele_rest::OptionalParam<bool> &is_big) {
...
void OAIDefaultApi::postSetStickerSetThumbnail(const QString &name, const qint32 &user_id, const QString &format, const ::tele_rest::OptionalParam<OAIPost_setStickerSetThumbnail_request_thumbnail> &thumbnail) {
...
void OAIDefaultApi::postStopPoll(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &message_id, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<OAIInlineKeyboardMarkup> &reply_markup) {
...
void OAIDefaultApi::postStopPollCallback(OAIHttpRequestWorker *worker) {
    ...
    OAIPost_stopPoll_200_response output(QString(worker->response));
    worker->deleteLater();
...
void OAIDefaultApi::postUnbanChatMember(const OAIPost_banChatMember_request_chat_id &chat_id, const qint32 &user_id, const ::tele_rest::OptionalParam<bool> &only_if_banned) {
...
void OAIDefaultApi::postUnbanChatSenderChat(const OAIPost_sendMessage_request_chat_id &chat_id, const qint32 &sender_chat_id) {
...
void OAIDefaultApi::postUnhideGeneralForumTopic(const OAIPost_restrictChatMember_request_chat_id &chat_id) {
...
void OAIDefaultApi::postUnpinAllChatMessages(const OAIPost_sendMessage_request_chat_id &chat_id) {
...
void OAIDefaultApi::postUnpinAllForumTopicMessages(const OAIPost_restrictChatMember_request_chat_id &chat_id, const qint32 &message_thread_id) {
...
void OAIDefaultApi::postUnpinAllGeneralForumTopicMessages(const OAIPost_restrictChatMember_request_chat_id &chat_id) {
...
void OAIDefaultApi::postUnpinChatMessage(const OAIPost_sendMessage_request_chat_id &chat_id, const ::tele_rest::OptionalParam<QString> &business_connection_id, const ::tele_rest::OptionalParam<qint32> &message_id) {
...
void OAIDefaultApi::postVerifyChat(const OAIPost_sendMessage_request_chat_id &chat_id, const ::tele_rest::OptionalParam<QString> &custom_description) {
