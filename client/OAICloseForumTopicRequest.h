...
/*
 * OAICloseForumTopicRequest.h
 *
 * Request parameters for closeForumTopic
 */

#ifndef OAICloseForumTopicRequest_H
#define OAICloseForumTopicRequest_H
...
class OAICloseForumTopicRequest : public OAIObject {
public:
    OAICloseForumTopicRequest();
    OAICloseForumTopicRequest(QString json);
    ~OAICloseForumTopicRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAICloseForumTopicRequest)

#endif // OAICloseForumTopicRequest_H
