...
/*
 * OAISetBusinessAccountProfilePhotoRequest.h
 *
 * Request parameters for setBusinessAccountProfilePhoto
 */

#ifndef OAISetBusinessAccountProfilePhotoRequest_H
#define OAISetBusinessAccountProfilePhotoRequest_H
...
namespace tele_rest {
class OAIInputProfilePhoto;

class OAISetBusinessAccountProfilePhotoRequest : public OAIObject {
public:
    OAISetBusinessAccountProfilePhotoRequest();
    OAISetBusinessAccountProfilePhotoRequest(QString json);
    ~OAISetBusinessAccountProfilePhotoRequest() override;
    ...
    OAIInputProfilePhoto getPhoto() const;
    void setPhoto(const OAIInputProfilePhoto &photo);
...
Q_DECLARE_METATYPE(tele_rest::OAISetBusinessAccountProfilePhotoRequest)

#endif // OAISetBusinessAccountProfilePhotoRequest_H
