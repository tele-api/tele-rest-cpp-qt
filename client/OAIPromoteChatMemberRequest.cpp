...
#include "OAIPromoteChatMemberRequest.h"
...
OAIPromoteChatMemberRequest::OAIPromoteChatMemberRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPromoteChatMemberRequest::OAIPromoteChatMemberRequest() {
    this->initializeModel();
}

OAIPromoteChatMemberRequest::~OAIPromoteChatMemberRequest() {}

void OAIPromoteChatMemberRequest::initializeModel() {
...
void OAIPromoteChatMemberRequest::fromJson(QString jsonString) {
...
void OAIPromoteChatMemberRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPromoteChatMemberRequest::asJson() const {
...
QJsonObject OAIPromoteChatMemberRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAIPromoteChatMemberRequest::getChatId() const {
    return m_chat_id;
}
void OAIPromoteChatMemberRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPromoteChatMemberRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIPromoteChatMemberRequest::getUserId() const {
    return m_user_id;
}
void OAIPromoteChatMemberRequest::setUserId(const qint32 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIPromoteChatMemberRequest::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIPromoteChatMemberRequest::isIsAnonymous() const {
    return m_is_anonymous;
}
void OAIPromoteChatMemberRequest::setIsAnonymous(const bool &is_anonymous) {
    m_is_anonymous = is_anonymous;
    m_is_anonymous_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_is_anonymous_Set() const{
    return m_is_anonymous_isSet;
}

bool OAIPromoteChatMemberRequest::is_is_anonymous_Valid() const{
    return m_is_anonymous_isValid;
}

bool OAIPromoteChatMemberRequest::isCanManageChat() const {
    return m_can_manage_chat;
}
void OAIPromoteChatMemberRequest::setCanManageChat(const bool &can_manage_chat) {
    m_can_manage_chat = can_manage_chat;
    m_can_manage_chat_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_manage_chat_Set() const{
    return m_can_manage_chat_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_manage_chat_Valid() const{
    return m_can_manage_chat_isValid;
}

bool OAIPromoteChatMemberRequest::isCanDeleteMessages() const {
    return m_can_delete_messages;
}
void OAIPromoteChatMemberRequest::setCanDeleteMessages(const bool &can_delete_messages) {
    m_can_delete_messages = can_delete_messages;
    m_can_delete_messages_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_delete_messages_Set() const{
    return m_can_delete_messages_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_delete_messages_Valid() const{
    return m_can_delete_messages_isValid;
}

bool OAIPromoteChatMemberRequest::isCanManageVideoChats() const {
    return m_can_manage_video_chats;
}
void OAIPromoteChatMemberRequest::setCanManageVideoChats(const bool &can_manage_video_chats) {
    m_can_manage_video_chats = can_manage_video_chats;
    m_can_manage_video_chats_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_manage_video_chats_Set() const{
    return m_can_manage_video_chats_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_manage_video_chats_Valid() const{
    return m_can_manage_video_chats_isValid;
}

bool OAIPromoteChatMemberRequest::isCanRestrictMembers() const {
    return m_can_restrict_members;
}
void OAIPromoteChatMemberRequest::setCanRestrictMembers(const bool &can_restrict_members) {
    m_can_restrict_members = can_restrict_members;
    m_can_restrict_members_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_restrict_members_Set() const{
    return m_can_restrict_members_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_restrict_members_Valid() const{
    return m_can_restrict_members_isValid;
}

bool OAIPromoteChatMemberRequest::isCanPromoteMembers() const {
    return m_can_promote_members;
}
void OAIPromoteChatMemberRequest::setCanPromoteMembers(const bool &can_promote_members) {
    m_can_promote_members = can_promote_members;
    m_can_promote_members_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_promote_members_Set() const{
    return m_can_promote_members_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_promote_members_Valid() const{
    return m_can_promote_members_isValid;
}

bool OAIPromoteChatMemberRequest::isCanChangeInfo() const {
    return m_can_change_info;
}
void OAIPromoteChatMemberRequest::setCanChangeInfo(const bool &can_change_info) {
    m_can_change_info = can_change_info;
    m_can_change_info_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_change_info_Set() const{
    return m_can_change_info_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_change_info_Valid() const{
    return m_can_change_info_isValid;
}

bool OAIPromoteChatMemberRequest::isCanInviteUsers() const {
    return m_can_invite_users;
}
void OAIPromoteChatMemberRequest::setCanInviteUsers(const bool &can_invite_users) {
    m_can_invite_users = can_invite_users;
    m_can_invite_users_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_invite_users_Set() const{
    return m_can_invite_users_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_invite_users_Valid() const{
    return m_can_invite_users_isValid;
}

bool OAIPromoteChatMemberRequest::isCanPostStories() const {
    return m_can_post_stories;
}
void OAIPromoteChatMemberRequest::setCanPostStories(const bool &can_post_stories) {
    m_can_post_stories = can_post_stories;
    m_can_post_stories_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_post_stories_Set() const{
    return m_can_post_stories_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_post_stories_Valid() const{
    return m_can_post_stories_isValid;
}

bool OAIPromoteChatMemberRequest::isCanEditStories() const {
    return m_can_edit_stories;
}
void OAIPromoteChatMemberRequest::setCanEditStories(const bool &can_edit_stories) {
    m_can_edit_stories = can_edit_stories;
    m_can_edit_stories_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_edit_stories_Set() const{
    return m_can_edit_stories_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_edit_stories_Valid() const{
    return m_can_edit_stories_isValid;
}

bool OAIPromoteChatMemberRequest::isCanDeleteStories() const {
    return m_can_delete_stories;
}
void OAIPromoteChatMemberRequest::setCanDeleteStories(const bool &can_delete_stories) {
    m_can_delete_stories = can_delete_stories;
    m_can_delete_stories_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_delete_stories_Set() const{
    return m_can_delete_stories_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_delete_stories_Valid() const{
    return m_can_delete_stories_isValid;
}

bool OAIPromoteChatMemberRequest::isCanPostMessages() const {
    return m_can_post_messages;
}
void OAIPromoteChatMemberRequest::setCanPostMessages(const bool &can_post_messages) {
    m_can_post_messages = can_post_messages;
    m_can_post_messages_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_post_messages_Set() const{
    return m_can_post_messages_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_post_messages_Valid() const{
    return m_can_post_messages_isValid;
}

bool OAIPromoteChatMemberRequest::isCanEditMessages() const {
    return m_can_edit_messages;
}
void OAIPromoteChatMemberRequest::setCanEditMessages(const bool &can_edit_messages) {
    m_can_edit_messages = can_edit_messages;
    m_can_edit_messages_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_edit_messages_Set() const{
    return m_can_edit_messages_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_edit_messages_Valid() const{
    return m_can_edit_messages_isValid;
}

bool OAIPromoteChatMemberRequest::isCanPinMessages() const {
    return m_can_pin_messages;
}
void OAIPromoteChatMemberRequest::setCanPinMessages(const bool &can_pin_messages) {
    m_can_pin_messages = can_pin_messages;
    m_can_pin_messages_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_pin_messages_Set() const{
    return m_can_pin_messages_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_pin_messages_Valid() const{
    return m_can_pin_messages_isValid;
}

bool OAIPromoteChatMemberRequest::isCanManageTopics() const {
    return m_can_manage_topics;
}
void OAIPromoteChatMemberRequest::setCanManageTopics(const bool &can_manage_topics) {
    m_can_manage_topics = can_manage_topics;
    m_can_manage_topics_isSet = true;
}

bool OAIPromoteChatMemberRequest::is_can_manage_topics_Set() const{
    return m_can_manage_topics_isSet;
}

bool OAIPromoteChatMemberRequest::is_can_manage_topics_Valid() const{
    return m_can_manage_topics_isValid;
}

bool OAIPromoteChatMemberRequest::isSet() const {
...
bool OAIPromoteChatMemberRequest::isValid() const {
