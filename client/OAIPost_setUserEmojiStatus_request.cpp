...
#include "OAIPost_setUserEmojiStatus_request.h"
...
OAIPost_setUserEmojiStatus_request::OAIPost_setUserEmojiStatus_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_setUserEmojiStatus_request::OAIPost_setUserEmojiStatus_request() {
    this->initializeModel();
}

OAIPost_setUserEmojiStatus_request::~OAIPost_setUserEmojiStatus_request() {}

void OAIPost_setUserEmojiStatus_request::initializeModel() {
...
void OAIPost_setUserEmojiStatus_request::fromJson(QString jsonString) {
...
void OAIPost_setUserEmojiStatus_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_setUserEmojiStatus_request::asJson() const {
...
QJsonObject OAIPost_setUserEmojiStatus_request::asJsonObject() const {
    QJsonObject obj;
    if (m_user_id_isSet) {
...
qint32 OAIPost_setUserEmojiStatus_request::getUserId() const {
    return m_user_id;
}
void OAIPost_setUserEmojiStatus_request::setUserId(const qint32 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIPost_setUserEmojiStatus_request::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIPost_setUserEmojiStatus_request::is_user_id_Valid() const{
    return m_user_id_isValid;
}

QString OAIPost_setUserEmojiStatus_request::getEmojiStatusCustomEmojiId() const {
    return m_emoji_status_custom_emoji_id;
}
void OAIPost_setUserEmojiStatus_request::setEmojiStatusCustomEmojiId(const QString &emoji_status_custom_emoji_id) {
    m_emoji_status_custom_emoji_id = emoji_status_custom_emoji_id;
    m_emoji_status_custom_emoji_id_isSet = true;
}

bool OAIPost_setUserEmojiStatus_request::is_emoji_status_custom_emoji_id_Set() const{
    return m_emoji_status_custom_emoji_id_isSet;
}

bool OAIPost_setUserEmojiStatus_request::is_emoji_status_custom_emoji_id_Valid() const{
    return m_emoji_status_custom_emoji_id_isValid;
}

qint32 OAIPost_setUserEmojiStatus_request::getEmojiStatusExpirationDate() const {
    return m_emoji_status_expiration_date;
}
void OAIPost_setUserEmojiStatus_request::setEmojiStatusExpirationDate(const qint32 &emoji_status_expiration_date) {
    m_emoji_status_expiration_date = emoji_status_expiration_date;
    m_emoji_status_expiration_date_isSet = true;
}

bool OAIPost_setUserEmojiStatus_request::is_emoji_status_expiration_date_Set() const{
    return m_emoji_status_expiration_date_isSet;
}

bool OAIPost_setUserEmojiStatus_request::is_emoji_status_expiration_date_Valid() const{
    return m_emoji_status_expiration_date_isValid;
}

bool OAIPost_setUserEmojiStatus_request::isSet() const {
...
bool OAIPost_setUserEmojiStatus_request::isValid() const {
