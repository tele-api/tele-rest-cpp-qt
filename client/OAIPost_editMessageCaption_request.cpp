...
#include "OAIPost_editMessageCaption_request.h"
...
OAIPost_editMessageCaption_request::OAIPost_editMessageCaption_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_editMessageCaption_request::OAIPost_editMessageCaption_request() {
    this->initializeModel();
}

OAIPost_editMessageCaption_request::~OAIPost_editMessageCaption_request() {}

void OAIPost_editMessageCaption_request::initializeModel() {
...
void OAIPost_editMessageCaption_request::fromJson(QString jsonString) {
...
void OAIPost_editMessageCaption_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_editMessageCaption_request::asJson() const {
...
QJsonObject OAIPost_editMessageCaption_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPost_editMessageCaption_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_editMessageCaption_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_editMessageCaption_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIPost_editMessageText_request_chat_id OAIPost_editMessageCaption_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_editMessageCaption_request::setChatId(const OAIPost_editMessageText_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_editMessageCaption_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIPost_editMessageCaption_request::getMessageId() const {
    return m_message_id;
}
void OAIPost_editMessageCaption_request::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIPost_editMessageCaption_request::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIPost_editMessageCaption_request::getInlineMessageId() const {
    return m_inline_message_id;
}
void OAIPost_editMessageCaption_request::setInlineMessageId(const QString &inline_message_id) {
    m_inline_message_id = inline_message_id;
    m_inline_message_id_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_inline_message_id_Set() const{
    return m_inline_message_id_isSet;
}

bool OAIPost_editMessageCaption_request::is_inline_message_id_Valid() const{
    return m_inline_message_id_isValid;
}

QString OAIPost_editMessageCaption_request::getCaption() const {
    return m_caption;
}
void OAIPost_editMessageCaption_request::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAIPost_editMessageCaption_request::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAIPost_editMessageCaption_request::getParseMode() const {
    return m_parse_mode;
}
void OAIPost_editMessageCaption_request::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAIPost_editMessageCaption_request::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIPost_editMessageCaption_request::getCaptionEntities() const {
    return m_caption_entities;
}
void OAIPost_editMessageCaption_request::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAIPost_editMessageCaption_request::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

bool OAIPost_editMessageCaption_request::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIPost_editMessageCaption_request::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIPost_editMessageCaption_request::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

OAIInlineKeyboardMarkup OAIPost_editMessageCaption_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_editMessageCaption_request::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_editMessageCaption_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_editMessageCaption_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_editMessageCaption_request::isSet() const {
...
bool OAIPost_editMessageCaption_request::isValid() const {
