...
/*
 * OAIInaccessibleMessage.h
 *
 * This object describes a message that was deleted or is otherwise inaccessible to the bot.
 */

#ifndef OAIInaccessibleMessage_H
#define OAIInaccessibleMessage_H
...
class OAIInaccessibleMessage : public OAIObject {
public:
    OAIInaccessibleMessage();
    OAIInaccessibleMessage(QString json);
    ~OAIInaccessibleMessage() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInaccessibleMessage)

#endif // OAIInaccessibleMessage_H
