...
/*
 * OAIEditMessageReplyMarkupRequest.h
 *
 * Request parameters for editMessageReplyMarkup
 */

#ifndef OAIEditMessageReplyMarkupRequest_H
#define OAIEditMessageReplyMarkupRequest_H
...
class OAIEditMessageReplyMarkupRequest : public OAIObject {
public:
    OAIEditMessageReplyMarkupRequest();
    OAIEditMessageReplyMarkupRequest(QString json);
    ~OAIEditMessageReplyMarkupRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIEditMessageReplyMarkupRequest)

#endif // OAIEditMessageReplyMarkupRequest_H
