...
/*
 * OAISendGiftRequest.h
 *
 * Request parameters for sendGift
 */

#ifndef OAISendGiftRequest_H
#define OAISendGiftRequest_H
...
class OAISendGiftRequest : public OAIObject {
public:
    OAISendGiftRequest();
    OAISendGiftRequest(QString json);
    ~OAISendGiftRequest() override;
    ...
    OAISendGiftRequest_chat_id getChatId() const;
    void setChatId(const OAISendGiftRequest_chat_id &chat_id);
...
private:
    ...
    OAISendGiftRequest_chat_id m_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAISendGiftRequest)

#endif // OAISendGiftRequest_H
