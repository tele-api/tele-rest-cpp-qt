...
/*
 * OAIGiftPremiumSubscriptionRequest.h
 *
 * Request parameters for giftPremiumSubscription
 */

#ifndef OAIGiftPremiumSubscriptionRequest_H
#define OAIGiftPremiumSubscriptionRequest_H
...
class OAIGiftPremiumSubscriptionRequest : public OAIObject {
public:
    OAIGiftPremiumSubscriptionRequest();
    OAIGiftPremiumSubscriptionRequest(QString json);
    ~OAIGiftPremiumSubscriptionRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIGiftPremiumSubscriptionRequest)

#endif // OAIGiftPremiumSubscriptionRequest_H
