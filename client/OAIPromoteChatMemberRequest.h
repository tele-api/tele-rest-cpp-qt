...
/*
 * OAIPromoteChatMemberRequest.h
 *
 * Request parameters for promoteChatMember
 */

#ifndef OAIPromoteChatMemberRequest_H
#define OAIPromoteChatMemberRequest_H
...
class OAIPromoteChatMemberRequest : public OAIObject {
public:
    OAIPromoteChatMemberRequest();
    OAIPromoteChatMemberRequest(QString json);
    ~OAIPromoteChatMemberRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPromoteChatMemberRequest)

#endif // OAIPromoteChatMemberRequest_H
