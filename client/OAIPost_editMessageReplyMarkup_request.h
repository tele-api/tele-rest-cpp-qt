...
/*
 * OAIPost_editMessageReplyMarkup_request.h
 *
 * 
 */

#ifndef OAIPost_editMessageReplyMarkup_request_H
#define OAIPost_editMessageReplyMarkup_request_H
...
class OAIPost_editMessageReplyMarkup_request : public OAIObject {
public:
    OAIPost_editMessageReplyMarkup_request();
    OAIPost_editMessageReplyMarkup_request(QString json);
    ~OAIPost_editMessageReplyMarkup_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_editMessageReplyMarkup_request)

#endif // OAIPost_editMessageReplyMarkup_request_H
