...
/*
 * OAIPost_editMessageCaption_request.h
 *
 * 
 */

#ifndef OAIPost_editMessageCaption_request_H
#define OAIPost_editMessageCaption_request_H
...
class OAIPost_editMessageCaption_request : public OAIObject {
public:
    OAIPost_editMessageCaption_request();
    OAIPost_editMessageCaption_request(QString json);
    ~OAIPost_editMessageCaption_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_editMessageCaption_request)

#endif // OAIPost_editMessageCaption_request_H
