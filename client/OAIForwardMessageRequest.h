...
/*
 * OAIForwardMessageRequest.h
 *
 * Request parameters for forwardMessage
 */

#ifndef OAIForwardMessageRequest_H
#define OAIForwardMessageRequest_H
...
class OAIForwardMessageRequest : public OAIObject {
public:
    OAIForwardMessageRequest();
    OAIForwardMessageRequest(QString json);
    ~OAIForwardMessageRequest() override;
    ...
    OAIForwardMessageRequest_from_chat_id getFromChatId() const;
    void setFromChatId(const OAIForwardMessageRequest_from_chat_id &from_chat_id);
...
private:
    ...
    OAIForwardMessageRequest_from_chat_id m_from_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAIForwardMessageRequest)

#endif // OAIForwardMessageRequest_H
