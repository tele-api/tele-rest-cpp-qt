...
/*
 * OAIDeleteForumTopicRequest.h
 *
 * Request parameters for deleteForumTopic
 */

#ifndef OAIDeleteForumTopicRequest_H
#define OAIDeleteForumTopicRequest_H
...
class OAIDeleteForumTopicRequest : public OAIObject {
public:
    OAIDeleteForumTopicRequest();
    OAIDeleteForumTopicRequest(QString json);
    ~OAIDeleteForumTopicRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIDeleteForumTopicRequest)

#endif // OAIDeleteForumTopicRequest_H
