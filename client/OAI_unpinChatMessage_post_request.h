...
/*
 * OAI_unpinChatMessage_post_request.h
 *
 * 
 */

#ifndef OAI_unpinChatMessage_post_request_H
#define OAI_unpinChatMessage_post_request_H
...
class OAI_unpinChatMessage_post_request : public OAIObject {
public:
    OAI_unpinChatMessage_post_request();
    OAI_unpinChatMessage_post_request(QString json);
    ~OAI_unpinChatMessage_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_unpinChatMessage_post_request)

#endif // OAI_unpinChatMessage_post_request_H
