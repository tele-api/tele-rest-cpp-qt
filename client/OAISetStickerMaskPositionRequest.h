...
/*
 * OAISetStickerMaskPositionRequest.h
 *
 * Request parameters for setStickerMaskPosition
 */

#ifndef OAISetStickerMaskPositionRequest_H
#define OAISetStickerMaskPositionRequest_H
...
class OAISetStickerMaskPositionRequest : public OAIObject {
public:
    OAISetStickerMaskPositionRequest();
    OAISetStickerMaskPositionRequest(QString json);
    ~OAISetStickerMaskPositionRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetStickerMaskPositionRequest)

#endif // OAISetStickerMaskPositionRequest_H
