...
/*
 * OAISendMediaGroupRequest.h
 *
 * Request parameters for sendMediaGroup
 */

#ifndef OAISendMediaGroupRequest_H
#define OAISendMediaGroupRequest_H
...
namespace tele_rest {
class OAISendMediaGroupRequest_media_inner;
class OAIReplyParameters;

class OAISendMediaGroupRequest : public OAIObject {
public:
    OAISendMediaGroupRequest();
    OAISendMediaGroupRequest(QString json);
    ~OAISendMediaGroupRequest() override;
    ...
    QList<OAISendMediaGroupRequest_media_inner> getMedia() const;
    void setMedia(const QList<OAISendMediaGroupRequest_media_inner> &media);
...
private:
    ...
    QList<OAISendMediaGroupRequest_media_inner> m_media;
    bool m_media_isSet;
...
Q_DECLARE_METATYPE(tele_rest::OAISendMediaGroupRequest)

#endif // OAISendMediaGroupRequest_H
