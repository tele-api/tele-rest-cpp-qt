...
/*
 * OAICopyMessageRequest.h
 *
 * Request parameters for copyMessage
 */

#ifndef OAICopyMessageRequest_H
#define OAICopyMessageRequest_H
...
class OAICopyMessageRequest : public OAIObject {
public:
    OAICopyMessageRequest();
    OAICopyMessageRequest(QString json);
    ~OAICopyMessageRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAICopyMessageRequest)

#endif // OAICopyMessageRequest_H
