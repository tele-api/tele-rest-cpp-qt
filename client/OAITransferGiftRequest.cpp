...
#include "OAITransferGiftRequest.h"
...
OAITransferGiftRequest::OAITransferGiftRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAITransferGiftRequest::OAITransferGiftRequest() {
    this->initializeModel();
}

OAITransferGiftRequest::~OAITransferGiftRequest() {}

void OAITransferGiftRequest::initializeModel() {
...
void OAITransferGiftRequest::fromJson(QString jsonString) {
...
void OAITransferGiftRequest::fromJsonObject(QJsonObject json) {
...
QString OAITransferGiftRequest::asJson() const {
...
QJsonObject OAITransferGiftRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAITransferGiftRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAITransferGiftRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAITransferGiftRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAITransferGiftRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

QString OAITransferGiftRequest::getOwnedGiftId() const {
    return m_owned_gift_id;
}
void OAITransferGiftRequest::setOwnedGiftId(const QString &owned_gift_id) {
    m_owned_gift_id = owned_gift_id;
    m_owned_gift_id_isSet = true;
}

bool OAITransferGiftRequest::is_owned_gift_id_Set() const{
    return m_owned_gift_id_isSet;
}

bool OAITransferGiftRequest::is_owned_gift_id_Valid() const{
    return m_owned_gift_id_isValid;
}

qint32 OAITransferGiftRequest::getNewOwnerChatId() const {
    return m_new_owner_chat_id;
}
void OAITransferGiftRequest::setNewOwnerChatId(const qint32 &new_owner_chat_id) {
    m_new_owner_chat_id = new_owner_chat_id;
    m_new_owner_chat_id_isSet = true;
}

bool OAITransferGiftRequest::is_new_owner_chat_id_Set() const{
    return m_new_owner_chat_id_isSet;
}

bool OAITransferGiftRequest::is_new_owner_chat_id_Valid() const{
    return m_new_owner_chat_id_isValid;
}

qint32 OAITransferGiftRequest::getStarCount() const {
    return m_star_count;
}
void OAITransferGiftRequest::setStarCount(const qint32 &star_count) {
    m_star_count = star_count;
    m_star_count_isSet = true;
}

bool OAITransferGiftRequest::is_star_count_Set() const{
    return m_star_count_isSet;
}

bool OAITransferGiftRequest::is_star_count_Valid() const{
    return m_star_count_isValid;
}

bool OAITransferGiftRequest::isSet() const {
...
bool OAITransferGiftRequest::isValid() const {
