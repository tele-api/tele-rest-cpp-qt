...
#include "OAIPost_forwardMessage_request.h"
...
OAIPost_forwardMessage_request::OAIPost_forwardMessage_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_forwardMessage_request::OAIPost_forwardMessage_request() {
    this->initializeModel();
}

OAIPost_forwardMessage_request::~OAIPost_forwardMessage_request() {}

void OAIPost_forwardMessage_request::initializeModel() {
...
void OAIPost_forwardMessage_request::fromJson(QString jsonString) {
...
void OAIPost_forwardMessage_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_forwardMessage_request::asJson() const {
...
QJsonObject OAIPost_forwardMessage_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_forwardMessage_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_forwardMessage_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_forwardMessage_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_forwardMessage_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

OAIPost_forwardMessage_request_from_chat_id OAIPost_forwardMessage_request::getFromChatId() const {
    return m_from_chat_id;
}
void OAIPost_forwardMessage_request::setFromChatId(const OAIPost_forwardMessage_request_from_chat_id &from_chat_id) {
    m_from_chat_id = from_chat_id;
    m_from_chat_id_isSet = true;
}

bool OAIPost_forwardMessage_request::is_from_chat_id_Set() const{
    return m_from_chat_id_isSet;
}

bool OAIPost_forwardMessage_request::is_from_chat_id_Valid() const{
    return m_from_chat_id_isValid;
}

qint32 OAIPost_forwardMessage_request::getMessageId() const {
    return m_message_id;
}
void OAIPost_forwardMessage_request::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIPost_forwardMessage_request::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIPost_forwardMessage_request::is_message_id_Valid() const{
    return m_message_id_isValid;
}

qint32 OAIPost_forwardMessage_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_forwardMessage_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_forwardMessage_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_forwardMessage_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

qint32 OAIPost_forwardMessage_request::getVideoStartTimestamp() const {
    return m_video_start_timestamp;
}
void OAIPost_forwardMessage_request::setVideoStartTimestamp(const qint32 &video_start_timestamp) {
    m_video_start_timestamp = video_start_timestamp;
    m_video_start_timestamp_isSet = true;
}

bool OAIPost_forwardMessage_request::is_video_start_timestamp_Set() const{
    return m_video_start_timestamp_isSet;
}

bool OAIPost_forwardMessage_request::is_video_start_timestamp_Valid() const{
    return m_video_start_timestamp_isValid;
}

bool OAIPost_forwardMessage_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPost_forwardMessage_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPost_forwardMessage_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPost_forwardMessage_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPost_forwardMessage_request::isProtectContent() const {
    return m_protect_content;
}
void OAIPost_forwardMessage_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIPost_forwardMessage_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIPost_forwardMessage_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIPost_forwardMessage_request::isSet() const {
...
bool OAIPost_forwardMessage_request::isValid() const {
