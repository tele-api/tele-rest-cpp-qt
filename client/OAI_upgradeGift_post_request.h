...
/*
 * OAI_upgradeGift_post_request.h
 *
 * 
 */

#ifndef OAI_upgradeGift_post_request_H
#define OAI_upgradeGift_post_request_H
...
class OAI_upgradeGift_post_request : public OAIObject {
public:
    OAI_upgradeGift_post_request();
    OAI_upgradeGift_post_request(QString json);
    ~OAI_upgradeGift_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_upgradeGift_post_request)

#endif // OAI_upgradeGift_post_request_H
