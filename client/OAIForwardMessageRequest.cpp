...
#include "OAIForwardMessageRequest.h"
...
OAIForwardMessageRequest::OAIForwardMessageRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForwardMessageRequest::OAIForwardMessageRequest() {
    this->initializeModel();
}

OAIForwardMessageRequest::~OAIForwardMessageRequest() {}

void OAIForwardMessageRequest::initializeModel() {
...
void OAIForwardMessageRequest::fromJson(QString jsonString) {
...
void OAIForwardMessageRequest::fromJsonObject(QJsonObject json) {
...
QString OAIForwardMessageRequest::asJson() const {
...
QJsonObject OAIForwardMessageRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAIForwardMessageRequest::getChatId() const {
    return m_chat_id;
}
void OAIForwardMessageRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIForwardMessageRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIForwardMessageRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

OAIForwardMessageRequest_from_chat_id OAIForwardMessageRequest::getFromChatId() const {
    return m_from_chat_id;
}
void OAIForwardMessageRequest::setFromChatId(const OAIForwardMessageRequest_from_chat_id &from_chat_id) {
    m_from_chat_id = from_chat_id;
    m_from_chat_id_isSet = true;
}

bool OAIForwardMessageRequest::is_from_chat_id_Set() const{
    return m_from_chat_id_isSet;
}

bool OAIForwardMessageRequest::is_from_chat_id_Valid() const{
    return m_from_chat_id_isValid;
}

qint32 OAIForwardMessageRequest::getMessageId() const {
    return m_message_id;
}
void OAIForwardMessageRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIForwardMessageRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIForwardMessageRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

qint32 OAIForwardMessageRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIForwardMessageRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIForwardMessageRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIForwardMessageRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

qint32 OAIForwardMessageRequest::getVideoStartTimestamp() const {
    return m_video_start_timestamp;
}
void OAIForwardMessageRequest::setVideoStartTimestamp(const qint32 &video_start_timestamp) {
    m_video_start_timestamp = video_start_timestamp;
    m_video_start_timestamp_isSet = true;
}

bool OAIForwardMessageRequest::is_video_start_timestamp_Set() const{
    return m_video_start_timestamp_isSet;
}

bool OAIForwardMessageRequest::is_video_start_timestamp_Valid() const{
    return m_video_start_timestamp_isValid;
}

bool OAIForwardMessageRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAIForwardMessageRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIForwardMessageRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIForwardMessageRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIForwardMessageRequest::isProtectContent() const {
    return m_protect_content;
}
void OAIForwardMessageRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIForwardMessageRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIForwardMessageRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIForwardMessageRequest::isSet() const {
...
bool OAIForwardMessageRequest::isValid() const {
