...
#ifndef OAIUniqueGiftInfo_H
#define OAIUniqueGiftInfo_H
...
class OAIUniqueGiftInfo : public OAIObject {
public:
    OAIUniqueGiftInfo();
    OAIUniqueGiftInfo(QString json);
    ~OAIUniqueGiftInfo() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIUniqueGiftInfo)

#endif // OAIUniqueGiftInfo_H
