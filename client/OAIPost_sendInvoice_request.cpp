...
#include "OAIPost_sendInvoice_request.h"
...
OAIPost_sendInvoice_request::OAIPost_sendInvoice_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_sendInvoice_request::OAIPost_sendInvoice_request() {
    this->initializeModel();
}

OAIPost_sendInvoice_request::~OAIPost_sendInvoice_request() {}

void OAIPost_sendInvoice_request::initializeModel() {
...
void OAIPost_sendInvoice_request::fromJson(QString jsonString) {
...
void OAIPost_sendInvoice_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_sendInvoice_request::asJson() const {
...
QJsonObject OAIPost_sendInvoice_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_sendInvoice_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_sendInvoice_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_sendInvoice_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_sendInvoice_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAIPost_sendInvoice_request::getTitle() const {
    return m_title;
}
void OAIPost_sendInvoice_request::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIPost_sendInvoice_request::is_title_Set() const{
    return m_title_isSet;
}

bool OAIPost_sendInvoice_request::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIPost_sendInvoice_request::getDescription() const {
    return m_description;
}
void OAIPost_sendInvoice_request::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAIPost_sendInvoice_request::is_description_Set() const{
    return m_description_isSet;
}

bool OAIPost_sendInvoice_request::is_description_Valid() const{
    return m_description_isValid;
}

QString OAIPost_sendInvoice_request::getPayload() const {
    return m_payload;
}
void OAIPost_sendInvoice_request::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAIPost_sendInvoice_request::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAIPost_sendInvoice_request::is_payload_Valid() const{
    return m_payload_isValid;
}

QString OAIPost_sendInvoice_request::getCurrency() const {
    return m_currency;
}
void OAIPost_sendInvoice_request::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAIPost_sendInvoice_request::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAIPost_sendInvoice_request::is_currency_Valid() const{
    return m_currency_isValid;
}

QList<OAILabeledPrice> OAIPost_sendInvoice_request::getPrices() const {
    return m_prices;
}
void OAIPost_sendInvoice_request::setPrices(const QList<OAILabeledPrice> &prices) {
    m_prices = prices;
    m_prices_isSet = true;
}

bool OAIPost_sendInvoice_request::is_prices_Set() const{
    return m_prices_isSet;
}

bool OAIPost_sendInvoice_request::is_prices_Valid() const{
    return m_prices_isValid;
}

qint32 OAIPost_sendInvoice_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_sendInvoice_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_sendInvoice_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_sendInvoice_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAIPost_sendInvoice_request::getProviderToken() const {
    return m_provider_token;
}
void OAIPost_sendInvoice_request::setProviderToken(const QString &provider_token) {
    m_provider_token = provider_token;
    m_provider_token_isSet = true;
}

bool OAIPost_sendInvoice_request::is_provider_token_Set() const{
    return m_provider_token_isSet;
}

bool OAIPost_sendInvoice_request::is_provider_token_Valid() const{
    return m_provider_token_isValid;
}

qint32 OAIPost_sendInvoice_request::getMaxTipAmount() const {
    return m_max_tip_amount;
}
void OAIPost_sendInvoice_request::setMaxTipAmount(const qint32 &max_tip_amount) {
    m_max_tip_amount = max_tip_amount;
    m_max_tip_amount_isSet = true;
}

bool OAIPost_sendInvoice_request::is_max_tip_amount_Set() const{
    return m_max_tip_amount_isSet;
}

bool OAIPost_sendInvoice_request::is_max_tip_amount_Valid() const{
    return m_max_tip_amount_isValid;
}

QList<qint32> OAIPost_sendInvoice_request::getSuggestedTipAmounts() const {
    return m_suggested_tip_amounts;
}
void OAIPost_sendInvoice_request::setSuggestedTipAmounts(const QList<qint32> &suggested_tip_amounts) {
    m_suggested_tip_amounts = suggested_tip_amounts;
    m_suggested_tip_amounts_isSet = true;
}

bool OAIPost_sendInvoice_request::is_suggested_tip_amounts_Set() const{
    return m_suggested_tip_amounts_isSet;
}

bool OAIPost_sendInvoice_request::is_suggested_tip_amounts_Valid() const{
    return m_suggested_tip_amounts_isValid;
}

QString OAIPost_sendInvoice_request::getStartParameter() const {
    return m_start_parameter;
}
void OAIPost_sendInvoice_request::setStartParameter(const QString &start_parameter) {
    m_start_parameter = start_parameter;
    m_start_parameter_isSet = true;
}

bool OAIPost_sendInvoice_request::is_start_parameter_Set() const{
    return m_start_parameter_isSet;
}

bool OAIPost_sendInvoice_request::is_start_parameter_Valid() const{
    return m_start_parameter_isValid;
}

QString OAIPost_sendInvoice_request::getProviderData() const {
    return m_provider_data;
}
void OAIPost_sendInvoice_request::setProviderData(const QString &provider_data) {
    m_provider_data = provider_data;
    m_provider_data_isSet = true;
}

bool OAIPost_sendInvoice_request::is_provider_data_Set() const{
    return m_provider_data_isSet;
}

bool OAIPost_sendInvoice_request::is_provider_data_Valid() const{
    return m_provider_data_isValid;
}

QString OAIPost_sendInvoice_request::getPhotoUrl() const {
    return m_photo_url;
}
void OAIPost_sendInvoice_request::setPhotoUrl(const QString &photo_url) {
    m_photo_url = photo_url;
    m_photo_url_isSet = true;
}

bool OAIPost_sendInvoice_request::is_photo_url_Set() const{
    return m_photo_url_isSet;
}

bool OAIPost_sendInvoice_request::is_photo_url_Valid() const{
    return m_photo_url_isValid;
}

qint32 OAIPost_sendInvoice_request::getPhotoSize() const {
    return m_photo_size;
}
void OAIPost_sendInvoice_request::setPhotoSize(const qint32 &photo_size) {
    m_photo_size = photo_size;
    m_photo_size_isSet = true;
}

bool OAIPost_sendInvoice_request::is_photo_size_Set() const{
    return m_photo_size_isSet;
}

bool OAIPost_sendInvoice_request::is_photo_size_Valid() const{
    return m_photo_size_isValid;
}

qint32 OAIPost_sendInvoice_request::getPhotoWidth() const {
    return m_photo_width;
}
void OAIPost_sendInvoice_request::setPhotoWidth(const qint32 &photo_width) {
    m_photo_width = photo_width;
    m_photo_width_isSet = true;
}

bool OAIPost_sendInvoice_request::is_photo_width_Set() const{
    return m_photo_width_isSet;
}

bool OAIPost_sendInvoice_request::is_photo_width_Valid() const{
    return m_photo_width_isValid;
}

qint32 OAIPost_sendInvoice_request::getPhotoHeight() const {
    return m_photo_height;
}
void OAIPost_sendInvoice_request::setPhotoHeight(const qint32 &photo_height) {
    m_photo_height = photo_height;
    m_photo_height_isSet = true;
}

bool OAIPost_sendInvoice_request::is_photo_height_Set() const{
    return m_photo_height_isSet;
}

bool OAIPost_sendInvoice_request::is_photo_height_Valid() const{
    return m_photo_height_isValid;
}

bool OAIPost_sendInvoice_request::isNeedName() const {
    return m_need_name;
}
void OAIPost_sendInvoice_request::setNeedName(const bool &need_name) {
    m_need_name = need_name;
    m_need_name_isSet = true;
}

bool OAIPost_sendInvoice_request::is_need_name_Set() const{
    return m_need_name_isSet;
}

bool OAIPost_sendInvoice_request::is_need_name_Valid() const{
    return m_need_name_isValid;
}

bool OAIPost_sendInvoice_request::isNeedPhoneNumber() const {
    return m_need_phone_number;
}
void OAIPost_sendInvoice_request::setNeedPhoneNumber(const bool &need_phone_number) {
    m_need_phone_number = need_phone_number;
    m_need_phone_number_isSet = true;
}

bool OAIPost_sendInvoice_request::is_need_phone_number_Set() const{
    return m_need_phone_number_isSet;
}

bool OAIPost_sendInvoice_request::is_need_phone_number_Valid() const{
    return m_need_phone_number_isValid;
}

bool OAIPost_sendInvoice_request::isNeedEmail() const {
    return m_need_email;
}
void OAIPost_sendInvoice_request::setNeedEmail(const bool &need_email) {
    m_need_email = need_email;
    m_need_email_isSet = true;
}

bool OAIPost_sendInvoice_request::is_need_email_Set() const{
    return m_need_email_isSet;
}

bool OAIPost_sendInvoice_request::is_need_email_Valid() const{
    return m_need_email_isValid;
}

bool OAIPost_sendInvoice_request::isNeedShippingAddress() const {
    return m_need_shipping_address;
}
void OAIPost_sendInvoice_request::setNeedShippingAddress(const bool &need_shipping_address) {
    m_need_shipping_address = need_shipping_address;
    m_need_shipping_address_isSet = true;
}

bool OAIPost_sendInvoice_request::is_need_shipping_address_Set() const{
    return m_need_shipping_address_isSet;
}

bool OAIPost_sendInvoice_request::is_need_shipping_address_Valid() const{
    return m_need_shipping_address_isValid;
}

bool OAIPost_sendInvoice_request::isSendPhoneNumberToProvider() const {
    return m_send_phone_number_to_provider;
}
void OAIPost_sendInvoice_request::setSendPhoneNumberToProvider(const bool &send_phone_number_to_provider) {
    m_send_phone_number_to_provider = send_phone_number_to_provider;
    m_send_phone_number_to_provider_isSet = true;
}

bool OAIPost_sendInvoice_request::is_send_phone_number_to_provider_Set() const{
    return m_send_phone_number_to_provider_isSet;
}

bool OAIPost_sendInvoice_request::is_send_phone_number_to_provider_Valid() const{
    return m_send_phone_number_to_provider_isValid;
}

bool OAIPost_sendInvoice_request::isSendEmailToProvider() const {
    return m_send_email_to_provider;
}
void OAIPost_sendInvoice_request::setSendEmailToProvider(const bool &send_email_to_provider) {
    m_send_email_to_provider = send_email_to_provider;
    m_send_email_to_provider_isSet = true;
}

bool OAIPost_sendInvoice_request::is_send_email_to_provider_Set() const{
    return m_send_email_to_provider_isSet;
}

bool OAIPost_sendInvoice_request::is_send_email_to_provider_Valid() const{
    return m_send_email_to_provider_isValid;
}

bool OAIPost_sendInvoice_request::isIsFlexible() const {
    return m_is_flexible;
}
void OAIPost_sendInvoice_request::setIsFlexible(const bool &is_flexible) {
    m_is_flexible = is_flexible;
    m_is_flexible_isSet = true;
}

bool OAIPost_sendInvoice_request::is_is_flexible_Set() const{
    return m_is_flexible_isSet;
}

bool OAIPost_sendInvoice_request::is_is_flexible_Valid() const{
    return m_is_flexible_isValid;
}

bool OAIPost_sendInvoice_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPost_sendInvoice_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPost_sendInvoice_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPost_sendInvoice_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPost_sendInvoice_request::isProtectContent() const {
    return m_protect_content;
}
void OAIPost_sendInvoice_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIPost_sendInvoice_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIPost_sendInvoice_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIPost_sendInvoice_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAIPost_sendInvoice_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAIPost_sendInvoice_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAIPost_sendInvoice_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAIPost_sendInvoice_request::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAIPost_sendInvoice_request::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAIPost_sendInvoice_request::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAIPost_sendInvoice_request::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAIPost_sendInvoice_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAIPost_sendInvoice_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAIPost_sendInvoice_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAIPost_sendInvoice_request::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAIInlineKeyboardMarkup OAIPost_sendInvoice_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_sendInvoice_request::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_sendInvoice_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_sendInvoice_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_sendInvoice_request::isSet() const {
...
bool OAIPost_sendInvoice_request::isValid() const {
