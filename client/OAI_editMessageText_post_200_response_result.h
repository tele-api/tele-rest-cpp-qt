...
/*
 * OAI_editMessageText_post_200_response_result.h
 *
 * 
 */

#ifndef OAI_editMessageText_post_200_response_result_H
#define OAI_editMessageText_post_200_response_result_H
...
class OAI_editMessageText_post_200_response_result : public OAIObject {
public:
    OAI_editMessageText_post_200_response_result();
    OAI_editMessageText_post_200_response_result(QString json);
    ~OAI_editMessageText_post_200_response_result() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_editMessageText_post_200_response_result)

#endif // OAI_editMessageText_post_200_response_result_H
