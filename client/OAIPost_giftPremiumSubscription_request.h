...
/*
 * OAIPost_giftPremiumSubscription_request.h
 *
 * 
 */

#ifndef OAIPost_giftPremiumSubscription_request_H
#define OAIPost_giftPremiumSubscription_request_H
...
class OAIPost_giftPremiumSubscription_request : public OAIObject {
public:
    OAIPost_giftPremiumSubscription_request();
    OAIPost_giftPremiumSubscription_request(QString json);
    ~OAIPost_giftPremiumSubscription_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_giftPremiumSubscription_request)

#endif // OAIPost_giftPremiumSubscription_request_H
