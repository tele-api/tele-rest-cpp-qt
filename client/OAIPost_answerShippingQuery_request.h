...
/*
 * OAIPost_answerShippingQuery_request.h
 *
 * 
 */

#ifndef OAIPost_answerShippingQuery_request_H
#define OAIPost_answerShippingQuery_request_H
...
class OAIPost_answerShippingQuery_request : public OAIObject {
public:
    OAIPost_answerShippingQuery_request();
    OAIPost_answerShippingQuery_request(QString json);
    ~OAIPost_answerShippingQuery_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_answerShippingQuery_request)

#endif // OAIPost_answerShippingQuery_request_H
