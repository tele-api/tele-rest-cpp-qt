...
/*
 * OAISetChatPhotoRequest.h
 *
 * Request parameters for setChatPhoto
 */

#ifndef OAISetChatPhotoRequest_H
#define OAISetChatPhotoRequest_H
...
class OAISetChatPhotoRequest : public OAIObject {
public:
    OAISetChatPhotoRequest();
    OAISetChatPhotoRequest(QString json);
    ~OAISetChatPhotoRequest() override;
    ...
    QJsonValue getPhoto() const;
    void setPhoto(const QJsonValue &photo);
...
Q_DECLARE_METATYPE(tele_rest::OAISetChatPhotoRequest)

#endif // OAISetChatPhotoRequest_H
