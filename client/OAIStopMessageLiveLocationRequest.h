...
/*
 * OAIStopMessageLiveLocationRequest.h
 *
 * Request parameters for stopMessageLiveLocation
 */

#ifndef OAIStopMessageLiveLocationRequest_H
#define OAIStopMessageLiveLocationRequest_H
...
class OAIStopMessageLiveLocationRequest : public OAIObject {
public:
    OAIStopMessageLiveLocationRequest();
    OAIStopMessageLiveLocationRequest(QString json);
    ~OAIStopMessageLiveLocationRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIStopMessageLiveLocationRequest)

#endif // OAIStopMessageLiveLocationRequest_H
