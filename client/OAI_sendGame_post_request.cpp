...
QString OAI_sendGame_post_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAI_sendGame_post_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAI_sendGame_post_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAI_sendGame_post_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAI_sendGame_post_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAI_sendGame_post_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAI_sendGame_post_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAI_sendGame_post_request::is_message_thread_id_Valid() const{
...
bool OAI_sendGame_post_request::isProtectContent() const {
    return m_protect_content;
}
void OAI_sendGame_post_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAI_sendGame_post_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAI_sendGame_post_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAI_sendGame_post_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAI_sendGame_post_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAI_sendGame_post_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAI_sendGame_post_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAI_sendGame_post_request::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAI_sendGame_post_request::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAI_sendGame_post_request::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAI_sendGame_post_request::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAI_sendGame_post_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAI_sendGame_post_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAI_sendGame_post_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAI_sendGame_post_request::is_reply_parameters_Valid() const{
