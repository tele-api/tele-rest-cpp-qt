...
OAISendVenueRequest::OAISendVenueRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendVenueRequest::OAISendVenueRequest() {
    this->initializeModel();
}

OAISendVenueRequest::~OAISendVenueRequest() {}

void OAISendVenueRequest::initializeModel() {
...
void OAISendVenueRequest::fromJson(QString jsonString) {
...
void OAISendVenueRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendVenueRequest::asJson() const {
...
QJsonObject OAISendVenueRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAISendVenueRequest::getChatId() const {
    return m_chat_id;
}
void OAISendVenueRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendVenueRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendVenueRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

double OAISendVenueRequest::getLatitude() const {
    return m_latitude;
}
void OAISendVenueRequest::setLatitude(const double &latitude) {
    m_latitude = latitude;
    m_latitude_isSet = true;
}

bool OAISendVenueRequest::is_latitude_Set() const{
    return m_latitude_isSet;
}

bool OAISendVenueRequest::is_latitude_Valid() const{
    return m_latitude_isValid;
}

double OAISendVenueRequest::getLongitude() const {
    return m_longitude;
}
void OAISendVenueRequest::setLongitude(const double &longitude) {
    m_longitude = longitude;
    m_longitude_isSet = true;
}

bool OAISendVenueRequest::is_longitude_Set() const{
    return m_longitude_isSet;
}

bool OAISendVenueRequest::is_longitude_Valid() const{
    return m_longitude_isValid;
}

QString OAISendVenueRequest::getTitle() const {
    return m_title;
}
void OAISendVenueRequest::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAISendVenueRequest::is_title_Set() const{
    return m_title_isSet;
}

bool OAISendVenueRequest::is_title_Valid() const{
    return m_title_isValid;
}

QString OAISendVenueRequest::getAddress() const {
    return m_address;
}
void OAISendVenueRequest::setAddress(const QString &address) {
    m_address = address;
    m_address_isSet = true;
}

bool OAISendVenueRequest::is_address_Set() const{
    return m_address_isSet;
}

bool OAISendVenueRequest::is_address_Valid() const{
    return m_address_isValid;
}

QString OAISendVenueRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAISendVenueRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAISendVenueRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAISendVenueRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAISendVenueRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendVenueRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendVenueRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendVenueRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAISendVenueRequest::getFoursquareId() const {
    return m_foursquare_id;
}
void OAISendVenueRequest::setFoursquareId(const QString &foursquare_id) {
    m_foursquare_id = foursquare_id;
    m_foursquare_id_isSet = true;
}

bool OAISendVenueRequest::is_foursquare_id_Set() const{
    return m_foursquare_id_isSet;
}

bool OAISendVenueRequest::is_foursquare_id_Valid() const{
    return m_foursquare_id_isValid;
}

QString OAISendVenueRequest::getFoursquareType() const {
    return m_foursquare_type;
}
void OAISendVenueRequest::setFoursquareType(const QString &foursquare_type) {
    m_foursquare_type = foursquare_type;
    m_foursquare_type_isSet = true;
}

bool OAISendVenueRequest::is_foursquare_type_Set() const{
    return m_foursquare_type_isSet;
}

bool OAISendVenueRequest::is_foursquare_type_Valid() const{
    return m_foursquare_type_isValid;
}

QString OAISendVenueRequest::getGooglePlaceId() const {
    return m_google_place_id;
}
void OAISendVenueRequest::setGooglePlaceId(const QString &google_place_id) {
    m_google_place_id = google_place_id;
    m_google_place_id_isSet = true;
}

bool OAISendVenueRequest::is_google_place_id_Set() const{
    return m_google_place_id_isSet;
}

bool OAISendVenueRequest::is_google_place_id_Valid() const{
    return m_google_place_id_isValid;
}

QString OAISendVenueRequest::getGooglePlaceType() const {
    return m_google_place_type;
}
void OAISendVenueRequest::setGooglePlaceType(const QString &google_place_type) {
    m_google_place_type = google_place_type;
    m_google_place_type_isSet = true;
}

bool OAISendVenueRequest::is_google_place_type_Set() const{
    return m_google_place_type_isSet;
}

bool OAISendVenueRequest::is_google_place_type_Valid() const{
    return m_google_place_type_isValid;
}

bool OAISendVenueRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendVenueRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendVenueRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendVenueRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendVenueRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendVenueRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendVenueRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendVenueRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendVenueRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendVenueRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendVenueRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendVenueRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendVenueRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendVenueRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendVenueRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendVenueRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendVenueRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendVenueRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendVenueRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendVenueRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAISendMessageRequest_reply_markup OAISendVenueRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAISendVenueRequest::setReplyMarkup(const OAISendMessageRequest_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAISendVenueRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAISendVenueRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAISendVenueRequest::isSet() const {
...
bool OAISendVenueRequest::isValid() const {
