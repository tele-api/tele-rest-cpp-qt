...
/*
 * OAISetUserEmojiStatusRequest.h
 *
 * Request parameters for setUserEmojiStatus
 */

#ifndef OAISetUserEmojiStatusRequest_H
#define OAISetUserEmojiStatusRequest_H
...
class OAISetUserEmojiStatusRequest : public OAIObject {
public:
    OAISetUserEmojiStatusRequest();
    OAISetUserEmojiStatusRequest(QString json);
    ~OAISetUserEmojiStatusRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetUserEmojiStatusRequest)

#endif // OAISetUserEmojiStatusRequest_H
