...
/*
 * OAIPostStoryRequest.h
 *
 * Request parameters for postStory
 */

#ifndef OAIPostStoryRequest_H
#define OAIPostStoryRequest_H
...
namespace tele_rest {
class OAIInputStoryContent;
class OAIMessageEntity;
class OAIStoryArea;

class OAIPostStoryRequest : public OAIObject {
public:
    OAIPostStoryRequest();
    OAIPostStoryRequest(QString json);
    ~OAIPostStoryRequest() override;
    ...
    OAIInputStoryContent getContent() const;
    void setContent(const OAIInputStoryContent &content);
    bool is_content_Set() const;
    bool is_content_Valid() const;

    qint32 getActivePeriod() const;
    void setActivePeriod(const qint32 &active_period);
    bool is_active_period_Set() const;
    bool is_active_period_Valid() const;
    ...
    QList<OAIStoryArea> getAreas() const;
    void setAreas(const QList<OAIStoryArea> &areas);
    bool is_areas_Set() const;
    bool is_areas_Valid() const;

    bool isPostToChatPage() const;
    void setPostToChatPage(const bool &post_to_chat_page);
    bool is_post_to_chat_page_Set() const;
    bool is_post_to_chat_page_Valid() const;
...
private:
    ...
    OAIInputStoryContent m_content;
    bool m_content_isSet;
    bool m_content_isValid;

    qint32 m_active_period;
    bool m_active_period_isSet;
    bool m_active_period_isValid;
    ...
    QList<OAIStoryArea> m_areas;
    bool m_areas_isSet;
    bool m_areas_isValid;

    bool m_post_to_chat_page;
    bool m_post_to_chat_page_isSet;
    bool m_post_to_chat_page_isValid;
...
Q_DECLARE_METATYPE(tele_rest::OAIPostStoryRequest)

#endif // OAIPostStoryRequest_H
