...
/*
 * OAIPost_stopPoll_request.h
 *
 * 
 */

#ifndef OAIPost_stopPoll_request_H
#define OAIPost_stopPoll_request_H
...
class OAIPost_stopPoll_request : public OAIObject {
public:
    OAIPost_stopPoll_request();
    OAIPost_stopPoll_request(QString json);
    ~OAIPost_stopPoll_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_stopPoll_request)

#endif // OAIPost_stopPoll_request_H
