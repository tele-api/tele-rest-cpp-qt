...
#ifndef OAIUsersShared_H
#define OAIUsersShared_H
...
class OAIUsersShared : public OAIObject {
public:
    OAIUsersShared();
    OAIUsersShared(QString json);
    ~OAIUsersShared() override;
    ...
    QList<OAISharedUser> getUsers() const;
    void setUsers(const QList<OAISharedUser> &users);
...
Q_DECLARE_METATYPE(tele_rest::OAIUsersShared)

#endif // OAIUsersShared_H
