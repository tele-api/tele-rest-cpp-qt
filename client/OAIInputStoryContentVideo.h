...
/*
 * OAIInputStoryContentVideo.h
 *
 * Describes a video to post as a story.
 */

#ifndef OAIInputStoryContentVideo_H
#define OAIInputStoryContentVideo_H
...
class OAIInputStoryContentVideo : public OAIObject {
public:
    OAIInputStoryContentVideo();
    OAIInputStoryContentVideo(QString json);
    ~OAIInputStoryContentVideo() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInputStoryContentVideo)

#endif // OAIInputStoryContentVideo_H
