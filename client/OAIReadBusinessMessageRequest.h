...
/*
 * OAIReadBusinessMessageRequest.h
 *
 * Request parameters for readBusinessMessage
 */

#ifndef OAIReadBusinessMessageRequest_H
#define OAIReadBusinessMessageRequest_H
...
class OAIReadBusinessMessageRequest : public OAIObject {
public:
    OAIReadBusinessMessageRequest();
    OAIReadBusinessMessageRequest(QString json);
    ~OAIReadBusinessMessageRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIReadBusinessMessageRequest)

#endif // OAIReadBusinessMessageRequest_H
