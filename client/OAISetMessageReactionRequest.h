...
/*
 * OAISetMessageReactionRequest.h
 *
 * Request parameters for setMessageReaction
 */

#ifndef OAISetMessageReactionRequest_H
#define OAISetMessageReactionRequest_H
...
class OAISetMessageReactionRequest : public OAIObject {
public:
    OAISetMessageReactionRequest();
    OAISetMessageReactionRequest(QString json);
    ~OAISetMessageReactionRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetMessageReactionRequest)

#endif // OAISetMessageReactionRequest_H
