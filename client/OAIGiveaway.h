...
#ifndef OAIGiveaway_H
#define OAIGiveaway_H
...
class OAIGiveaway : public OAIObject {
public:
    OAIGiveaway();
    OAIGiveaway(QString json);
    ~OAIGiveaway() override;
    ...
    QList<OAIChat> getChats() const;
    void setChats(const QList<OAIChat> &chats);
    ...
    bool isHasPublicWinners() const;
    void setHasPublicWinners(const bool &has_public_winners);
    bool is_has_public_winners_Set() const;
    bool is_has_public_winners_Valid() const;
...
private:
    ...
    bool m_has_public_winners;
    bool m_has_public_winners_isSet;
    bool m_has_public_winners_isValid;
...
Q_DECLARE_METATYPE(tele_rest::OAIGiveaway)
