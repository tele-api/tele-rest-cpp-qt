...
/*
 * OAISetMyShortDescriptionRequest.h
 *
 * Request parameters for setMyShortDescription
 */

#ifndef OAISetMyShortDescriptionRequest_H
#define OAISetMyShortDescriptionRequest_H
...
class OAISetMyShortDescriptionRequest : public OAIObject {
public:
    OAISetMyShortDescriptionRequest();
    OAISetMyShortDescriptionRequest(QString json);
    ~OAISetMyShortDescriptionRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetMyShortDescriptionRequest)

#endif // OAISetMyShortDescriptionRequest_H
