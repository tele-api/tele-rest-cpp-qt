...
/*
 * OAISetChatStickerSetRequest.h
 *
 * Request parameters for setChatStickerSet
 */

#ifndef OAISetChatStickerSetRequest_H
#define OAISetChatStickerSetRequest_H
...
class OAISetChatStickerSetRequest : public OAIObject {
public:
    OAISetChatStickerSetRequest();
    OAISetChatStickerSetRequest(QString json);
    ~OAISetChatStickerSetRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetChatStickerSetRequest)

#endif // OAISetChatStickerSetRequest_H
