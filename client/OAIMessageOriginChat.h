...
/*
 * OAIMessageOriginChat.h
 *
 * The message was originally sent on behalf of a chat to a group chat.
 */

#ifndef OAIMessageOriginChat_H
#define OAIMessageOriginChat_H
...
class OAIMessageOriginChat : public OAIObject {
public:
    OAIMessageOriginChat();
    OAIMessageOriginChat(QString json);
    ~OAIMessageOriginChat() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIMessageOriginChat)

#endif // OAIMessageOriginChat_H
