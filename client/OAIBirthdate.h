...
#ifndef OAIBirthdate_H
#define OAIBirthdate_H
...
class OAIBirthdate : public OAIObject {
public:
    OAIBirthdate();
    OAIBirthdate(QString json);
    ~OAIBirthdate() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIBirthdate)

#endif // OAIBirthdate_H
