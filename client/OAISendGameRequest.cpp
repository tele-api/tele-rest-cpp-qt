...
OAISendGameRequest::OAISendGameRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendGameRequest::OAISendGameRequest() {
    this->initializeModel();
}

OAISendGameRequest::~OAISendGameRequest() {}

void OAISendGameRequest::initializeModel() {
...
void OAISendGameRequest::fromJson(QString jsonString) {
...
void OAISendGameRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendGameRequest::asJson() const {
...
QJsonObject OAISendGameRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id_isSet) {
...
qint32 OAISendGameRequest::getChatId() const {
    return m_chat_id;
}
void OAISendGameRequest::setChatId(const qint32 &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendGameRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendGameRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAISendGameRequest::getGameShortName() const {
    return m_game_short_name;
}
void OAISendGameRequest::setGameShortName(const QString &game_short_name) {
    m_game_short_name = game_short_name;
    m_game_short_name_isSet = true;
}

bool OAISendGameRequest::is_game_short_name_Set() const{
    return m_game_short_name_isSet;
}

bool OAISendGameRequest::is_game_short_name_Valid() const{
    return m_game_short_name_isValid;
}

QString OAISendGameRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAISendGameRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAISendGameRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAISendGameRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAISendGameRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendGameRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendGameRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendGameRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

bool OAISendGameRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendGameRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendGameRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendGameRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendGameRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendGameRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendGameRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendGameRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendGameRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendGameRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendGameRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendGameRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendGameRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendGameRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendGameRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendGameRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendGameRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendGameRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendGameRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendGameRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAIInlineKeyboardMarkup OAISendGameRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAISendGameRequest::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAISendGameRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAISendGameRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAISendGameRequest::isSet() const {
...
bool OAISendGameRequest::isValid() const {
