...
/*
 * OAIPost_editMessageLiveLocation_request.h
 *
 * 
 */

#ifndef OAIPost_editMessageLiveLocation_request_H
#define OAIPost_editMessageLiveLocation_request_H
...
class OAIPost_editMessageLiveLocation_request : public OAIObject {
public:
    OAIPost_editMessageLiveLocation_request();
    OAIPost_editMessageLiveLocation_request(QString json);
    ~OAIPost_editMessageLiveLocation_request() override;
    ...
    OAIPost_editMessageText_request_chat_id getChatId() const;
    void setChatId(const OAIPost_editMessageText_request_chat_id &chat_id);
...
private:
    ...
    OAIPost_editMessageText_request_chat_id m_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_editMessageLiveLocation_request)

#endif // OAIPost_editMessageLiveLocation_request_H
