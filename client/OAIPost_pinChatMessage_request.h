...
/*
 * OAIPost_pinChatMessage_request.h
 *
 * 
 */

#ifndef OAIPost_pinChatMessage_request_H
#define OAIPost_pinChatMessage_request_H
...
class OAIPost_pinChatMessage_request : public OAIObject {
public:
    OAIPost_pinChatMessage_request();
    OAIPost_pinChatMessage_request(QString json);
    ~OAIPost_pinChatMessage_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_pinChatMessage_request)

#endif // OAIPost_pinChatMessage_request_H
