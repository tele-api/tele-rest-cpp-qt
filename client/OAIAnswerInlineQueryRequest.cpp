...
#include "OAIAnswerInlineQueryRequest.h"
...
OAIAnswerInlineQueryRequest::OAIAnswerInlineQueryRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIAnswerInlineQueryRequest::OAIAnswerInlineQueryRequest() {
    this->initializeModel();
}

OAIAnswerInlineQueryRequest::~OAIAnswerInlineQueryRequest() {}

void OAIAnswerInlineQueryRequest::initializeModel() {
...
void OAIAnswerInlineQueryRequest::fromJson(QString jsonString) {
...
void OAIAnswerInlineQueryRequest::fromJsonObject(QJsonObject json) {
...
QString OAIAnswerInlineQueryRequest::asJson() const {
...
QJsonObject OAIAnswerInlineQueryRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIAnswerInlineQueryRequest::getInlineQueryId() const {
    return m_inline_query_id;
}
void OAIAnswerInlineQueryRequest::setInlineQueryId(const QString &inline_query_id) {
    m_inline_query_id = inline_query_id;
    m_inline_query_id_isSet = true;
}

bool OAIAnswerInlineQueryRequest::is_inline_query_id_Set() const{
    return m_inline_query_id_isSet;
}

bool OAIAnswerInlineQueryRequest::is_inline_query_id_Valid() const{
    return m_inline_query_id_isValid;
}

QList<OAIInlineQueryResult> OAIAnswerInlineQueryRequest::getResults() const {
    return m_results;
}
void OAIAnswerInlineQueryRequest::setResults(const QList<OAIInlineQueryResult> &results) {
    m_results = results;
    m_results_isSet = true;
}

bool OAIAnswerInlineQueryRequest::is_results_Set() const{
    return m_results_isSet;
}

bool OAIAnswerInlineQueryRequest::is_results_Valid() const{
    return m_results_isValid;
}

qint32 OAIAnswerInlineQueryRequest::getCacheTime() const {
    return m_cache_time;
}
void OAIAnswerInlineQueryRequest::setCacheTime(const qint32 &cache_time) {
    m_cache_time = cache_time;
    m_cache_time_isSet = true;
}

bool OAIAnswerInlineQueryRequest::is_cache_time_Set() const{
    return m_cache_time_isSet;
}

bool OAIAnswerInlineQueryRequest::is_cache_time_Valid() const{
    return m_cache_time_isValid;
}

bool OAIAnswerInlineQueryRequest::isIsPersonal() const {
    return m_is_personal;
}
void OAIAnswerInlineQueryRequest::setIsPersonal(const bool &is_personal) {
    m_is_personal = is_personal;
    m_is_personal_isSet = true;
}

bool OAIAnswerInlineQueryRequest::is_is_personal_Set() const{
    return m_is_personal_isSet;
}

bool OAIAnswerInlineQueryRequest::is_is_personal_Valid() const{
    return m_is_personal_isValid;
}

QString OAIAnswerInlineQueryRequest::getNextOffset() const {
    return m_next_offset;
}
void OAIAnswerInlineQueryRequest::setNextOffset(const QString &next_offset) {
    m_next_offset = next_offset;
    m_next_offset_isSet = true;
}

bool OAIAnswerInlineQueryRequest::is_next_offset_Set() const{
    return m_next_offset_isSet;
}

bool OAIAnswerInlineQueryRequest::is_next_offset_Valid() const{
    return m_next_offset_isValid;
}

OAIInlineQueryResultsButton OAIAnswerInlineQueryRequest::getButton() const {
    return m_button;
}
void OAIAnswerInlineQueryRequest::setButton(const OAIInlineQueryResultsButton &button) {
    m_button = button;
    m_button_isSet = true;
}

bool OAIAnswerInlineQueryRequest::is_button_Set() const{
    return m_button_isSet;
}

bool OAIAnswerInlineQueryRequest::is_button_Valid() const{
    return m_button_isValid;
}

bool OAIAnswerInlineQueryRequest::isSet() const {
...
bool OAIAnswerInlineQueryRequest::isValid() const {
