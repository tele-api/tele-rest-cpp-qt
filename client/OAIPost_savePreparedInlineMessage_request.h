...
/*
 * OAIPost_savePreparedInlineMessage_request.h
 *
 * 
 */

#ifndef OAIPost_savePreparedInlineMessage_request_H
#define OAIPost_savePreparedInlineMessage_request_H
...
class OAIPost_savePreparedInlineMessage_request : public OAIObject {
public:
    OAIPost_savePreparedInlineMessage_request();
    OAIPost_savePreparedInlineMessage_request(QString json);
    ~OAIPost_savePreparedInlineMessage_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_savePreparedInlineMessage_request)

#endif // OAIPost_savePreparedInlineMessage_request_H
