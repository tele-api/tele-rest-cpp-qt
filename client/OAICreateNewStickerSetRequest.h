...
/*
 * OAICreateNewStickerSetRequest.h
 *
 * Request parameters for createNewStickerSet
 */

#ifndef OAICreateNewStickerSetRequest_H
#define OAICreateNewStickerSetRequest_H
...
class OAICreateNewStickerSetRequest : public OAIObject {
public:
    OAICreateNewStickerSetRequest();
    OAICreateNewStickerSetRequest(QString json);
    ~OAICreateNewStickerSetRequest() override;
    ...
    QList<OAIInputSticker> getStickers() const;
    void setStickers(const QList<OAIInputSticker> &stickers);
...
private:
    ...
    QList<OAIInputSticker> m_stickers;
...
Q_DECLARE_METATYPE(tele_rest::OAICreateNewStickerSetRequest)

#endif // OAICreateNewStickerSetRequest_H
