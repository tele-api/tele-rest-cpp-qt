...
/*
 * OAISetChatAdministratorCustomTitleRequest.h
 *
 * Request parameters for setChatAdministratorCustomTitle
 */

#ifndef OAISetChatAdministratorCustomTitleRequest_H
#define OAISetChatAdministratorCustomTitleRequest_H
...
class OAISetChatAdministratorCustomTitleRequest : public OAIObject {
public:
    OAISetChatAdministratorCustomTitleRequest();
    OAISetChatAdministratorCustomTitleRequest(QString json);
    ~OAISetChatAdministratorCustomTitleRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetChatAdministratorCustomTitleRequest)

#endif // OAISetChatAdministratorCustomTitleRequest_H
