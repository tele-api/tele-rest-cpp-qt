...
/*
 * OAIPost_sendChatAction_request.h
 *
 * 
 */

#ifndef OAIPost_sendChatAction_request_H
#define OAIPost_sendChatAction_request_H
...
class OAIPost_sendChatAction_request : public OAIObject {
public:
    OAIPost_sendChatAction_request();
    OAIPost_sendChatAction_request(QString json);
    ~OAIPost_sendChatAction_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendChatAction_request)

#endif // OAIPost_sendChatAction_request_H
