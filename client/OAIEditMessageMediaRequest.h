...
/*
 * OAIEditMessageMediaRequest.h
 *
 * Request parameters for editMessageMedia
 */

#ifndef OAIEditMessageMediaRequest_H
#define OAIEditMessageMediaRequest_H
...
class OAIEditMessageMediaRequest : public OAIObject {
public:
    OAIEditMessageMediaRequest();
    OAIEditMessageMediaRequest(QString json);
    ~OAIEditMessageMediaRequest() override;
    ...
    OAIInputMedia getMedia() const;
    void setMedia(const OAIInputMedia &media);
    ...
    OAIEditMessageTextRequest_chat_id getChatId() const;
    void setChatId(const OAIEditMessageTextRequest_chat_id &chat_id);
...
private:
    ...
    OAIEditMessageTextRequest_chat_id m_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAIEditMessageMediaRequest)

#endif // OAIEditMessageMediaRequest_H
