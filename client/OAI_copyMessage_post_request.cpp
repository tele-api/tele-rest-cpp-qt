...
OAI_sendMessage_post_request_chat_id OAI_copyMessage_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_copyMessage_post_request::setChatId(const OAI_sendMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
...
OAI_forwardMessage_post_request_from_chat_id OAI_copyMessage_post_request::getFromChatId() const {
    return m_from_chat_id;
}
void OAI_copyMessage_post_request::setFromChatId(const OAI_forwardMessage_post_request_from_chat_id &from_chat_id) {
...
qint32 OAI_copyMessage_post_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAI_copyMessage_post_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAI_copyMessage_post_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAI_copyMessage_post_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

qint32 OAI_copyMessage_post_request::getVideoStartTimestamp() const {
    return m_video_start_timestamp;
}
void OAI_copyMessage_post_request::setVideoStartTimestamp(const qint32 &video_start_timestamp) {
    m_video_start_timestamp = video_start_timestamp;
    m_video_start_timestamp_isSet = true;
}

bool OAI_copyMessage_post_request::is_video_start_timestamp_Set() const{
    return m_video_start_timestamp_isSet;
}

bool OAI_copyMessage_post_request::is_video_start_timestamp_Valid() const{
...
bool OAI_copyMessage_post_request::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAI_copyMessage_post_request::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAI_copyMessage_post_request::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAI_copyMessage_post_request::is_show_caption_above_media_Valid() const{
...
bool OAI_copyMessage_post_request::isProtectContent() const {
    return m_protect_content;
}
void OAI_copyMessage_post_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAI_copyMessage_post_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAI_copyMessage_post_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAI_copyMessage_post_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAI_copyMessage_post_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAI_copyMessage_post_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAI_copyMessage_post_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

OAIReplyParameters OAI_copyMessage_post_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAI_copyMessage_post_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAI_copyMessage_post_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAI_copyMessage_post_request::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAI_sendMessage_post_request_reply_markup OAI_copyMessage_post_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAI_copyMessage_post_request::setReplyMarkup(const OAI_sendMessage_post_request_reply_markup &reply_markup) {
