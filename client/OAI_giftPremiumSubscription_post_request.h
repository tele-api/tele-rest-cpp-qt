...
/*
 * OAI_giftPremiumSubscription_post_request.h
 *
 * 
 */

#ifndef OAI_giftPremiumSubscription_post_request_H
#define OAI_giftPremiumSubscription_post_request_H
...
class OAI_giftPremiumSubscription_post_request : public OAIObject {
public:
    OAI_giftPremiumSubscription_post_request();
    OAI_giftPremiumSubscription_post_request(QString json);
    ~OAI_giftPremiumSubscription_post_request() override;
    ...
    qint32 getMonthCount() const;
    void setMonthCount(const qint32 &month_count);
    bool is_month_count_Set() const;
    bool is_month_count_Valid() const;
...
private:
    ...
    qint32 m_month_count;
    bool m_month_count_isSet;
    bool m_month_count_isValid;
...
Q_DECLARE_METATYPE(tele_rest::OAI_giftPremiumSubscription_post_request)

#endif // OAI_giftPremiumSubscription_post_request_H
