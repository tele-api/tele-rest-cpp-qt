...
/*
 * OAISendPhotoRequest.h
 *
 * Request parameters for sendPhoto
 */

#ifndef OAISendPhotoRequest_H
#define OAISendPhotoRequest_H
...
class OAISendPhotoRequest : public OAIObject {
public:
    OAISendPhotoRequest();
    OAISendPhotoRequest(QString json);
    ~OAISendPhotoRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendPhotoRequest)

#endif // OAISendPhotoRequest_H
