...
/*
 * OAIEditMessageTextResponse_result.h
 *
 * 
 */

#ifndef OAIEditMessageTextResponse_result_H
#define OAIEditMessageTextResponse_result_H
...
class OAIEditMessageTextResponse_result : public OAIObject {
public:
    OAIEditMessageTextResponse_result();
    OAIEditMessageTextResponse_result(QString json);
    ~OAIEditMessageTextResponse_result() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIEditMessageTextResponse_result)

#endif // OAIEditMessageTextResponse_result_H
