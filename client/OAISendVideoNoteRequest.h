...
/*
 * OAISendVideoNoteRequest.h
 *
 * Request parameters for sendVideoNote
 */

#ifndef OAISendVideoNoteRequest_H
#define OAISendVideoNoteRequest_H
...
class OAISendVideoNoteRequest : public OAIObject {
public:
    OAISendVideoNoteRequest();
    OAISendVideoNoteRequest(QString json);
    ~OAISendVideoNoteRequest() override;
    ...
    QString getVideoNote() const;
    void setVideoNote(const QString &video_note);
...
Q_DECLARE_METATYPE(tele_rest::OAISendVideoNoteRequest)

#endif // OAISendVideoNoteRequest_H
