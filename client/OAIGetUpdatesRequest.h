...
/*
 * OAIGetUpdatesRequest.h
 *
 * Request parameters for getUpdates
 */

#ifndef OAIGetUpdatesRequest_H
#define OAIGetUpdatesRequest_H
...
class OAIGetUpdatesRequest : public OAIObject {
public:
    OAIGetUpdatesRequest();
    OAIGetUpdatesRequest(QString json);
    ~OAIGetUpdatesRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIGetUpdatesRequest)

#endif // OAIGetUpdatesRequest_H
