...
/*
 * OAIPost_sendMessage_request.h
 *
 * 
 */

#ifndef OAIPost_sendMessage_request_H
#define OAIPost_sendMessage_request_H
...
class OAIPost_sendMessage_request : public OAIObject {
public:
    OAIPost_sendMessage_request();
    OAIPost_sendMessage_request(QString json);
    ~OAIPost_sendMessage_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendMessage_request)

#endif // OAIPost_sendMessage_request_H
