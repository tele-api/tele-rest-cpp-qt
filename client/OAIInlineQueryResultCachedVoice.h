...
/*
 * OAIInlineQueryResultCachedVoice.h
 *
...
#ifndef OAIInlineQueryResultCachedVoice_H
#define OAIInlineQueryResultCachedVoice_H
...
class OAIInlineQueryResultCachedVoice : public OAIObject {
public:
    OAIInlineQueryResultCachedVoice();
    OAIInlineQueryResultCachedVoice(QString json);
    ~OAIInlineQueryResultCachedVoice() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInlineQueryResultCachedVoice)

#endif // OAIInlineQueryResultCachedVoice_H
