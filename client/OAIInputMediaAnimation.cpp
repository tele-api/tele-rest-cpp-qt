...
QString OAIInputMediaAnimation::getThumbnail() const {
    return m_thumbnail;
}
void OAIInputMediaAnimation::setThumbnail(const QString &thumbnail) {
    m_thumbnail = thumbnail;
    m_thumbnail_isSet = true;
}

bool OAIInputMediaAnimation::is_thumbnail_Set() const{
    return m_thumbnail_isSet;
}

bool OAIInputMediaAnimation::is_thumbnail_Valid() const{
...
bool OAIInputMediaAnimation::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIInputMediaAnimation::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIInputMediaAnimation::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIInputMediaAnimation::is_show_caption_above_media_Valid() const{
...
bool OAIInputMediaAnimation::isHasSpoiler() const {
    return m_has_spoiler;
}
void OAIInputMediaAnimation::setHasSpoiler(const bool &has_spoiler) {
    m_has_spoiler = has_spoiler;
    m_has_spoiler_isSet = true;
}

bool OAIInputMediaAnimation::is_has_spoiler_Set() const{
    return m_has_spoiler_isSet;
}

bool OAIInputMediaAnimation::is_has_spoiler_Valid() const{
