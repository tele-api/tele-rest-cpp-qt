...
/*
 * OAIForwardMessagesRequest.h
 *
 * Request parameters for forwardMessages
 */

#ifndef OAIForwardMessagesRequest_H
#define OAIForwardMessagesRequest_H
...
class OAIForwardMessagesRequest : public OAIObject {
public:
    OAIForwardMessagesRequest();
    OAIForwardMessagesRequest(QString json);
    ~OAIForwardMessagesRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIForwardMessagesRequest)

#endif // OAIForwardMessagesRequest_H
