...
/*
 * OAIPost_answerCallbackQuery_request.h
 *
 * 
 */

#ifndef OAIPost_answerCallbackQuery_request_H
#define OAIPost_answerCallbackQuery_request_H
...
class OAIPost_answerCallbackQuery_request : public OAIObject {
public:
    OAIPost_answerCallbackQuery_request();
    OAIPost_answerCallbackQuery_request(QString json);
    ~OAIPost_answerCallbackQuery_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_answerCallbackQuery_request)

#endif // OAIPost_answerCallbackQuery_request_H
