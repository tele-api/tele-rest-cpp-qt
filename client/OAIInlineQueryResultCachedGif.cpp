...
OAIInlineQueryResultCachedGif::OAIInlineQueryResultCachedGif(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIInlineQueryResultCachedGif::OAIInlineQueryResultCachedGif() {
    this->initializeModel();
}

OAIInlineQueryResultCachedGif::~OAIInlineQueryResultCachedGif() {}

void OAIInlineQueryResultCachedGif::initializeModel() {
...
void OAIInlineQueryResultCachedGif::fromJson(QString jsonString) {
...
void OAIInlineQueryResultCachedGif::fromJsonObject(QJsonObject json) {
...
QString OAIInlineQueryResultCachedGif::asJson() const {
...
QJsonObject OAIInlineQueryResultCachedGif::asJsonObject() const {
    QJsonObject obj;
    if (m_type_isSet) {
...
QString OAIInlineQueryResultCachedGif::getType() const {
    return m_type;
}
void OAIInlineQueryResultCachedGif::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_type_Set() const{
    return m_type_isSet;
}

bool OAIInlineQueryResultCachedGif::is_type_Valid() const{
    return m_type_isValid;
}

QString OAIInlineQueryResultCachedGif::getId() const {
    return m_id;
}
void OAIInlineQueryResultCachedGif::setId(const QString &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_id_Set() const{
    return m_id_isSet;
}

bool OAIInlineQueryResultCachedGif::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIInlineQueryResultCachedGif::getGifFileId() const {
    return m_gif_file_id;
}
void OAIInlineQueryResultCachedGif::setGifFileId(const QString &gif_file_id) {
    m_gif_file_id = gif_file_id;
    m_gif_file_id_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_gif_file_id_Set() const{
    return m_gif_file_id_isSet;
}

bool OAIInlineQueryResultCachedGif::is_gif_file_id_Valid() const{
    return m_gif_file_id_isValid;
}

QString OAIInlineQueryResultCachedGif::getTitle() const {
    return m_title;
}
void OAIInlineQueryResultCachedGif::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_title_Set() const{
    return m_title_isSet;
}

bool OAIInlineQueryResultCachedGif::is_title_Valid() const{
    return m_title_isValid;
}

QString OAIInlineQueryResultCachedGif::getCaption() const {
    return m_caption;
}
void OAIInlineQueryResultCachedGif::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAIInlineQueryResultCachedGif::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAIInlineQueryResultCachedGif::getParseMode() const {
    return m_parse_mode;
}
void OAIInlineQueryResultCachedGif::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAIInlineQueryResultCachedGif::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIInlineQueryResultCachedGif::getCaptionEntities() const {
    return m_caption_entities;
}
void OAIInlineQueryResultCachedGif::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAIInlineQueryResultCachedGif::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

bool OAIInlineQueryResultCachedGif::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIInlineQueryResultCachedGif::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIInlineQueryResultCachedGif::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

OAIInlineKeyboardMarkup OAIInlineQueryResultCachedGif::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIInlineQueryResultCachedGif::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIInlineQueryResultCachedGif::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

OAIInputMessageContent OAIInlineQueryResultCachedGif::getInputMessageContent() const {
    return m_input_message_content;
}
void OAIInlineQueryResultCachedGif::setInputMessageContent(const OAIInputMessageContent &input_message_content) {
    m_input_message_content = input_message_content;
    m_input_message_content_isSet = true;
}

bool OAIInlineQueryResultCachedGif::is_input_message_content_Set() const{
    return m_input_message_content_isSet;
}

bool OAIInlineQueryResultCachedGif::is_input_message_content_Valid() const{
    return m_input_message_content_isValid;
}

bool OAIInlineQueryResultCachedGif::isSet() const {
...
bool OAIInlineQueryResultCachedGif::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_type_isValid && m_id_isValid && m_gif_file_id_isValid && true;
}
