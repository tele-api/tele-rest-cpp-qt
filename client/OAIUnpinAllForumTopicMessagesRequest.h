...
/*
 * OAIUnpinAllForumTopicMessagesRequest.h
 *
 * Request parameters for unpinAllForumTopicMessages
 */

#ifndef OAIUnpinAllForumTopicMessagesRequest_H
#define OAIUnpinAllForumTopicMessagesRequest_H
...
class OAIUnpinAllForumTopicMessagesRequest : public OAIObject {
public:
    OAIUnpinAllForumTopicMessagesRequest();
    OAIUnpinAllForumTopicMessagesRequest(QString json);
    ~OAIUnpinAllForumTopicMessagesRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIUnpinAllForumTopicMessagesRequest)

#endif // OAIUnpinAllForumTopicMessagesRequest_H
