...
/*
 * OAIEditStoryRequest.h
 *
 * Request parameters for editStory
 */

#ifndef OAIEditStoryRequest_H
#define OAIEditStoryRequest_H
...
class OAIEditStoryRequest : public OAIObject {
public:
    OAIEditStoryRequest();
    OAIEditStoryRequest(QString json);
    ~OAIEditStoryRequest() override;
    ...
    qint32 getStoryId() const;
    void setStoryId(const qint32 &story_id);
...
Q_DECLARE_METATYPE(tele_rest::OAIEditStoryRequest)

#endif // OAIEditStoryRequest_H
