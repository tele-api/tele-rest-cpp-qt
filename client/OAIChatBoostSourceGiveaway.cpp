...
OAIChatBoostSourceGiveaway::OAIChatBoostSourceGiveaway(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIChatBoostSourceGiveaway::OAIChatBoostSourceGiveaway() {
    this->initializeModel();
}

OAIChatBoostSourceGiveaway::~OAIChatBoostSourceGiveaway() {}

void OAIChatBoostSourceGiveaway::initializeModel() {
...
void OAIChatBoostSourceGiveaway::fromJson(QString jsonString) {
...
void OAIChatBoostSourceGiveaway::fromJsonObject(QJsonObject json) {
...
QString OAIChatBoostSourceGiveaway::asJson() const {
...
QJsonObject OAIChatBoostSourceGiveaway::asJsonObject() const {
    QJsonObject obj;
    if (m_source_isSet) {
...
QString OAIChatBoostSourceGiveaway::getSource() const {
    return m_source;
}
void OAIChatBoostSourceGiveaway::setSource(const QString &source) {
    m_source = source;
    m_source_isSet = true;
}

bool OAIChatBoostSourceGiveaway::is_source_Set() const{
    return m_source_isSet;
}

bool OAIChatBoostSourceGiveaway::is_source_Valid() const{
    return m_source_isValid;
}

qint32 OAIChatBoostSourceGiveaway::getGiveawayMessageId() const {
    return m_giveaway_message_id;
}
void OAIChatBoostSourceGiveaway::setGiveawayMessageId(const qint32 &giveaway_message_id) {
    m_giveaway_message_id = giveaway_message_id;
    m_giveaway_message_id_isSet = true;
}

bool OAIChatBoostSourceGiveaway::is_giveaway_message_id_Set() const{
    return m_giveaway_message_id_isSet;
}

bool OAIChatBoostSourceGiveaway::is_giveaway_message_id_Valid() const{
    return m_giveaway_message_id_isValid;
}

OAIUser OAIChatBoostSourceGiveaway::getUser() const {
    return m_user;
}
void OAIChatBoostSourceGiveaway::setUser(const OAIUser &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIChatBoostSourceGiveaway::is_user_Set() const{
    return m_user_isSet;
}

bool OAIChatBoostSourceGiveaway::is_user_Valid() const{
    return m_user_isValid;
}

qint32 OAIChatBoostSourceGiveaway::getPrizeStarCount() const {
    return m_prize_star_count;
}
void OAIChatBoostSourceGiveaway::setPrizeStarCount(const qint32 &prize_star_count) {
    m_prize_star_count = prize_star_count;
    m_prize_star_count_isSet = true;
}

bool OAIChatBoostSourceGiveaway::is_prize_star_count_Set() const{
    return m_prize_star_count_isSet;
}

bool OAIChatBoostSourceGiveaway::is_prize_star_count_Valid() const{
    return m_prize_star_count_isValid;
}

bool OAIChatBoostSourceGiveaway::isIsUnclaimed() const {
    return m_is_unclaimed;
}
void OAIChatBoostSourceGiveaway::setIsUnclaimed(const bool &is_unclaimed) {
    m_is_unclaimed = is_unclaimed;
    m_is_unclaimed_isSet = true;
}

bool OAIChatBoostSourceGiveaway::is_is_unclaimed_Set() const{
    return m_is_unclaimed_isSet;
}

bool OAIChatBoostSourceGiveaway::is_is_unclaimed_Valid() const{
    return m_is_unclaimed_isValid;
}

bool OAIChatBoostSourceGiveaway::isSet() const {
...
bool OAIChatBoostSourceGiveaway::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_source_isValid && m_giveaway_message_id_isValid && true;
}
