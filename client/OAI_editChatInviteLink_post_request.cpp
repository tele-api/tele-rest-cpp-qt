...
#include "OAI_editChatInviteLink_post_request.h"
...
OAI_editChatInviteLink_post_request::OAI_editChatInviteLink_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_editChatInviteLink_post_request::OAI_editChatInviteLink_post_request() {
    this->initializeModel();
}

OAI_editChatInviteLink_post_request::~OAI_editChatInviteLink_post_request() {}

void OAI_editChatInviteLink_post_request::initializeModel() {
...
void OAI_editChatInviteLink_post_request::fromJson(QString jsonString) {
...
void OAI_editChatInviteLink_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_editChatInviteLink_post_request::asJson() const {
...
QJsonObject OAI_editChatInviteLink_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAI_sendMessage_post_request_chat_id OAI_editChatInviteLink_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_editChatInviteLink_post_request::setChatId(const OAI_sendMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAI_editChatInviteLink_post_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAI_editChatInviteLink_post_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAI_editChatInviteLink_post_request::getInviteLink() const {
    return m_invite_link;
}
void OAI_editChatInviteLink_post_request::setInviteLink(const QString &invite_link) {
    m_invite_link = invite_link;
    m_invite_link_isSet = true;
}

bool OAI_editChatInviteLink_post_request::is_invite_link_Set() const{
    return m_invite_link_isSet;
}

bool OAI_editChatInviteLink_post_request::is_invite_link_Valid() const{
    return m_invite_link_isValid;
}

QString OAI_editChatInviteLink_post_request::getName() const {
    return m_name;
}
void OAI_editChatInviteLink_post_request::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAI_editChatInviteLink_post_request::is_name_Set() const{
    return m_name_isSet;
}

bool OAI_editChatInviteLink_post_request::is_name_Valid() const{
    return m_name_isValid;
}

qint32 OAI_editChatInviteLink_post_request::getExpireDate() const {
    return m_expire_date;
}
void OAI_editChatInviteLink_post_request::setExpireDate(const qint32 &expire_date) {
    m_expire_date = expire_date;
    m_expire_date_isSet = true;
}

bool OAI_editChatInviteLink_post_request::is_expire_date_Set() const{
    return m_expire_date_isSet;
}

bool OAI_editChatInviteLink_post_request::is_expire_date_Valid() const{
    return m_expire_date_isValid;
}

qint32 OAI_editChatInviteLink_post_request::getMemberLimit() const {
    return m_member_limit;
}
void OAI_editChatInviteLink_post_request::setMemberLimit(const qint32 &member_limit) {
    m_member_limit = member_limit;
    m_member_limit_isSet = true;
}

bool OAI_editChatInviteLink_post_request::is_member_limit_Set() const{
    return m_member_limit_isSet;
}

bool OAI_editChatInviteLink_post_request::is_member_limit_Valid() const{
    return m_member_limit_isValid;
}

bool OAI_editChatInviteLink_post_request::isCreatesJoinRequest() const {
    return m_creates_join_request;
}
void OAI_editChatInviteLink_post_request::setCreatesJoinRequest(const bool &creates_join_request) {
    m_creates_join_request = creates_join_request;
    m_creates_join_request_isSet = true;
}

bool OAI_editChatInviteLink_post_request::is_creates_join_request_Set() const{
    return m_creates_join_request_isSet;
}

bool OAI_editChatInviteLink_post_request::is_creates_join_request_Valid() const{
    return m_creates_join_request_isValid;
}

bool OAI_editChatInviteLink_post_request::isSet() const {
...
bool OAI_editChatInviteLink_post_request::isValid() const {
