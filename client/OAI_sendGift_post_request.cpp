...
#include "OAI_sendGift_post_request.h"
...
OAI_sendGift_post_request::OAI_sendGift_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_sendGift_post_request::OAI_sendGift_post_request() {
    this->initializeModel();
}

OAI_sendGift_post_request::~OAI_sendGift_post_request() {}

void OAI_sendGift_post_request::initializeModel() {
...
void OAI_sendGift_post_request::fromJson(QString jsonString) {
...
void OAI_sendGift_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_sendGift_post_request::asJson() const {
...
QJsonObject OAI_sendGift_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_gift_id_isSet) {
...
QString OAI_sendGift_post_request::getGiftId() const {
    return m_gift_id;
}
void OAI_sendGift_post_request::setGiftId(const QString &gift_id) {
    m_gift_id = gift_id;
    m_gift_id_isSet = true;
}

bool OAI_sendGift_post_request::is_gift_id_Set() const{
    return m_gift_id_isSet;
}

bool OAI_sendGift_post_request::is_gift_id_Valid() const{
    return m_gift_id_isValid;
}

qint32 OAI_sendGift_post_request::getUserId() const {
    return m_user_id;
}
void OAI_sendGift_post_request::setUserId(const qint32 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAI_sendGift_post_request::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAI_sendGift_post_request::is_user_id_Valid() const{
    return m_user_id_isValid;
}

OAI_sendGift_post_request_chat_id OAI_sendGift_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_sendGift_post_request::setChatId(const OAI_sendGift_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAI_sendGift_post_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAI_sendGift_post_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

bool OAI_sendGift_post_request::isPayForUpgrade() const {
    return m_pay_for_upgrade;
}
void OAI_sendGift_post_request::setPayForUpgrade(const bool &pay_for_upgrade) {
    m_pay_for_upgrade = pay_for_upgrade;
    m_pay_for_upgrade_isSet = true;
}

bool OAI_sendGift_post_request::is_pay_for_upgrade_Set() const{
    return m_pay_for_upgrade_isSet;
}

bool OAI_sendGift_post_request::is_pay_for_upgrade_Valid() const{
    return m_pay_for_upgrade_isValid;
}

QString OAI_sendGift_post_request::getText() const {
    return m_text;
}
void OAI_sendGift_post_request::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAI_sendGift_post_request::is_text_Set() const{
    return m_text_isSet;
}

bool OAI_sendGift_post_request::is_text_Valid() const{
    return m_text_isValid;
}

QString OAI_sendGift_post_request::getTextParseMode() const {
    return m_text_parse_mode;
}
void OAI_sendGift_post_request::setTextParseMode(const QString &text_parse_mode) {
    m_text_parse_mode = text_parse_mode;
    m_text_parse_mode_isSet = true;
}

bool OAI_sendGift_post_request::is_text_parse_mode_Set() const{
    return m_text_parse_mode_isSet;
}

bool OAI_sendGift_post_request::is_text_parse_mode_Valid() const{
    return m_text_parse_mode_isValid;
}

QList<OAIMessageEntity> OAI_sendGift_post_request::getTextEntities() const {
    return m_text_entities;
}
void OAI_sendGift_post_request::setTextEntities(const QList<OAIMessageEntity> &text_entities) {
    m_text_entities = text_entities;
    m_text_entities_isSet = true;
}

bool OAI_sendGift_post_request::is_text_entities_Set() const{
    return m_text_entities_isSet;
}

bool OAI_sendGift_post_request::is_text_entities_Valid() const{
    return m_text_entities_isValid;
}

bool OAI_sendGift_post_request::isSet() const {
...
bool OAI_sendGift_post_request::isValid() const {
