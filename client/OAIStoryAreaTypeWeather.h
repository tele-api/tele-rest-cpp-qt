...
/*
 * OAIStoryAreaTypeWeather.h
 *
 * Describes a story area containing weather information. Currently, a story can have up to 3 weather areas.
 */

#ifndef OAIStoryAreaTypeWeather_H
#define OAIStoryAreaTypeWeather_H
...
class OAIStoryAreaTypeWeather : public OAIObject {
public:
    OAIStoryAreaTypeWeather();
    OAIStoryAreaTypeWeather(QString json);
    ~OAIStoryAreaTypeWeather() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIStoryAreaTypeWeather)

#endif // OAIStoryAreaTypeWeather_H
