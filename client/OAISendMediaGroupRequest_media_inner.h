...
/*
 * OAISendMediaGroupRequest_media_inner.h
 *
 * 
 */

#ifndef OAISendMediaGroupRequest_media_inner_H
#define OAISendMediaGroupRequest_media_inner_H
...
class OAISendMediaGroupRequest_media_inner : public OAIObject {
public:
    OAISendMediaGroupRequest_media_inner();
    OAISendMediaGroupRequest_media_inner(QString json);
    ~OAISendMediaGroupRequest_media_inner() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendMediaGroupRequest_media_inner)

#endif // OAISendMediaGroupRequest_media_inner_H
