...
/*
 * OAI_getGameHighScores_post_request.h
 *
 * 
 */

#ifndef OAI_getGameHighScores_post_request_H
#define OAI_getGameHighScores_post_request_H
...
class OAI_getGameHighScores_post_request : public OAIObject {
public:
    OAI_getGameHighScores_post_request();
    OAI_getGameHighScores_post_request(QString json);
    ~OAI_getGameHighScores_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_getGameHighScores_post_request)

#endif // OAI_getGameHighScores_post_request_H
