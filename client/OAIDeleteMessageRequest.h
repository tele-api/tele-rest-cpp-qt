...
/*
 * OAIDeleteMessageRequest.h
 *
 * Request parameters for deleteMessage
 */

#ifndef OAIDeleteMessageRequest_H
#define OAIDeleteMessageRequest_H
...
class OAIDeleteMessageRequest : public OAIObject {
public:
    OAIDeleteMessageRequest();
    OAIDeleteMessageRequest(QString json);
    ~OAIDeleteMessageRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIDeleteMessageRequest)

#endif // OAIDeleteMessageRequest_H
