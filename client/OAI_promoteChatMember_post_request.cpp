...
OAI_sendMessage_post_request_chat_id OAI_promoteChatMember_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_promoteChatMember_post_request::setChatId(const OAI_sendMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
...
bool OAI_promoteChatMember_post_request::isCanManageChat() const {
    return m_can_manage_chat;
}
void OAI_promoteChatMember_post_request::setCanManageChat(const bool &can_manage_chat) {
    m_can_manage_chat = can_manage_chat;
    m_can_manage_chat_isSet = true;
}

bool OAI_promoteChatMember_post_request::is_can_manage_chat_Set() const{
    return m_can_manage_chat_isSet;
}

bool OAI_promoteChatMember_post_request::is_can_manage_chat_Valid() const{
...
bool OAI_promoteChatMember_post_request::isCanManageVideoChats() const {
    return m_can_manage_video_chats;
}
void OAI_promoteChatMember_post_request::setCanManageVideoChats(const bool &can_manage_video_chats) {
    m_can_manage_video_chats = can_manage_video_chats;
    m_can_manage_video_chats_isSet = true;
}

bool OAI_promoteChatMember_post_request::is_can_manage_video_chats_Set() const{
    return m_can_manage_video_chats_isSet;
}

bool OAI_promoteChatMember_post_request::is_can_manage_video_chats_Valid() const{
...
bool OAI_promoteChatMember_post_request::isCanPostStories() const {
    return m_can_post_stories;
}
void OAI_promoteChatMember_post_request::setCanPostStories(const bool &can_post_stories) {
    m_can_post_stories = can_post_stories;
    m_can_post_stories_isSet = true;
}

bool OAI_promoteChatMember_post_request::is_can_post_stories_Set() const{
    return m_can_post_stories_isSet;
}

bool OAI_promoteChatMember_post_request::is_can_post_stories_Valid() const{
    return m_can_post_stories_isValid;
}

bool OAI_promoteChatMember_post_request::isCanEditStories() const {
    return m_can_edit_stories;
}
void OAI_promoteChatMember_post_request::setCanEditStories(const bool &can_edit_stories) {
    m_can_edit_stories = can_edit_stories;
    m_can_edit_stories_isSet = true;
}

bool OAI_promoteChatMember_post_request::is_can_edit_stories_Set() const{
    return m_can_edit_stories_isSet;
}

bool OAI_promoteChatMember_post_request::is_can_edit_stories_Valid() const{
    return m_can_edit_stories_isValid;
}

bool OAI_promoteChatMember_post_request::isCanDeleteStories() const {
    return m_can_delete_stories;
}
void OAI_promoteChatMember_post_request::setCanDeleteStories(const bool &can_delete_stories) {
    m_can_delete_stories = can_delete_stories;
    m_can_delete_stories_isSet = true;
}

bool OAI_promoteChatMember_post_request::is_can_delete_stories_Set() const{
    return m_can_delete_stories_isSet;
}

bool OAI_promoteChatMember_post_request::is_can_delete_stories_Valid() const{
...
bool OAI_promoteChatMember_post_request::isCanManageTopics() const {
    return m_can_manage_topics;
}
void OAI_promoteChatMember_post_request::setCanManageTopics(const bool &can_manage_topics) {
    m_can_manage_topics = can_manage_topics;
    m_can_manage_topics_isSet = true;
}

bool OAI_promoteChatMember_post_request::is_can_manage_topics_Set() const{
    return m_can_manage_topics_isSet;
}

bool OAI_promoteChatMember_post_request::is_can_manage_topics_Valid() const{
