...
#include "OAIPost_transferGift_request.h"
...
OAIPost_transferGift_request::OAIPost_transferGift_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_transferGift_request::OAIPost_transferGift_request() {
    this->initializeModel();
}

OAIPost_transferGift_request::~OAIPost_transferGift_request() {}

void OAIPost_transferGift_request::initializeModel() {
...
void OAIPost_transferGift_request::fromJson(QString jsonString) {
...
void OAIPost_transferGift_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_transferGift_request::asJson() const {
...
QJsonObject OAIPost_transferGift_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPost_transferGift_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_transferGift_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_transferGift_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_transferGift_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

QString OAIPost_transferGift_request::getOwnedGiftId() const {
    return m_owned_gift_id;
}
void OAIPost_transferGift_request::setOwnedGiftId(const QString &owned_gift_id) {
    m_owned_gift_id = owned_gift_id;
    m_owned_gift_id_isSet = true;
}

bool OAIPost_transferGift_request::is_owned_gift_id_Set() const{
    return m_owned_gift_id_isSet;
}

bool OAIPost_transferGift_request::is_owned_gift_id_Valid() const{
    return m_owned_gift_id_isValid;
}

qint32 OAIPost_transferGift_request::getNewOwnerChatId() const {
    return m_new_owner_chat_id;
}
void OAIPost_transferGift_request::setNewOwnerChatId(const qint32 &new_owner_chat_id) {
    m_new_owner_chat_id = new_owner_chat_id;
    m_new_owner_chat_id_isSet = true;
}

bool OAIPost_transferGift_request::is_new_owner_chat_id_Set() const{
    return m_new_owner_chat_id_isSet;
}

bool OAIPost_transferGift_request::is_new_owner_chat_id_Valid() const{
    return m_new_owner_chat_id_isValid;
}

qint32 OAIPost_transferGift_request::getStarCount() const {
    return m_star_count;
}
void OAIPost_transferGift_request::setStarCount(const qint32 &star_count) {
    m_star_count = star_count;
    m_star_count_isSet = true;
}

bool OAIPost_transferGift_request::is_star_count_Set() const{
    return m_star_count_isSet;
}

bool OAIPost_transferGift_request::is_star_count_Valid() const{
    return m_star_count_isValid;
}

bool OAIPost_transferGift_request::isSet() const {
...
bool OAIPost_transferGift_request::isValid() const {
