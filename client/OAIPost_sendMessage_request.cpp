...
#include "OAIPost_sendMessage_request.h"
...
OAIPost_sendMessage_request::OAIPost_sendMessage_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_sendMessage_request::OAIPost_sendMessage_request() {
    this->initializeModel();
}

OAIPost_sendMessage_request::~OAIPost_sendMessage_request() {}

void OAIPost_sendMessage_request::initializeModel() {
...
void OAIPost_sendMessage_request::fromJson(QString jsonString) {
...
void OAIPost_sendMessage_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_sendMessage_request::asJson() const {
...
QJsonObject OAIPost_sendMessage_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_sendMessage_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_sendMessage_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_sendMessage_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_sendMessage_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAIPost_sendMessage_request::getText() const {
    return m_text;
}
void OAIPost_sendMessage_request::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIPost_sendMessage_request::is_text_Set() const{
    return m_text_isSet;
}

bool OAIPost_sendMessage_request::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIPost_sendMessage_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_sendMessage_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_sendMessage_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_sendMessage_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAIPost_sendMessage_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_sendMessage_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_sendMessage_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_sendMessage_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAIPost_sendMessage_request::getParseMode() const {
    return m_parse_mode;
}
void OAIPost_sendMessage_request::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAIPost_sendMessage_request::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAIPost_sendMessage_request::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIPost_sendMessage_request::getEntities() const {
    return m_entities;
}
void OAIPost_sendMessage_request::setEntities(const QList<OAIMessageEntity> &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAIPost_sendMessage_request::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAIPost_sendMessage_request::is_entities_Valid() const{
    return m_entities_isValid;
}

OAILinkPreviewOptions OAIPost_sendMessage_request::getLinkPreviewOptions() const {
    return m_link_preview_options;
}
void OAIPost_sendMessage_request::setLinkPreviewOptions(const OAILinkPreviewOptions &link_preview_options) {
    m_link_preview_options = link_preview_options;
    m_link_preview_options_isSet = true;
}

bool OAIPost_sendMessage_request::is_link_preview_options_Set() const{
    return m_link_preview_options_isSet;
}

bool OAIPost_sendMessage_request::is_link_preview_options_Valid() const{
    return m_link_preview_options_isValid;
}

bool OAIPost_sendMessage_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPost_sendMessage_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPost_sendMessage_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPost_sendMessage_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPost_sendMessage_request::isProtectContent() const {
    return m_protect_content;
}
void OAIPost_sendMessage_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIPost_sendMessage_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIPost_sendMessage_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIPost_sendMessage_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAIPost_sendMessage_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAIPost_sendMessage_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAIPost_sendMessage_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAIPost_sendMessage_request::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAIPost_sendMessage_request::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAIPost_sendMessage_request::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAIPost_sendMessage_request::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAIPost_sendMessage_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAIPost_sendMessage_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAIPost_sendMessage_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAIPost_sendMessage_request::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAIPost_sendMessage_request_reply_markup OAIPost_sendMessage_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_sendMessage_request::setReplyMarkup(const OAIPost_sendMessage_request_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_sendMessage_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_sendMessage_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_sendMessage_request::isSet() const {
...
bool OAIPost_sendMessage_request::isValid() const {
