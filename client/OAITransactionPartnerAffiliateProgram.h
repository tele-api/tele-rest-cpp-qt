...
/*
 * OAITransactionPartnerAffiliateProgram.h
 *
 * Describes the affiliate program that issued the affiliate commission received via this transaction.
 */

#ifndef OAITransactionPartnerAffiliateProgram_H
#define OAITransactionPartnerAffiliateProgram_H
...
class OAITransactionPartnerAffiliateProgram : public OAIObject {
public:
    OAITransactionPartnerAffiliateProgram();
    OAITransactionPartnerAffiliateProgram(QString json);
    ~OAITransactionPartnerAffiliateProgram() override;
...
Q_DECLARE_METATYPE(tele_rest::OAITransactionPartnerAffiliateProgram)

#endif // OAITransactionPartnerAffiliateProgram_H
