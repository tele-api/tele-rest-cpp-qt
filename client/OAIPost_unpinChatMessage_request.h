...
/*
 * OAIPost_unpinChatMessage_request.h
 *
 * 
 */

#ifndef OAIPost_unpinChatMessage_request_H
#define OAIPost_unpinChatMessage_request_H
...
class OAIPost_unpinChatMessage_request : public OAIObject {
public:
    OAIPost_unpinChatMessage_request();
    OAIPost_unpinChatMessage_request(QString json);
    ~OAIPost_unpinChatMessage_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_unpinChatMessage_request)

#endif // OAIPost_unpinChatMessage_request_H
