...
/*
 * OAICreateInvoiceLinkRequest.h
 *
 * Request parameters for createInvoiceLink
 */

#ifndef OAICreateInvoiceLinkRequest_H
#define OAICreateInvoiceLinkRequest_H
...
class OAICreateInvoiceLinkRequest : public OAIObject {
public:
    OAICreateInvoiceLinkRequest();
    OAICreateInvoiceLinkRequest(QString json);
    ~OAICreateInvoiceLinkRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAICreateInvoiceLinkRequest)

#endif // OAICreateInvoiceLinkRequest_H
