...
/*
 * OAISendAnimationRequest.h
 *
 * Request parameters for sendAnimation
 */

#ifndef OAISendAnimationRequest_H
#define OAISendAnimationRequest_H
...
class OAISendAnimationRequest : public OAIObject {
public:
    OAISendAnimationRequest();
    OAISendAnimationRequest(QString json);
    ~OAISendAnimationRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendAnimationRequest)

#endif // OAISendAnimationRequest_H
