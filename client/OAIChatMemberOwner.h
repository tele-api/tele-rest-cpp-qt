...
/*
 * OAIChatMemberOwner.h
 *
 * Represents a [chat member](https://core.telegram.org/bots/api/#chatmember) that owns the chat and has all administrator privileges.
 */

#ifndef OAIChatMemberOwner_H
#define OAIChatMemberOwner_H
...
class OAIChatMemberOwner : public OAIObject {
public:
    OAIChatMemberOwner();
    OAIChatMemberOwner(QString json);
    ~OAIChatMemberOwner() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIChatMemberOwner)

#endif // OAIChatMemberOwner_H
