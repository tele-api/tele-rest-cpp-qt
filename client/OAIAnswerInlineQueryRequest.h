...
/*
 * OAIAnswerInlineQueryRequest.h
 *
 * Request parameters for answerInlineQuery
 */

#ifndef OAIAnswerInlineQueryRequest_H
#define OAIAnswerInlineQueryRequest_H
...
class OAIAnswerInlineQueryRequest : public OAIObject {
public:
    OAIAnswerInlineQueryRequest();
    OAIAnswerInlineQueryRequest(QString json);
    ~OAIAnswerInlineQueryRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIAnswerInlineQueryRequest)

#endif // OAIAnswerInlineQueryRequest_H
