...
#include "OAI_getBusinessAccountGifts_post_request.h"
...
OAI_getBusinessAccountGifts_post_request::OAI_getBusinessAccountGifts_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_getBusinessAccountGifts_post_request::OAI_getBusinessAccountGifts_post_request() {
    this->initializeModel();
}

OAI_getBusinessAccountGifts_post_request::~OAI_getBusinessAccountGifts_post_request() {}

void OAI_getBusinessAccountGifts_post_request::initializeModel() {
...
void OAI_getBusinessAccountGifts_post_request::fromJson(QString jsonString) {
...
void OAI_getBusinessAccountGifts_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_getBusinessAccountGifts_post_request::asJson() const {
...
QJsonObject OAI_getBusinessAccountGifts_post_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAI_getBusinessAccountGifts_post_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAI_getBusinessAccountGifts_post_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

bool OAI_getBusinessAccountGifts_post_request::isExcludeUnsaved() const {
    return m_exclude_unsaved;
}
void OAI_getBusinessAccountGifts_post_request::setExcludeUnsaved(const bool &exclude_unsaved) {
    m_exclude_unsaved = exclude_unsaved;
    m_exclude_unsaved_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_unsaved_Set() const{
    return m_exclude_unsaved_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_unsaved_Valid() const{
    return m_exclude_unsaved_isValid;
}

bool OAI_getBusinessAccountGifts_post_request::isExcludeSaved() const {
    return m_exclude_saved;
}
void OAI_getBusinessAccountGifts_post_request::setExcludeSaved(const bool &exclude_saved) {
    m_exclude_saved = exclude_saved;
    m_exclude_saved_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_saved_Set() const{
    return m_exclude_saved_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_saved_Valid() const{
    return m_exclude_saved_isValid;
}

bool OAI_getBusinessAccountGifts_post_request::isExcludeUnlimited() const {
    return m_exclude_unlimited;
}
void OAI_getBusinessAccountGifts_post_request::setExcludeUnlimited(const bool &exclude_unlimited) {
    m_exclude_unlimited = exclude_unlimited;
    m_exclude_unlimited_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_unlimited_Set() const{
    return m_exclude_unlimited_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_unlimited_Valid() const{
    return m_exclude_unlimited_isValid;
}

bool OAI_getBusinessAccountGifts_post_request::isExcludeLimited() const {
    return m_exclude_limited;
}
void OAI_getBusinessAccountGifts_post_request::setExcludeLimited(const bool &exclude_limited) {
    m_exclude_limited = exclude_limited;
    m_exclude_limited_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_limited_Set() const{
    return m_exclude_limited_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_limited_Valid() const{
    return m_exclude_limited_isValid;
}

bool OAI_getBusinessAccountGifts_post_request::isExcludeUnique() const {
    return m_exclude_unique;
}
void OAI_getBusinessAccountGifts_post_request::setExcludeUnique(const bool &exclude_unique) {
    m_exclude_unique = exclude_unique;
    m_exclude_unique_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_unique_Set() const{
    return m_exclude_unique_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_exclude_unique_Valid() const{
    return m_exclude_unique_isValid;
}

bool OAI_getBusinessAccountGifts_post_request::isSortByPrice() const {
    return m_sort_by_price;
}
void OAI_getBusinessAccountGifts_post_request::setSortByPrice(const bool &sort_by_price) {
    m_sort_by_price = sort_by_price;
    m_sort_by_price_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_sort_by_price_Set() const{
    return m_sort_by_price_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_sort_by_price_Valid() const{
    return m_sort_by_price_isValid;
}

QString OAI_getBusinessAccountGifts_post_request::getOffset() const {
    return m_offset;
}
void OAI_getBusinessAccountGifts_post_request::setOffset(const QString &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_offset_Valid() const{
    return m_offset_isValid;
}

qint32 OAI_getBusinessAccountGifts_post_request::getLimit() const {
    return m_limit;
}
void OAI_getBusinessAccountGifts_post_request::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAI_getBusinessAccountGifts_post_request::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAI_getBusinessAccountGifts_post_request::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAI_getBusinessAccountGifts_post_request::isSet() const {
...
bool OAI_getBusinessAccountGifts_post_request::isValid() const {
