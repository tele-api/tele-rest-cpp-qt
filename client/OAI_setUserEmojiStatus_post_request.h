...
/*
 * OAI_setUserEmojiStatus_post_request.h
 *
 * 
 */

#ifndef OAI_setUserEmojiStatus_post_request_H
#define OAI_setUserEmojiStatus_post_request_H
...
class OAI_setUserEmojiStatus_post_request : public OAIObject {
public:
    OAI_setUserEmojiStatus_post_request();
    OAI_setUserEmojiStatus_post_request(QString json);
    ~OAI_setUserEmojiStatus_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_setUserEmojiStatus_post_request)

#endif // OAI_setUserEmojiStatus_post_request_H
