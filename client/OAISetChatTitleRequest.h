...
/*
 * OAISetChatTitleRequest.h
 *
 * Request parameters for setChatTitle
 */

#ifndef OAISetChatTitleRequest_H
#define OAISetChatTitleRequest_H
...
class OAISetChatTitleRequest : public OAIObject {
public:
    OAISetChatTitleRequest();
    OAISetChatTitleRequest(QString json);
    ~OAISetChatTitleRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISetChatTitleRequest)

#endif // OAISetChatTitleRequest_H
