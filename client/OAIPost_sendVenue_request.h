...
/*
 * OAIPost_sendVenue_request.h
 *
 * 
 */

#ifndef OAIPost_sendVenue_request_H
#define OAIPost_sendVenue_request_H
...
class OAIPost_sendVenue_request : public OAIObject {
public:
    OAIPost_sendVenue_request();
    OAIPost_sendVenue_request(QString json);
    ~OAIPost_sendVenue_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendVenue_request)

#endif // OAIPost_sendVenue_request_H
