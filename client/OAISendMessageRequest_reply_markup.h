...
/*
 * OAISendMessageRequest_reply_markup.h
 *
 * Additional interface options. A JSON-serialized object for an [inline keyboard](https://core.telegram.org/bots/features#inline-keyboards), [custom reply keyboard](https://core.telegram.org/bots/features#keyboards), instructions to remove a reply keyboard or to force a reply from the user
 */

#ifndef OAISendMessageRequest_reply_markup_H
#define OAISendMessageRequest_reply_markup_H
...
class OAISendMessageRequest_reply_markup : public OAIObject {
public:
    OAISendMessageRequest_reply_markup();
    OAISendMessageRequest_reply_markup(QString json);
    ~OAISendMessageRequest_reply_markup() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendMessageRequest_reply_markup)

#endif // OAISendMessageRequest_reply_markup_H
