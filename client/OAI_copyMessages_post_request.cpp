...
#include "OAI_copyMessages_post_request.h"
...
OAI_copyMessages_post_request::OAI_copyMessages_post_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_copyMessages_post_request::OAI_copyMessages_post_request() {
    this->initializeModel();
}

OAI_copyMessages_post_request::~OAI_copyMessages_post_request() {}

void OAI_copyMessages_post_request::initializeModel() {
...
void OAI_copyMessages_post_request::fromJson(QString jsonString) {
...
void OAI_copyMessages_post_request::fromJsonObject(QJsonObject json) {
...
QString OAI_copyMessages_post_request::asJson() const {
...
QJsonObject OAI_copyMessages_post_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAI_sendMessage_post_request_chat_id OAI_copyMessages_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_copyMessages_post_request::setChatId(const OAI_sendMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAI_copyMessages_post_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAI_copyMessages_post_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

OAI_forwardMessages_post_request_from_chat_id OAI_copyMessages_post_request::getFromChatId() const {
    return m_from_chat_id;
}
void OAI_copyMessages_post_request::setFromChatId(const OAI_forwardMessages_post_request_from_chat_id &from_chat_id) {
    m_from_chat_id = from_chat_id;
    m_from_chat_id_isSet = true;
}

bool OAI_copyMessages_post_request::is_from_chat_id_Set() const{
    return m_from_chat_id_isSet;
}

bool OAI_copyMessages_post_request::is_from_chat_id_Valid() const{
    return m_from_chat_id_isValid;
}

QList<qint32> OAI_copyMessages_post_request::getMessageIds() const {
    return m_message_ids;
}
void OAI_copyMessages_post_request::setMessageIds(const QList<qint32> &message_ids) {
    m_message_ids = message_ids;
    m_message_ids_isSet = true;
}

bool OAI_copyMessages_post_request::is_message_ids_Set() const{
    return m_message_ids_isSet;
}

bool OAI_copyMessages_post_request::is_message_ids_Valid() const{
    return m_message_ids_isValid;
}

qint32 OAI_copyMessages_post_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAI_copyMessages_post_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAI_copyMessages_post_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAI_copyMessages_post_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

bool OAI_copyMessages_post_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAI_copyMessages_post_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAI_copyMessages_post_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAI_copyMessages_post_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAI_copyMessages_post_request::isProtectContent() const {
    return m_protect_content;
}
void OAI_copyMessages_post_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAI_copyMessages_post_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAI_copyMessages_post_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAI_copyMessages_post_request::isRemoveCaption() const {
    return m_remove_caption;
}
void OAI_copyMessages_post_request::setRemoveCaption(const bool &remove_caption) {
    m_remove_caption = remove_caption;
    m_remove_caption_isSet = true;
}

bool OAI_copyMessages_post_request::is_remove_caption_Set() const{
    return m_remove_caption_isSet;
}

bool OAI_copyMessages_post_request::is_remove_caption_Valid() const{
    return m_remove_caption_isValid;
}

bool OAI_copyMessages_post_request::isSet() const {
...
bool OAI_copyMessages_post_request::isValid() const {
