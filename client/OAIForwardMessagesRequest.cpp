...
#include "OAIForwardMessagesRequest.h"
...
OAIForwardMessagesRequest::OAIForwardMessagesRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIForwardMessagesRequest::OAIForwardMessagesRequest() {
    this->initializeModel();
}

OAIForwardMessagesRequest::~OAIForwardMessagesRequest() {}

void OAIForwardMessagesRequest::initializeModel() {
...
void OAIForwardMessagesRequest::fromJson(QString jsonString) {
...
void OAIForwardMessagesRequest::fromJsonObject(QJsonObject json) {
...
QString OAIForwardMessagesRequest::asJson() const {
...
QJsonObject OAIForwardMessagesRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAIForwardMessagesRequest::getChatId() const {
    return m_chat_id;
}
void OAIForwardMessagesRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIForwardMessagesRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIForwardMessagesRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

OAIForwardMessagesRequest_from_chat_id OAIForwardMessagesRequest::getFromChatId() const {
    return m_from_chat_id;
}
void OAIForwardMessagesRequest::setFromChatId(const OAIForwardMessagesRequest_from_chat_id &from_chat_id) {
    m_from_chat_id = from_chat_id;
    m_from_chat_id_isSet = true;
}

bool OAIForwardMessagesRequest::is_from_chat_id_Set() const{
    return m_from_chat_id_isSet;
}

bool OAIForwardMessagesRequest::is_from_chat_id_Valid() const{
    return m_from_chat_id_isValid;
}

QList<qint32> OAIForwardMessagesRequest::getMessageIds() const {
    return m_message_ids;
}
void OAIForwardMessagesRequest::setMessageIds(const QList<qint32> &message_ids) {
    m_message_ids = message_ids;
    m_message_ids_isSet = true;
}

bool OAIForwardMessagesRequest::is_message_ids_Set() const{
    return m_message_ids_isSet;
}

bool OAIForwardMessagesRequest::is_message_ids_Valid() const{
    return m_message_ids_isValid;
}

qint32 OAIForwardMessagesRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIForwardMessagesRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIForwardMessagesRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIForwardMessagesRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

bool OAIForwardMessagesRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAIForwardMessagesRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIForwardMessagesRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIForwardMessagesRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIForwardMessagesRequest::isProtectContent() const {
    return m_protect_content;
}
void OAIForwardMessagesRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIForwardMessagesRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIForwardMessagesRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIForwardMessagesRequest::isSet() const {
...
bool OAIForwardMessagesRequest::isValid() const {
