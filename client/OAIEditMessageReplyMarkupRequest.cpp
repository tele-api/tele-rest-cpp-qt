...
#include "OAIEditMessageReplyMarkupRequest.h"
...
OAIEditMessageReplyMarkupRequest::OAIEditMessageReplyMarkupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditMessageReplyMarkupRequest::OAIEditMessageReplyMarkupRequest() {
    this->initializeModel();
}

OAIEditMessageReplyMarkupRequest::~OAIEditMessageReplyMarkupRequest() {}

void OAIEditMessageReplyMarkupRequest::initializeModel() {
...
void OAIEditMessageReplyMarkupRequest::fromJson(QString jsonString) {
...
void OAIEditMessageReplyMarkupRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEditMessageReplyMarkupRequest::asJson() const {
...
QJsonObject OAIEditMessageReplyMarkupRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEditMessageReplyMarkupRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIEditMessageReplyMarkupRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIEditMessageReplyMarkupRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIEditMessageReplyMarkupRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIEditMessageTextRequest_chat_id OAIEditMessageReplyMarkupRequest::getChatId() const {
    return m_chat_id;
}
void OAIEditMessageReplyMarkupRequest::setChatId(const OAIEditMessageTextRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIEditMessageReplyMarkupRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIEditMessageReplyMarkupRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIEditMessageReplyMarkupRequest::getMessageId() const {
    return m_message_id;
}
void OAIEditMessageReplyMarkupRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIEditMessageReplyMarkupRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIEditMessageReplyMarkupRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIEditMessageReplyMarkupRequest::getInlineMessageId() const {
    return m_inline_message_id;
}
void OAIEditMessageReplyMarkupRequest::setInlineMessageId(const QString &inline_message_id) {
    m_inline_message_id = inline_message_id;
    m_inline_message_id_isSet = true;
}

bool OAIEditMessageReplyMarkupRequest::is_inline_message_id_Set() const{
    return m_inline_message_id_isSet;
}

bool OAIEditMessageReplyMarkupRequest::is_inline_message_id_Valid() const{
    return m_inline_message_id_isValid;
}

OAIInlineKeyboardMarkup OAIEditMessageReplyMarkupRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIEditMessageReplyMarkupRequest::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIEditMessageReplyMarkupRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIEditMessageReplyMarkupRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIEditMessageReplyMarkupRequest::isSet() const {
...
bool OAIEditMessageReplyMarkupRequest::isValid() const {
