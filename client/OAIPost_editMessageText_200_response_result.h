...
/*
 * OAIPost_editMessageText_200_response_result.h
 *
 * 
 */

#ifndef OAIPost_editMessageText_200_response_result_H
#define OAIPost_editMessageText_200_response_result_H
...
class OAIPost_editMessageText_200_response_result : public OAIObject {
public:
    OAIPost_editMessageText_200_response_result();
    OAIPost_editMessageText_200_response_result(QString json);
    ~OAIPost_editMessageText_200_response_result() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_editMessageText_200_response_result)

#endif // OAIPost_editMessageText_200_response_result_H
