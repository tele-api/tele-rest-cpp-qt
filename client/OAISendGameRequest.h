...
/*
 * OAISendGameRequest.h
 *
 * Request parameters for sendGame
 */

#ifndef OAISendGameRequest_H
#define OAISendGameRequest_H
...
class OAISendGameRequest : public OAIObject {
public:
    OAISendGameRequest();
    OAISendGameRequest(QString json);
    ~OAISendGameRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendGameRequest)

#endif // OAISendGameRequest_H
