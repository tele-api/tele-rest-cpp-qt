...
/*
 * OAIRestrictChatMemberRequest.h
 *
 * Request parameters for restrictChatMember
 */

#ifndef OAIRestrictChatMemberRequest_H
#define OAIRestrictChatMemberRequest_H
...
class OAIRestrictChatMemberRequest : public OAIObject {
public:
    OAIRestrictChatMemberRequest();
    OAIRestrictChatMemberRequest(QString json);
    ~OAIRestrictChatMemberRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIRestrictChatMemberRequest)

#endif // OAIRestrictChatMemberRequest_H
