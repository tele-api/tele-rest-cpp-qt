...
#include "OAIEditMessageCaptionRequest.h"
...
OAIEditMessageCaptionRequest::OAIEditMessageCaptionRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditMessageCaptionRequest::OAIEditMessageCaptionRequest() {
    this->initializeModel();
}

OAIEditMessageCaptionRequest::~OAIEditMessageCaptionRequest() {}

void OAIEditMessageCaptionRequest::initializeModel() {
...
void OAIEditMessageCaptionRequest::fromJson(QString jsonString) {
...
void OAIEditMessageCaptionRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEditMessageCaptionRequest::asJson() const {
...
QJsonObject OAIEditMessageCaptionRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIEditMessageCaptionRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIEditMessageCaptionRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIEditMessageCaptionRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIEditMessageTextRequest_chat_id OAIEditMessageCaptionRequest::getChatId() const {
    return m_chat_id;
}
void OAIEditMessageCaptionRequest::setChatId(const OAIEditMessageTextRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIEditMessageCaptionRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIEditMessageCaptionRequest::getMessageId() const {
    return m_message_id;
}
void OAIEditMessageCaptionRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIEditMessageCaptionRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIEditMessageCaptionRequest::getInlineMessageId() const {
    return m_inline_message_id;
}
void OAIEditMessageCaptionRequest::setInlineMessageId(const QString &inline_message_id) {
    m_inline_message_id = inline_message_id;
    m_inline_message_id_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_inline_message_id_Set() const{
    return m_inline_message_id_isSet;
}

bool OAIEditMessageCaptionRequest::is_inline_message_id_Valid() const{
    return m_inline_message_id_isValid;
}

QString OAIEditMessageCaptionRequest::getCaption() const {
    return m_caption;
}
void OAIEditMessageCaptionRequest::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAIEditMessageCaptionRequest::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAIEditMessageCaptionRequest::getParseMode() const {
    return m_parse_mode;
}
void OAIEditMessageCaptionRequest::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAIEditMessageCaptionRequest::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIEditMessageCaptionRequest::getCaptionEntities() const {
    return m_caption_entities;
}
void OAIEditMessageCaptionRequest::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAIEditMessageCaptionRequest::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

bool OAIEditMessageCaptionRequest::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIEditMessageCaptionRequest::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIEditMessageCaptionRequest::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

OAIInlineKeyboardMarkup OAIEditMessageCaptionRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIEditMessageCaptionRequest::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIEditMessageCaptionRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIEditMessageCaptionRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIEditMessageCaptionRequest::isSet() const {
...
bool OAIEditMessageCaptionRequest::isValid() const {
