...
/*
 * OAI_transferGift_post_request.h
 *
 * 
 */

#ifndef OAI_transferGift_post_request_H
#define OAI_transferGift_post_request_H
...
class OAI_transferGift_post_request : public OAIObject {
public:
    OAI_transferGift_post_request();
    OAI_transferGift_post_request(QString json);
    ~OAI_transferGift_post_request() override;
    ...
    qint32 getNewOwnerChatId() const;
    void setNewOwnerChatId(const qint32 &new_owner_chat_id);
    bool is_new_owner_chat_id_Set() const;
    bool is_new_owner_chat_id_Valid() const;
...
private:
    ...
    qint32 m_new_owner_chat_id;
    bool m_new_owner_chat_id_isSet;
    bool m_new_owner_chat_id_isValid;
...
Q_DECLARE_METATYPE(tele_rest::OAI_transferGift_post_request)

#endif // OAI_transferGift_post_request_H
