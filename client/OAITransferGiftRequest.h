...
/*
 * OAITransferGiftRequest.h
 *
 * Request parameters for transferGift
 */

#ifndef OAITransferGiftRequest_H
#define OAITransferGiftRequest_H
...
class OAITransferGiftRequest : public OAIObject {
public:
    OAITransferGiftRequest();
    OAITransferGiftRequest(QString json);
    ~OAITransferGiftRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAITransferGiftRequest)

#endif // OAITransferGiftRequest_H
