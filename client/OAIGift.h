...
class OAIGift : public OAIObject {
public:
    OAIGift();
    OAIGift(QString json);
    ~OAIGift() override;
    ...
    qint32 getUpgradeStarCount() const;
    void setUpgradeStarCount(const qint32 &upgrade_star_count);
    bool is_upgrade_star_count_Set() const;
    bool is_upgrade_star_count_Valid() const;
...
private:
    ...
    qint32 m_upgrade_star_count;
    bool m_upgrade_star_count_isSet;
    bool m_upgrade_star_count_isValid;
...
Q_DECLARE_METATYPE(tele_rest::OAIGift)
