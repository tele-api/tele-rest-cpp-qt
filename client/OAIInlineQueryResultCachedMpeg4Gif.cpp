...
bool OAIInlineQueryResultCachedMpeg4Gif::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIInlineQueryResultCachedMpeg4Gif::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIInlineQueryResultCachedMpeg4Gif::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIInlineQueryResultCachedMpeg4Gif::is_show_caption_above_media_Valid() const{
...
bool OAIInlineQueryResultCachedMpeg4Gif::isValid() const {
    ...
    return m_type_isValid && m_id_isValid && m_mpeg4_file_id_isValid && true;
}
