...
/*
 * OAI_copyMessages_post_request.h
 *
 * 
 */

#ifndef OAI_copyMessages_post_request_H
#define OAI_copyMessages_post_request_H
...
class OAI_copyMessages_post_request : public OAIObject {
public:
    OAI_copyMessages_post_request();
    OAI_copyMessages_post_request(QString json);
    ~OAI_copyMessages_post_request() override;
    ...
    OAI_forwardMessages_post_request_from_chat_id getFromChatId() const;
    void setFromChatId(const OAI_forwardMessages_post_request_from_chat_id &from_chat_id);
    bool is_from_chat_id_Set() const;
    bool is_from_chat_id_Valid() const;

    QList<qint32> getMessageIds() const;
    void setMessageIds(const QList<qint32> &message_ids);
    ...
    bool isRemoveCaption() const;
    void setRemoveCaption(const bool &remove_caption);
    bool is_remove_caption_Set() const;
    bool is_remove_caption_Valid() const;
...
private:
    ...
    OAI_forwardMessages_post_request_from_chat_id m_from_chat_id;
    bool m_from_chat_id_isSet;
    bool m_from_chat_id_isValid;

    QList<qint32> m_message_ids;
    ...
    bool m_remove_caption;
    bool m_remove_caption_isSet;
    bool m_remove_caption_isValid;
};

} // namespace tele_rest

Q_DECLARE_METATYPE(tele_rest::OAI_copyMessages_post_request)

#endif // OAI_copyMessages_post_request_H
