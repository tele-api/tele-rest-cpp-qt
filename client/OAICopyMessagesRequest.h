...
/*
 * OAICopyMessagesRequest.h
 *
 * Request parameters for copyMessages
 */

#ifndef OAICopyMessagesRequest_H
#define OAICopyMessagesRequest_H
...
class OAICopyMessagesRequest : public OAIObject {
public:
    OAICopyMessagesRequest();
    OAICopyMessagesRequest(QString json);
    ~OAICopyMessagesRequest() override;
    ...
    OAIForwardMessagesRequest_from_chat_id getFromChatId() const;
    void setFromChatId(const OAIForwardMessagesRequest_from_chat_id &from_chat_id);
...
private:
    ...
    OAIForwardMessagesRequest_from_chat_id m_from_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAICopyMessagesRequest)

#endif // OAICopyMessagesRequest_H
