...
#ifndef OAIOwnedGifts_H
#define OAIOwnedGifts_H
...
class OAIOwnedGifts : public OAIObject {
public:
    OAIOwnedGifts();
    OAIOwnedGifts(QString json);
    ~OAIOwnedGifts() override;
    ...
    QList<OAIOwnedGift> getGifts() const;
    void setGifts(const QList<OAIOwnedGift> &gifts);
    bool is_gifts_Set() const;
    bool is_gifts_Valid() const;
...
private:
    ...
    QList<OAIOwnedGift> m_gifts;
    bool m_gifts_isSet;
    bool m_gifts_isValid;
...
Q_DECLARE_METATYPE(tele_rest::OAIOwnedGifts)

#endif // OAIOwnedGifts_H
