...
/*
 * OAIStoryAreaTypeLocation.h
 *
 * Describes a story area pointing to a location. Currently, a story can have up to 10 location areas.
 */

#ifndef OAIStoryAreaTypeLocation_H
#define OAIStoryAreaTypeLocation_H
...
class OAIStoryAreaTypeLocation : public OAIObject {
public:
    OAIStoryAreaTypeLocation();
    OAIStoryAreaTypeLocation(QString json);
    ~OAIStoryAreaTypeLocation() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIStoryAreaTypeLocation)

#endif // OAIStoryAreaTypeLocation_H
