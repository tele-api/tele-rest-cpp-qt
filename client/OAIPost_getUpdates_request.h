...
/*
 * OAIPost_getUpdates_request.h
 *
 * 
 */

#ifndef OAIPost_getUpdates_request_H
#define OAIPost_getUpdates_request_H
...
class OAIPost_getUpdates_request : public OAIObject {
public:
    OAIPost_getUpdates_request();
    OAIPost_getUpdates_request(QString json);
    ~OAIPost_getUpdates_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_getUpdates_request)

#endif // OAIPost_getUpdates_request_H
