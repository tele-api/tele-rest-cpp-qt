...
/*
 * OAIConvertGiftToStarsRequest.h
 *
 * Request parameters for convertGiftToStars
 */

#ifndef OAIConvertGiftToStarsRequest_H
#define OAIConvertGiftToStarsRequest_H
...
class OAIConvertGiftToStarsRequest : public OAIObject {
public:
    OAIConvertGiftToStarsRequest();
    OAIConvertGiftToStarsRequest(QString json);
    ~OAIConvertGiftToStarsRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIConvertGiftToStarsRequest)

#endif // OAIConvertGiftToStarsRequest_H
