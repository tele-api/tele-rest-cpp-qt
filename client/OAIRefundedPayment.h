...
/*
 * OAIRefundedPayment.h
 *
 * This object contains basic information about a refunded payment.
 */

#ifndef OAIRefundedPayment_H
#define OAIRefundedPayment_H
...
class OAIRefundedPayment : public OAIObject {
public:
    OAIRefundedPayment();
    OAIRefundedPayment(QString json);
    ~OAIRefundedPayment() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIRefundedPayment)

#endif // OAIRefundedPayment_H
