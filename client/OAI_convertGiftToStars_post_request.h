...
/*
 * OAI_convertGiftToStars_post_request.h
 *
 * 
 */

#ifndef OAI_convertGiftToStars_post_request_H
#define OAI_convertGiftToStars_post_request_H
...
class OAI_convertGiftToStars_post_request : public OAIObject {
public:
    OAI_convertGiftToStars_post_request();
    OAI_convertGiftToStars_post_request(QString json);
    ~OAI_convertGiftToStars_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_convertGiftToStars_post_request)

#endif // OAI_convertGiftToStars_post_request_H
