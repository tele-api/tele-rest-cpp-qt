...
#include "OAIEditMessageTextRequest.h"
...
OAIEditMessageTextRequest::OAIEditMessageTextRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditMessageTextRequest::OAIEditMessageTextRequest() {
    this->initializeModel();
}

OAIEditMessageTextRequest::~OAIEditMessageTextRequest() {}

void OAIEditMessageTextRequest::initializeModel() {
...
void OAIEditMessageTextRequest::fromJson(QString jsonString) {
...
void OAIEditMessageTextRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEditMessageTextRequest::asJson() const {
...
QJsonObject OAIEditMessageTextRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_text_isSet) {
...
QString OAIEditMessageTextRequest::getText() const {
    return m_text;
}
void OAIEditMessageTextRequest::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIEditMessageTextRequest::is_text_Set() const{
    return m_text_isSet;
}

bool OAIEditMessageTextRequest::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIEditMessageTextRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIEditMessageTextRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIEditMessageTextRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIEditMessageTextRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIEditMessageTextRequest_chat_id OAIEditMessageTextRequest::getChatId() const {
    return m_chat_id;
}
void OAIEditMessageTextRequest::setChatId(const OAIEditMessageTextRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIEditMessageTextRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIEditMessageTextRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIEditMessageTextRequest::getMessageId() const {
    return m_message_id;
}
void OAIEditMessageTextRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIEditMessageTextRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIEditMessageTextRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIEditMessageTextRequest::getInlineMessageId() const {
    return m_inline_message_id;
}
void OAIEditMessageTextRequest::setInlineMessageId(const QString &inline_message_id) {
    m_inline_message_id = inline_message_id;
    m_inline_message_id_isSet = true;
}

bool OAIEditMessageTextRequest::is_inline_message_id_Set() const{
    return m_inline_message_id_isSet;
}

bool OAIEditMessageTextRequest::is_inline_message_id_Valid() const{
    return m_inline_message_id_isValid;
}

QString OAIEditMessageTextRequest::getParseMode() const {
    return m_parse_mode;
}
void OAIEditMessageTextRequest::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAIEditMessageTextRequest::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAIEditMessageTextRequest::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIEditMessageTextRequest::getEntities() const {
    return m_entities;
}
void OAIEditMessageTextRequest::setEntities(const QList<OAIMessageEntity> &entities) {
    m_entities = entities;
    m_entities_isSet = true;
}

bool OAIEditMessageTextRequest::is_entities_Set() const{
    return m_entities_isSet;
}

bool OAIEditMessageTextRequest::is_entities_Valid() const{
    return m_entities_isValid;
}

OAILinkPreviewOptions OAIEditMessageTextRequest::getLinkPreviewOptions() const {
    return m_link_preview_options;
}
void OAIEditMessageTextRequest::setLinkPreviewOptions(const OAILinkPreviewOptions &link_preview_options) {
    m_link_preview_options = link_preview_options;
    m_link_preview_options_isSet = true;
}

bool OAIEditMessageTextRequest::is_link_preview_options_Set() const{
    return m_link_preview_options_isSet;
}

bool OAIEditMessageTextRequest::is_link_preview_options_Valid() const{
    return m_link_preview_options_isValid;
}

OAIInlineKeyboardMarkup OAIEditMessageTextRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIEditMessageTextRequest::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIEditMessageTextRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIEditMessageTextRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIEditMessageTextRequest::isSet() const {
...
bool OAIEditMessageTextRequest::isValid() const {
