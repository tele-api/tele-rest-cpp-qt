...
/*
 * OAIPost_sendDice_request.h
 *
 * 
 */

#ifndef OAIPost_sendDice_request_H
#define OAIPost_sendDice_request_H
...
class OAIPost_sendDice_request : public OAIObject {
public:
    OAIPost_sendDice_request();
    OAIPost_sendDice_request(QString json);
    ~OAIPost_sendDice_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendDice_request)

#endif // OAIPost_sendDice_request_H
