...
/*
 * OAI_closeForumTopic_post_request.h
 *
 * 
 */

#ifndef OAI_closeForumTopic_post_request_H
#define OAI_closeForumTopic_post_request_H
...
class OAI_closeForumTopic_post_request : public OAIObject {
public:
    OAI_closeForumTopic_post_request();
    OAI_closeForumTopic_post_request(QString json);
    ~OAI_closeForumTopic_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_closeForumTopic_post_request)

#endif // OAI_closeForumTopic_post_request_H
