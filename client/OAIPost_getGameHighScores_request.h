...
/*
 * OAIPost_getGameHighScores_request.h
 *
 * 
 */

#ifndef OAIPost_getGameHighScores_request_H
#define OAIPost_getGameHighScores_request_H
...
class OAIPost_getGameHighScores_request : public OAIObject {
public:
    OAIPost_getGameHighScores_request();
    OAIPost_getGameHighScores_request(QString json);
    ~OAIPost_getGameHighScores_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_getGameHighScores_request)

#endif // OAIPost_getGameHighScores_request_H
