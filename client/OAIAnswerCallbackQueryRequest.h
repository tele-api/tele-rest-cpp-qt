...
/*
 * OAIAnswerCallbackQueryRequest.h
 *
 * Request parameters for answerCallbackQuery
 */

#ifndef OAIAnswerCallbackQueryRequest_H
#define OAIAnswerCallbackQueryRequest_H
...
class OAIAnswerCallbackQueryRequest : public OAIObject {
public:
    OAIAnswerCallbackQueryRequest();
    OAIAnswerCallbackQueryRequest(QString json);
    ~OAIAnswerCallbackQueryRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIAnswerCallbackQueryRequest)

#endif // OAIAnswerCallbackQueryRequest_H
