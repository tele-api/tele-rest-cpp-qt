...
#ifndef OAITextQuote_H
#define OAITextQuote_H
...
class OAITextQuote : public OAIObject {
public:
    OAITextQuote();
    OAITextQuote(QString json);
    ~OAITextQuote() override;
...
Q_DECLARE_METATYPE(tele_rest::OAITextQuote)

#endif // OAITextQuote_H
