...
/*
 * OAI_forwardMessages_post_request.h
 *
 * 
 */

#ifndef OAI_forwardMessages_post_request_H
#define OAI_forwardMessages_post_request_H
...
class OAI_forwardMessages_post_request : public OAIObject {
public:
    OAI_forwardMessages_post_request();
    OAI_forwardMessages_post_request(QString json);
    ~OAI_forwardMessages_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_forwardMessages_post_request)

#endif // OAI_forwardMessages_post_request_H
