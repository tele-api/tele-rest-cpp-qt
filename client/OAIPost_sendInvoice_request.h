...
/*
 * OAIPost_sendInvoice_request.h
 *
 * 
 */

#ifndef OAIPost_sendInvoice_request_H
#define OAIPost_sendInvoice_request_H
...
class OAIPost_sendInvoice_request : public OAIObject {
public:
    OAIPost_sendInvoice_request();
    OAIPost_sendInvoice_request(QString json);
    ~OAIPost_sendInvoice_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendInvoice_request)

#endif // OAIPost_sendInvoice_request_H
