...
#include "OAISendAnimationRequest.h"
...
OAISendAnimationRequest::OAISendAnimationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendAnimationRequest::OAISendAnimationRequest() {
    this->initializeModel();
}

OAISendAnimationRequest::~OAISendAnimationRequest() {}

void OAISendAnimationRequest::initializeModel() {
...
void OAISendAnimationRequest::fromJson(QString jsonString) {
...
void OAISendAnimationRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendAnimationRequest::asJson() const {
...
QJsonObject OAISendAnimationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
        obj.insert(QString("chat_id"), ::tele_rest::toJsonValue(m_chat_id));
    }
    if (m_animation_isSet) {
...
OAISendMessageRequest_chat_id OAISendAnimationRequest::getChatId() const {
    return m_chat_id;
}
void OAISendAnimationRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendAnimationRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendAnimationRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAISendAnimationRequest::getAnimation() const {
    return m_animation;
}
void OAISendAnimationRequest::setAnimation(const QString &animation) {
    m_animation = animation;
    m_animation_isSet = true;
}

bool OAISendAnimationRequest::is_animation_Set() const{
    return m_animation_isSet;
}

bool OAISendAnimationRequest::is_animation_Valid() const{
    return m_animation_isValid;
}

QString OAISendAnimationRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAISendAnimationRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAISendAnimationRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAISendAnimationRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAISendAnimationRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendAnimationRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendAnimationRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendAnimationRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

qint32 OAISendAnimationRequest::getDuration() const {
    return m_duration;
}
void OAISendAnimationRequest::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAISendAnimationRequest::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAISendAnimationRequest::is_duration_Valid() const{
    return m_duration_isValid;
}

qint32 OAISendAnimationRequest::getWidth() const {
    return m_width;
}
void OAISendAnimationRequest::setWidth(const qint32 &width) {
    m_width = width;
    m_width_isSet = true;
}

bool OAISendAnimationRequest::is_width_Set() const{
    return m_width_isSet;
}

bool OAISendAnimationRequest::is_width_Valid() const{
    return m_width_isValid;
}

qint32 OAISendAnimationRequest::getHeight() const {
    return m_height;
}
void OAISendAnimationRequest::setHeight(const qint32 &height) {
    m_height = height;
    m_height_isSet = true;
}

bool OAISendAnimationRequest::is_height_Set() const{
    return m_height_isSet;
}

bool OAISendAnimationRequest::is_height_Valid() const{
    return m_height_isValid;
}

QString OAISendAnimationRequest::getThumbnail() const {
    return m_thumbnail;
}
void OAISendAnimationRequest::setThumbnail(const QString &thumbnail) {
    m_thumbnail = thumbnail;
    m_thumbnail_isSet = true;
}

bool OAISendAnimationRequest::is_thumbnail_Set() const{
    return m_thumbnail_isSet;
}

bool OAISendAnimationRequest::is_thumbnail_Valid() const{
    return m_thumbnail_isValid;
}

QString OAISendAnimationRequest::getCaption() const {
    return m_caption;
}
void OAISendAnimationRequest::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAISendAnimationRequest::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAISendAnimationRequest::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAISendAnimationRequest::getParseMode() const {
    return m_parse_mode;
}
void OAISendAnimationRequest::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAISendAnimationRequest::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAISendAnimationRequest::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAISendAnimationRequest::getCaptionEntities() const {
    return m_caption_entities;
}
void OAISendAnimationRequest::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAISendAnimationRequest::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAISendAnimationRequest::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

bool OAISendAnimationRequest::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAISendAnimationRequest::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAISendAnimationRequest::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAISendAnimationRequest::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

bool OAISendAnimationRequest::isHasSpoiler() const {
    return m_has_spoiler;
}
void OAISendAnimationRequest::setHasSpoiler(const bool &has_spoiler) {
    m_has_spoiler = has_spoiler;
    m_has_spoiler_isSet = true;
}

bool OAISendAnimationRequest::is_has_spoiler_Set() const{
    return m_has_spoiler_isSet;
}

bool OAISendAnimationRequest::is_has_spoiler_Valid() const{
    return m_has_spoiler_isValid;
}

bool OAISendAnimationRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendAnimationRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendAnimationRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendAnimationRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendAnimationRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendAnimationRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendAnimationRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendAnimationRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendAnimationRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendAnimationRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendAnimationRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendAnimationRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendAnimationRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendAnimationRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendAnimationRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendAnimationRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendAnimationRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendAnimationRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendAnimationRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendAnimationRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAISendMessageRequest_reply_markup OAISendAnimationRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAISendAnimationRequest::setReplyMarkup(const OAISendMessageRequest_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAISendAnimationRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAISendAnimationRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAISendAnimationRequest::isSet() const {
...
bool OAISendAnimationRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_chat_id_isValid && m_animation_isValid && true;
}
