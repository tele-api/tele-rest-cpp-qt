...
/*
 * OAIPost_convertGiftToStars_request.h
 *
 * 
 */

#ifndef OAIPost_convertGiftToStars_request_H
#define OAIPost_convertGiftToStars_request_H
...
class OAIPost_convertGiftToStars_request : public OAIObject {
public:
    OAIPost_convertGiftToStars_request();
    OAIPost_convertGiftToStars_request(QString json);
    ~OAIPost_convertGiftToStars_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_convertGiftToStars_request)

#endif // OAIPost_convertGiftToStars_request_H
