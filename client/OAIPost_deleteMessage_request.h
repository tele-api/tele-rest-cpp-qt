...
/*
 * OAIPost_deleteMessage_request.h
 *
 * 
 */

#ifndef OAIPost_deleteMessage_request_H
#define OAIPost_deleteMessage_request_H
...
class OAIPost_deleteMessage_request : public OAIObject {
public:
    OAIPost_deleteMessage_request();
    OAIPost_deleteMessage_request(QString json);
    ~OAIPost_deleteMessage_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_deleteMessage_request)

#endif // OAIPost_deleteMessage_request_H
