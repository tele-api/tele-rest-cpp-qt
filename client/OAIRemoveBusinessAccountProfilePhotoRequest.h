...
/*
 * OAIRemoveBusinessAccountProfilePhotoRequest.h
 *
 * Request parameters for removeBusinessAccountProfilePhoto
 */

#ifndef OAIRemoveBusinessAccountProfilePhotoRequest_H
#define OAIRemoveBusinessAccountProfilePhotoRequest_H
...
class OAIRemoveBusinessAccountProfilePhotoRequest : public OAIObject {
public:
    OAIRemoveBusinessAccountProfilePhotoRequest();
    OAIRemoveBusinessAccountProfilePhotoRequest(QString json);
    ~OAIRemoveBusinessAccountProfilePhotoRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIRemoveBusinessAccountProfilePhotoRequest)

#endif // OAIRemoveBusinessAccountProfilePhotoRequest_H
