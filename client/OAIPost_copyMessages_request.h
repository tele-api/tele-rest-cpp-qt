...
/*
 * OAIPost_copyMessages_request.h
 *
 * 
 */

#ifndef OAIPost_copyMessages_request_H
#define OAIPost_copyMessages_request_H
...
class OAIPost_copyMessages_request : public OAIObject {
public:
    OAIPost_copyMessages_request();
    OAIPost_copyMessages_request(QString json);
    ~OAIPost_copyMessages_request() override;
    ...
    OAIPost_forwardMessages_request_from_chat_id getFromChatId() const;
    void setFromChatId(const OAIPost_forwardMessages_request_from_chat_id &from_chat_id);
...
private:
    ...
    OAIPost_forwardMessages_request_from_chat_id m_from_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_copyMessages_request)

#endif // OAIPost_copyMessages_request_H
