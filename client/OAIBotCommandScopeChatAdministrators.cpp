...
OAIBotCommandScopeChat_chat_id OAIBotCommandScopeChatAdministrators::getChatId() const {
    return m_chat_id;
}
void OAIBotCommandScopeChatAdministrators::setChatId(const OAIBotCommandScopeChat_chat_id &chat_id) {
    m_chat_id = chat_id;
