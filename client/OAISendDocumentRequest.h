...
/*
 * OAISendDocumentRequest.h
 *
 * Request parameters for sendDocument
 */

#ifndef OAISendDocumentRequest_H
#define OAISendDocumentRequest_H
...
class OAISendDocumentRequest : public OAIObject {
public:
    OAISendDocumentRequest();
    OAISendDocumentRequest(QString json);
    ~OAISendDocumentRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendDocumentRequest)

#endif // OAISendDocumentRequest_H
