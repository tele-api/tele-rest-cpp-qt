...
#include "OAIPost_sendPoll_request.h"
...
OAIPost_sendPoll_request::OAIPost_sendPoll_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_sendPoll_request::OAIPost_sendPoll_request() {
    this->initializeModel();
}

OAIPost_sendPoll_request::~OAIPost_sendPoll_request() {}

void OAIPost_sendPoll_request::initializeModel() {
...
void OAIPost_sendPoll_request::fromJson(QString jsonString) {
...
void OAIPost_sendPoll_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_sendPoll_request::asJson() const {
...
QJsonObject OAIPost_sendPoll_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_sendPoll_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_sendPoll_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_sendPoll_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_sendPoll_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAIPost_sendPoll_request::getQuestion() const {
    return m_question;
}
void OAIPost_sendPoll_request::setQuestion(const QString &question) {
    m_question = question;
    m_question_isSet = true;
}

bool OAIPost_sendPoll_request::is_question_Set() const{
    return m_question_isSet;
}

bool OAIPost_sendPoll_request::is_question_Valid() const{
    return m_question_isValid;
}

QList<OAIInputPollOption> OAIPost_sendPoll_request::getOptions() const {
    return m_options;
}
void OAIPost_sendPoll_request::setOptions(const QList<OAIInputPollOption> &options) {
    m_options = options;
    m_options_isSet = true;
}

bool OAIPost_sendPoll_request::is_options_Set() const{
    return m_options_isSet;
}

bool OAIPost_sendPoll_request::is_options_Valid() const{
    return m_options_isValid;
}

QString OAIPost_sendPoll_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_sendPoll_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_sendPoll_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_sendPoll_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAIPost_sendPoll_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_sendPoll_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_sendPoll_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_sendPoll_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAIPost_sendPoll_request::getQuestionParseMode() const {
    return m_question_parse_mode;
}
void OAIPost_sendPoll_request::setQuestionParseMode(const QString &question_parse_mode) {
    m_question_parse_mode = question_parse_mode;
    m_question_parse_mode_isSet = true;
}

bool OAIPost_sendPoll_request::is_question_parse_mode_Set() const{
    return m_question_parse_mode_isSet;
}

bool OAIPost_sendPoll_request::is_question_parse_mode_Valid() const{
    return m_question_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIPost_sendPoll_request::getQuestionEntities() const {
    return m_question_entities;
}
void OAIPost_sendPoll_request::setQuestionEntities(const QList<OAIMessageEntity> &question_entities) {
    m_question_entities = question_entities;
    m_question_entities_isSet = true;
}

bool OAIPost_sendPoll_request::is_question_entities_Set() const{
    return m_question_entities_isSet;
}

bool OAIPost_sendPoll_request::is_question_entities_Valid() const{
    return m_question_entities_isValid;
}

bool OAIPost_sendPoll_request::isIsAnonymous() const {
    return m_is_anonymous;
}
void OAIPost_sendPoll_request::setIsAnonymous(const bool &is_anonymous) {
    m_is_anonymous = is_anonymous;
    m_is_anonymous_isSet = true;
}

bool OAIPost_sendPoll_request::is_is_anonymous_Set() const{
    return m_is_anonymous_isSet;
}

bool OAIPost_sendPoll_request::is_is_anonymous_Valid() const{
    return m_is_anonymous_isValid;
}

QString OAIPost_sendPoll_request::getType() const {
    return m_type;
}
void OAIPost_sendPoll_request::setType(const QString &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIPost_sendPoll_request::is_type_Set() const{
    return m_type_isSet;
}

bool OAIPost_sendPoll_request::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIPost_sendPoll_request::isAllowsMultipleAnswers() const {
    return m_allows_multiple_answers;
}
void OAIPost_sendPoll_request::setAllowsMultipleAnswers(const bool &allows_multiple_answers) {
    m_allows_multiple_answers = allows_multiple_answers;
    m_allows_multiple_answers_isSet = true;
}

bool OAIPost_sendPoll_request::is_allows_multiple_answers_Set() const{
    return m_allows_multiple_answers_isSet;
}

bool OAIPost_sendPoll_request::is_allows_multiple_answers_Valid() const{
    return m_allows_multiple_answers_isValid;
}

qint32 OAIPost_sendPoll_request::getCorrectOptionId() const {
    return m_correct_option_id;
}
void OAIPost_sendPoll_request::setCorrectOptionId(const qint32 &correct_option_id) {
    m_correct_option_id = correct_option_id;
    m_correct_option_id_isSet = true;
}

bool OAIPost_sendPoll_request::is_correct_option_id_Set() const{
    return m_correct_option_id_isSet;
}

bool OAIPost_sendPoll_request::is_correct_option_id_Valid() const{
    return m_correct_option_id_isValid;
}

QString OAIPost_sendPoll_request::getExplanation() const {
    return m_explanation;
}
void OAIPost_sendPoll_request::setExplanation(const QString &explanation) {
    m_explanation = explanation;
    m_explanation_isSet = true;
}

bool OAIPost_sendPoll_request::is_explanation_Set() const{
    return m_explanation_isSet;
}

bool OAIPost_sendPoll_request::is_explanation_Valid() const{
    return m_explanation_isValid;
}

QString OAIPost_sendPoll_request::getExplanationParseMode() const {
    return m_explanation_parse_mode;
}
void OAIPost_sendPoll_request::setExplanationParseMode(const QString &explanation_parse_mode) {
    m_explanation_parse_mode = explanation_parse_mode;
    m_explanation_parse_mode_isSet = true;
}

bool OAIPost_sendPoll_request::is_explanation_parse_mode_Set() const{
    return m_explanation_parse_mode_isSet;
}

bool OAIPost_sendPoll_request::is_explanation_parse_mode_Valid() const{
    return m_explanation_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIPost_sendPoll_request::getExplanationEntities() const {
    return m_explanation_entities;
}
void OAIPost_sendPoll_request::setExplanationEntities(const QList<OAIMessageEntity> &explanation_entities) {
    m_explanation_entities = explanation_entities;
    m_explanation_entities_isSet = true;
}

bool OAIPost_sendPoll_request::is_explanation_entities_Set() const{
    return m_explanation_entities_isSet;
}

bool OAIPost_sendPoll_request::is_explanation_entities_Valid() const{
    return m_explanation_entities_isValid;
}

qint32 OAIPost_sendPoll_request::getOpenPeriod() const {
    return m_open_period;
}
void OAIPost_sendPoll_request::setOpenPeriod(const qint32 &open_period) {
    m_open_period = open_period;
    m_open_period_isSet = true;
}

bool OAIPost_sendPoll_request::is_open_period_Set() const{
    return m_open_period_isSet;
}

bool OAIPost_sendPoll_request::is_open_period_Valid() const{
    return m_open_period_isValid;
}

qint32 OAIPost_sendPoll_request::getCloseDate() const {
    return m_close_date;
}
void OAIPost_sendPoll_request::setCloseDate(const qint32 &close_date) {
    m_close_date = close_date;
    m_close_date_isSet = true;
}

bool OAIPost_sendPoll_request::is_close_date_Set() const{
    return m_close_date_isSet;
}

bool OAIPost_sendPoll_request::is_close_date_Valid() const{
    return m_close_date_isValid;
}

bool OAIPost_sendPoll_request::isIsClosed() const {
    return m_is_closed;
}
void OAIPost_sendPoll_request::setIsClosed(const bool &is_closed) {
    m_is_closed = is_closed;
    m_is_closed_isSet = true;
}

bool OAIPost_sendPoll_request::is_is_closed_Set() const{
    return m_is_closed_isSet;
}

bool OAIPost_sendPoll_request::is_is_closed_Valid() const{
    return m_is_closed_isValid;
}

bool OAIPost_sendPoll_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPost_sendPoll_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPost_sendPoll_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPost_sendPoll_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPost_sendPoll_request::isProtectContent() const {
    return m_protect_content;
}
void OAIPost_sendPoll_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIPost_sendPoll_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIPost_sendPoll_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIPost_sendPoll_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAIPost_sendPoll_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAIPost_sendPoll_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAIPost_sendPoll_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAIPost_sendPoll_request::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAIPost_sendPoll_request::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAIPost_sendPoll_request::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAIPost_sendPoll_request::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAIPost_sendPoll_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAIPost_sendPoll_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAIPost_sendPoll_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAIPost_sendPoll_request::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAIPost_sendMessage_request_reply_markup OAIPost_sendPoll_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_sendPoll_request::setReplyMarkup(const OAIPost_sendMessage_request_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_sendPoll_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_sendPoll_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_sendPoll_request::isSet() const {
...
bool OAIPost_sendPoll_request::isValid() const {
