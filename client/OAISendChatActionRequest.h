...
/*
 * OAISendChatActionRequest.h
 *
 * Request parameters for sendChatAction
 */

#ifndef OAISendChatActionRequest_H
#define OAISendChatActionRequest_H
...
class OAISendChatActionRequest : public OAIObject {
public:
    OAISendChatActionRequest();
    OAISendChatActionRequest(QString json);
    ~OAISendChatActionRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendChatActionRequest)

#endif // OAISendChatActionRequest_H
