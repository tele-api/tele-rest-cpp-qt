...
/*
 * OAIPost_answerInlineQuery_request.h
 *
 * 
 */

#ifndef OAIPost_answerInlineQuery_request_H
#define OAIPost_answerInlineQuery_request_H
...
class OAIPost_answerInlineQuery_request : public OAIObject {
public:
    OAIPost_answerInlineQuery_request();
    OAIPost_answerInlineQuery_request(QString json);
    ~OAIPost_answerInlineQuery_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_answerInlineQuery_request)

#endif // OAIPost_answerInlineQuery_request_H
