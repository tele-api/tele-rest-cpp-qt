...
/*
 * OAIPost_editMessageText_request.h
 *
 * 
 */

#ifndef OAIPost_editMessageText_request_H
#define OAIPost_editMessageText_request_H
...
class OAIPost_editMessageText_request : public OAIObject {
public:
    OAIPost_editMessageText_request();
    OAIPost_editMessageText_request(QString json);
    ~OAIPost_editMessageText_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_editMessageText_request)

#endif // OAIPost_editMessageText_request_H
