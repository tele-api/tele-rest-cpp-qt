...
/*
 * OAIInlineQueryResultCachedAudio.h
 *
...
#ifndef OAIInlineQueryResultCachedAudio_H
#define OAIInlineQueryResultCachedAudio_H
...
class OAIInlineQueryResultCachedAudio : public OAIObject {
public:
    OAIInlineQueryResultCachedAudio();
    OAIInlineQueryResultCachedAudio(QString json);
    ~OAIInlineQueryResultCachedAudio() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInlineQueryResultCachedAudio)

#endif // OAIInlineQueryResultCachedAudio_H
