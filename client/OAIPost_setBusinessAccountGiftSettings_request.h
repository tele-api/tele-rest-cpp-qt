...
/*
 * OAIPost_setBusinessAccountGiftSettings_request.h
 *
 * 
 */

#ifndef OAIPost_setBusinessAccountGiftSettings_request_H
#define OAIPost_setBusinessAccountGiftSettings_request_H
...
class OAIPost_setBusinessAccountGiftSettings_request : public OAIObject {
public:
    OAIPost_setBusinessAccountGiftSettings_request();
    OAIPost_setBusinessAccountGiftSettings_request(QString json);
    ~OAIPost_setBusinessAccountGiftSettings_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_setBusinessAccountGiftSettings_request)

#endif // OAIPost_setBusinessAccountGiftSettings_request_H
