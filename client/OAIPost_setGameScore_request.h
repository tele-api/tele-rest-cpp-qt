...
/*
 * OAIPost_setGameScore_request.h
 *
 * 
 */

#ifndef OAIPost_setGameScore_request_H
#define OAIPost_setGameScore_request_H
...
class OAIPost_setGameScore_request : public OAIObject {
public:
    OAIPost_setGameScore_request();
    OAIPost_setGameScore_request(QString json);
    ~OAIPost_setGameScore_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_setGameScore_request)

#endif // OAIPost_setGameScore_request_H
