...
/*
 * OAIGetBusinessAccountGiftsRequest.h
 *
 * Request parameters for getBusinessAccountGifts
 */

#ifndef OAIGetBusinessAccountGiftsRequest_H
#define OAIGetBusinessAccountGiftsRequest_H
...
class OAIGetBusinessAccountGiftsRequest : public OAIObject {
public:
    OAIGetBusinessAccountGiftsRequest();
    OAIGetBusinessAccountGiftsRequest(QString json);
    ~OAIGetBusinessAccountGiftsRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIGetBusinessAccountGiftsRequest)

#endif // OAIGetBusinessAccountGiftsRequest_H
