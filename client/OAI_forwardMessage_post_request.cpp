...
OAI_sendMessage_post_request_chat_id OAI_forwardMessage_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_forwardMessage_post_request::setChatId(const OAI_sendMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
...
OAI_forwardMessage_post_request_from_chat_id OAI_forwardMessage_post_request::getFromChatId() const {
    return m_from_chat_id;
}
void OAI_forwardMessage_post_request::setFromChatId(const OAI_forwardMessage_post_request_from_chat_id &from_chat_id) {
...
qint32 OAI_forwardMessage_post_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAI_forwardMessage_post_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAI_forwardMessage_post_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAI_forwardMessage_post_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

qint32 OAI_forwardMessage_post_request::getVideoStartTimestamp() const {
    return m_video_start_timestamp;
}
void OAI_forwardMessage_post_request::setVideoStartTimestamp(const qint32 &video_start_timestamp) {
    m_video_start_timestamp = video_start_timestamp;
    m_video_start_timestamp_isSet = true;
}

bool OAI_forwardMessage_post_request::is_video_start_timestamp_Set() const{
    return m_video_start_timestamp_isSet;
}

bool OAI_forwardMessage_post_request::is_video_start_timestamp_Valid() const{
...
bool OAI_forwardMessage_post_request::isProtectContent() const {
    return m_protect_content;
}
void OAI_forwardMessage_post_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAI_forwardMessage_post_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAI_forwardMessage_post_request::is_protect_content_Valid() const{
