...
#include "OAIPost_getBusinessAccountGifts_request.h"
...
OAIPost_getBusinessAccountGifts_request::OAIPost_getBusinessAccountGifts_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_getBusinessAccountGifts_request::OAIPost_getBusinessAccountGifts_request() {
    this->initializeModel();
}

OAIPost_getBusinessAccountGifts_request::~OAIPost_getBusinessAccountGifts_request() {}

void OAIPost_getBusinessAccountGifts_request::initializeModel() {
...
void OAIPost_getBusinessAccountGifts_request::fromJson(QString jsonString) {
...
void OAIPost_getBusinessAccountGifts_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_getBusinessAccountGifts_request::asJson() const {
...
QJsonObject OAIPost_getBusinessAccountGifts_request::asJsonObject() const {
    QJsonObject obj;
...
QString OAIPost_getBusinessAccountGifts_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_getBusinessAccountGifts_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

bool OAIPost_getBusinessAccountGifts_request::isExcludeUnsaved() const {
    return m_exclude_unsaved;
}
void OAIPost_getBusinessAccountGifts_request::setExcludeUnsaved(const bool &exclude_unsaved) {
    m_exclude_unsaved = exclude_unsaved;
    m_exclude_unsaved_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_unsaved_Set() const{
    return m_exclude_unsaved_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_unsaved_Valid() const{
    return m_exclude_unsaved_isValid;
}

bool OAIPost_getBusinessAccountGifts_request::isExcludeSaved() const {
    return m_exclude_saved;
}
void OAIPost_getBusinessAccountGifts_request::setExcludeSaved(const bool &exclude_saved) {
    m_exclude_saved = exclude_saved;
    m_exclude_saved_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_saved_Set() const{
    return m_exclude_saved_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_saved_Valid() const{
    return m_exclude_saved_isValid;
}

bool OAIPost_getBusinessAccountGifts_request::isExcludeUnlimited() const {
    return m_exclude_unlimited;
}
void OAIPost_getBusinessAccountGifts_request::setExcludeUnlimited(const bool &exclude_unlimited) {
    m_exclude_unlimited = exclude_unlimited;
    m_exclude_unlimited_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_unlimited_Set() const{
    return m_exclude_unlimited_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_unlimited_Valid() const{
    return m_exclude_unlimited_isValid;
}

bool OAIPost_getBusinessAccountGifts_request::isExcludeLimited() const {
    return m_exclude_limited;
}
void OAIPost_getBusinessAccountGifts_request::setExcludeLimited(const bool &exclude_limited) {
    m_exclude_limited = exclude_limited;
    m_exclude_limited_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_limited_Set() const{
    return m_exclude_limited_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_limited_Valid() const{
    return m_exclude_limited_isValid;
}

bool OAIPost_getBusinessAccountGifts_request::isExcludeUnique() const {
    return m_exclude_unique;
}
void OAIPost_getBusinessAccountGifts_request::setExcludeUnique(const bool &exclude_unique) {
    m_exclude_unique = exclude_unique;
    m_exclude_unique_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_unique_Set() const{
    return m_exclude_unique_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_exclude_unique_Valid() const{
    return m_exclude_unique_isValid;
}

bool OAIPost_getBusinessAccountGifts_request::isSortByPrice() const {
    return m_sort_by_price;
}
void OAIPost_getBusinessAccountGifts_request::setSortByPrice(const bool &sort_by_price) {
    m_sort_by_price = sort_by_price;
    m_sort_by_price_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_sort_by_price_Set() const{
    return m_sort_by_price_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_sort_by_price_Valid() const{
    return m_sort_by_price_isValid;
}

QString OAIPost_getBusinessAccountGifts_request::getOffset() const {
    return m_offset;
}
void OAIPost_getBusinessAccountGifts_request::setOffset(const QString &offset) {
    m_offset = offset;
    m_offset_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_offset_Set() const{
    return m_offset_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_offset_Valid() const{
    return m_offset_isValid;
}

qint32 OAIPost_getBusinessAccountGifts_request::getLimit() const {
    return m_limit;
}
void OAIPost_getBusinessAccountGifts_request::setLimit(const qint32 &limit) {
    m_limit = limit;
    m_limit_isSet = true;
}

bool OAIPost_getBusinessAccountGifts_request::is_limit_Set() const{
    return m_limit_isSet;
}

bool OAIPost_getBusinessAccountGifts_request::is_limit_Valid() const{
    return m_limit_isValid;
}

bool OAIPost_getBusinessAccountGifts_request::isSet() const {
...
bool OAIPost_getBusinessAccountGifts_request::isValid() const {
