...
OAIStopPollRequest::OAIStopPollRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIStopPollRequest::OAIStopPollRequest() {
    this->initializeModel();
}

OAIStopPollRequest::~OAIStopPollRequest() {}

void OAIStopPollRequest::initializeModel() {
...
void OAIStopPollRequest::fromJson(QString jsonString) {
...
void OAIStopPollRequest::fromJsonObject(QJsonObject json) {
...
QString OAIStopPollRequest::asJson() const {
...
QJsonObject OAIStopPollRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAIStopPollRequest::getChatId() const {
    return m_chat_id;
}
void OAIStopPollRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIStopPollRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIStopPollRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIStopPollRequest::getMessageId() const {
    return m_message_id;
}
void OAIStopPollRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIStopPollRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIStopPollRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIStopPollRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIStopPollRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIStopPollRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIStopPollRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIInlineKeyboardMarkup OAIStopPollRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIStopPollRequest::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIStopPollRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIStopPollRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIStopPollRequest::isSet() const {
...
bool OAIStopPollRequest::isValid() const {
