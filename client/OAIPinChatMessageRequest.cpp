...
#include "OAIPinChatMessageRequest.h"
...
OAIPinChatMessageRequest::OAIPinChatMessageRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPinChatMessageRequest::OAIPinChatMessageRequest() {
    this->initializeModel();
}

OAIPinChatMessageRequest::~OAIPinChatMessageRequest() {}

void OAIPinChatMessageRequest::initializeModel() {
...
void OAIPinChatMessageRequest::fromJson(QString jsonString) {
...
void OAIPinChatMessageRequest::fromJsonObject(QJsonObject json) {
...
QString OAIPinChatMessageRequest::asJson() const {
...
QJsonObject OAIPinChatMessageRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAIPinChatMessageRequest::getChatId() const {
    return m_chat_id;
}
void OAIPinChatMessageRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPinChatMessageRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPinChatMessageRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIPinChatMessageRequest::getMessageId() const {
    return m_message_id;
}
void OAIPinChatMessageRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIPinChatMessageRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIPinChatMessageRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIPinChatMessageRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPinChatMessageRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPinChatMessageRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPinChatMessageRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

bool OAIPinChatMessageRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPinChatMessageRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPinChatMessageRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPinChatMessageRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPinChatMessageRequest::isSet() const {
...
bool OAIPinChatMessageRequest::isValid() const {
