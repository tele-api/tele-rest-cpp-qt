...
/*
 * OAIPost_sendMessage_request_reply_markup.h
 *
 * Additional interface options. A JSON-serialized object for an [inline keyboard](https://core.telegram.org/bots/features#inline-keyboards), [custom reply keyboard](https://core.telegram.org/bots/features#keyboards), instructions to remove a reply keyboard or to force a reply from the user
 */

#ifndef OAIPost_sendMessage_request_reply_markup_H
#define OAIPost_sendMessage_request_reply_markup_H
...
class OAIPost_sendMessage_request_reply_markup : public OAIObject {
public:
    OAIPost_sendMessage_request_reply_markup();
    OAIPost_sendMessage_request_reply_markup(QString json);
    ~OAIPost_sendMessage_request_reply_markup() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendMessage_request_reply_markup)

#endif // OAIPost_sendMessage_request_reply_markup_H
