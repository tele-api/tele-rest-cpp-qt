...
#ifndef OAIChatBoostSourceGiveaway_H
#define OAIChatBoostSourceGiveaway_H
...
class OAIChatBoostSourceGiveaway : public OAIObject {
public:
    OAIChatBoostSourceGiveaway();
    OAIChatBoostSourceGiveaway(QString json);
    ~OAIChatBoostSourceGiveaway() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIChatBoostSourceGiveaway)

#endif // OAIChatBoostSourceGiveaway_H
