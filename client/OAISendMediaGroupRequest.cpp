...
#include "OAISendMediaGroupRequest.h"
...
OAISendMediaGroupRequest::OAISendMediaGroupRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMediaGroupRequest::OAISendMediaGroupRequest() {
    this->initializeModel();
}

OAISendMediaGroupRequest::~OAISendMediaGroupRequest() {}

void OAISendMediaGroupRequest::initializeModel() {
...
void OAISendMediaGroupRequest::fromJson(QString jsonString) {
...
void OAISendMediaGroupRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendMediaGroupRequest::asJson() const {
...
QJsonObject OAISendMediaGroupRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAISendMediaGroupRequest::getChatId() const {
    return m_chat_id;
}
void OAISendMediaGroupRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendMediaGroupRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendMediaGroupRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QList<OAISendMediaGroupRequest_media_inner> OAISendMediaGroupRequest::getMedia() const {
    return m_media;
}
void OAISendMediaGroupRequest::setMedia(const QList<OAISendMediaGroupRequest_media_inner> &media) {
    m_media = media;
    m_media_isSet = true;
}

bool OAISendMediaGroupRequest::is_media_Set() const{
    return m_media_isSet;
}

bool OAISendMediaGroupRequest::is_media_Valid() const{
    return m_media_isValid;
}

QString OAISendMediaGroupRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAISendMediaGroupRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAISendMediaGroupRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAISendMediaGroupRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAISendMediaGroupRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendMediaGroupRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendMediaGroupRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendMediaGroupRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

bool OAISendMediaGroupRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendMediaGroupRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendMediaGroupRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendMediaGroupRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendMediaGroupRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendMediaGroupRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendMediaGroupRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendMediaGroupRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendMediaGroupRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendMediaGroupRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendMediaGroupRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendMediaGroupRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendMediaGroupRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendMediaGroupRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendMediaGroupRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendMediaGroupRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendMediaGroupRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendMediaGroupRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendMediaGroupRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendMediaGroupRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

bool OAISendMediaGroupRequest::isSet() const {
...
bool OAISendMediaGroupRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_chat_id_isValid && m_media_isValid && true;
}
