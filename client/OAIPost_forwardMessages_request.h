...
/*
 * OAIPost_forwardMessages_request.h
 *
 * 
 */

#ifndef OAIPost_forwardMessages_request_H
#define OAIPost_forwardMessages_request_H
...
class OAIPost_forwardMessages_request : public OAIObject {
public:
    OAIPost_forwardMessages_request();
    OAIPost_forwardMessages_request(QString json);
    ~OAIPost_forwardMessages_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_forwardMessages_request)

#endif // OAIPost_forwardMessages_request_H
