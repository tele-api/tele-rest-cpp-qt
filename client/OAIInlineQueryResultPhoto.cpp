...
QString OAIInlineQueryResultPhoto::getThumbnailUrl() const {
    return m_thumbnail_url;
}
void OAIInlineQueryResultPhoto::setThumbnailUrl(const QString &thumbnail_url) {
    m_thumbnail_url = thumbnail_url;
    m_thumbnail_url_isSet = true;
}

bool OAIInlineQueryResultPhoto::is_thumbnail_url_Set() const{
    return m_thumbnail_url_isSet;
}

bool OAIInlineQueryResultPhoto::is_thumbnail_url_Valid() const{
...
bool OAIInlineQueryResultPhoto::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAIInlineQueryResultPhoto::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAIInlineQueryResultPhoto::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAIInlineQueryResultPhoto::is_show_caption_above_media_Valid() const{
...
bool OAIInlineQueryResultPhoto::isValid() const {
    ...
    return m_type_isValid && m_id_isValid && m_photo_url_isValid && m_thumbnail_url_isValid && true;
}
