...
OAISendVoiceRequest::OAISendVoiceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendVoiceRequest::OAISendVoiceRequest() {
    this->initializeModel();
}

OAISendVoiceRequest::~OAISendVoiceRequest() {}

void OAISendVoiceRequest::initializeModel() {
...
void OAISendVoiceRequest::fromJson(QString jsonString) {
...
void OAISendVoiceRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendVoiceRequest::asJson() const {
...
QJsonObject OAISendVoiceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAISendVoiceRequest::getChatId() const {
    return m_chat_id;
}
void OAISendVoiceRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendVoiceRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendVoiceRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAISendVoiceRequest::getVoice() const {
    return m_voice;
}
void OAISendVoiceRequest::setVoice(const QString &voice) {
    m_voice = voice;
    m_voice_isSet = true;
}

bool OAISendVoiceRequest::is_voice_Set() const{
    return m_voice_isSet;
}

bool OAISendVoiceRequest::is_voice_Valid() const{
    return m_voice_isValid;
}

QString OAISendVoiceRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAISendVoiceRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAISendVoiceRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAISendVoiceRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAISendVoiceRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendVoiceRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendVoiceRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendVoiceRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAISendVoiceRequest::getCaption() const {
    return m_caption;
}
void OAISendVoiceRequest::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAISendVoiceRequest::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAISendVoiceRequest::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAISendVoiceRequest::getParseMode() const {
    return m_parse_mode;
}
void OAISendVoiceRequest::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAISendVoiceRequest::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAISendVoiceRequest::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAISendVoiceRequest::getCaptionEntities() const {
    return m_caption_entities;
}
void OAISendVoiceRequest::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAISendVoiceRequest::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAISendVoiceRequest::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

qint32 OAISendVoiceRequest::getDuration() const {
    return m_duration;
}
void OAISendVoiceRequest::setDuration(const qint32 &duration) {
    m_duration = duration;
    m_duration_isSet = true;
}

bool OAISendVoiceRequest::is_duration_Set() const{
    return m_duration_isSet;
}

bool OAISendVoiceRequest::is_duration_Valid() const{
    return m_duration_isValid;
}

bool OAISendVoiceRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendVoiceRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendVoiceRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendVoiceRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendVoiceRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendVoiceRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendVoiceRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendVoiceRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendVoiceRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendVoiceRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendVoiceRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendVoiceRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendVoiceRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendVoiceRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendVoiceRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendVoiceRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendVoiceRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendVoiceRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendVoiceRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendVoiceRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAISendMessageRequest_reply_markup OAISendVoiceRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAISendVoiceRequest::setReplyMarkup(const OAISendMessageRequest_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAISendVoiceRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAISendVoiceRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAISendVoiceRequest::isSet() const {
...
bool OAISendVoiceRequest::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_chat_id_isValid && m_voice_isValid && true;
}
