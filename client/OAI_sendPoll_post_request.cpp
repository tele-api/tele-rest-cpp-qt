...
OAI_sendMessage_post_request_chat_id OAI_sendPoll_post_request::getChatId() const {
    return m_chat_id;
}
void OAI_sendPoll_post_request::setChatId(const OAI_sendMessage_post_request_chat_id &chat_id) {
    m_chat_id = chat_id;
...
QList<OAIInputPollOption> OAI_sendPoll_post_request::getOptions() const {
    return m_options;
}
void OAI_sendPoll_post_request::setOptions(const QList<OAIInputPollOption> &options) {
    m_options = options;
...
QString OAI_sendPoll_post_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAI_sendPoll_post_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAI_sendPoll_post_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAI_sendPoll_post_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAI_sendPoll_post_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAI_sendPoll_post_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAI_sendPoll_post_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAI_sendPoll_post_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAI_sendPoll_post_request::getQuestionParseMode() const {
    return m_question_parse_mode;
}
void OAI_sendPoll_post_request::setQuestionParseMode(const QString &question_parse_mode) {
    m_question_parse_mode = question_parse_mode;
    m_question_parse_mode_isSet = true;
}

bool OAI_sendPoll_post_request::is_question_parse_mode_Set() const{
    return m_question_parse_mode_isSet;
}

bool OAI_sendPoll_post_request::is_question_parse_mode_Valid() const{
    return m_question_parse_mode_isValid;
}

QList<OAIMessageEntity> OAI_sendPoll_post_request::getQuestionEntities() const {
    return m_question_entities;
}
void OAI_sendPoll_post_request::setQuestionEntities(const QList<OAIMessageEntity> &question_entities) {
    m_question_entities = question_entities;
    m_question_entities_isSet = true;
}

bool OAI_sendPoll_post_request::is_question_entities_Set() const{
    return m_question_entities_isSet;
}

bool OAI_sendPoll_post_request::is_question_entities_Valid() const{
...
bool OAI_sendPoll_post_request::isProtectContent() const {
    return m_protect_content;
}
void OAI_sendPoll_post_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAI_sendPoll_post_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAI_sendPoll_post_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAI_sendPoll_post_request::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAI_sendPoll_post_request::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAI_sendPoll_post_request::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAI_sendPoll_post_request::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAI_sendPoll_post_request::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAI_sendPoll_post_request::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAI_sendPoll_post_request::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAI_sendPoll_post_request::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAI_sendPoll_post_request::getReplyParameters() const {
    return m_reply_parameters;
}
void OAI_sendPoll_post_request::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAI_sendPoll_post_request::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAI_sendPoll_post_request::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAI_sendMessage_post_request_reply_markup OAI_sendPoll_post_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAI_sendPoll_post_request::setReplyMarkup(const OAI_sendMessage_post_request_reply_markup &reply_markup) {
