...
/*
 * OAI_forwardMessage_post_request.h
 *
 * 
 */

#ifndef OAI_forwardMessage_post_request_H
#define OAI_forwardMessage_post_request_H
...
class OAI_forwardMessage_post_request : public OAIObject {
public:
    OAI_forwardMessage_post_request();
    OAI_forwardMessage_post_request(QString json);
    ~OAI_forwardMessage_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_forwardMessage_post_request)

#endif // OAI_forwardMessage_post_request_H
