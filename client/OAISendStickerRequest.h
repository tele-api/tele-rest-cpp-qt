...
/*
 * OAISendStickerRequest.h
 *
 * Request parameters for sendSticker
 */

#ifndef OAISendStickerRequest_H
#define OAISendStickerRequest_H
...
class OAISendStickerRequest : public OAIObject {
public:
    OAISendStickerRequest();
    OAISendStickerRequest(QString json);
    ~OAISendStickerRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendStickerRequest)

#endif // OAISendStickerRequest_H
