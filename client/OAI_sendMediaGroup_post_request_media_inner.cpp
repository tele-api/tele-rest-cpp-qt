...
QString OAI_sendMediaGroup_post_request_media_inner::getThumbnail() const {
    return m_thumbnail;
}
void OAI_sendMediaGroup_post_request_media_inner::setThumbnail(const QString &thumbnail) {
    m_thumbnail = thumbnail;
    m_thumbnail_isSet = true;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_thumbnail_Set() const{
    return m_thumbnail_isSet;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_thumbnail_Valid() const{
...
bool OAI_sendMediaGroup_post_request_media_inner::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAI_sendMediaGroup_post_request_media_inner::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

bool OAI_sendMediaGroup_post_request_media_inner::isHasSpoiler() const {
    return m_has_spoiler;
}
void OAI_sendMediaGroup_post_request_media_inner::setHasSpoiler(const bool &has_spoiler) {
    m_has_spoiler = has_spoiler;
    m_has_spoiler_isSet = true;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_has_spoiler_Set() const{
    return m_has_spoiler_isSet;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_has_spoiler_Valid() const{
    return m_has_spoiler_isValid;
}

QString OAI_sendMediaGroup_post_request_media_inner::getCover() const {
    return m_cover;
}
void OAI_sendMediaGroup_post_request_media_inner::setCover(const QString &cover) {
    m_cover = cover;
    m_cover_isSet = true;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_cover_Set() const{
    return m_cover_isSet;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_cover_Valid() const{
    return m_cover_isValid;
}

qint32 OAI_sendMediaGroup_post_request_media_inner::getStartTimestamp() const {
    return m_start_timestamp;
}
void OAI_sendMediaGroup_post_request_media_inner::setStartTimestamp(const qint32 &start_timestamp) {
    m_start_timestamp = start_timestamp;
    m_start_timestamp_isSet = true;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_start_timestamp_Set() const{
    return m_start_timestamp_isSet;
}

bool OAI_sendMediaGroup_post_request_media_inner::is_start_timestamp_Valid() const{
