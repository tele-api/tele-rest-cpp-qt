...
#include "OAICopyMessageRequest.h"
...
OAICopyMessageRequest::OAICopyMessageRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICopyMessageRequest::OAICopyMessageRequest() {
    this->initializeModel();
}

OAICopyMessageRequest::~OAICopyMessageRequest() {}

void OAICopyMessageRequest::initializeModel() {
...
void OAICopyMessageRequest::fromJson(QString jsonString) {
...
void OAICopyMessageRequest::fromJsonObject(QJsonObject json) {
...
QString OAICopyMessageRequest::asJson() const {
...
QJsonObject OAICopyMessageRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAICopyMessageRequest::getChatId() const {
    return m_chat_id;
}
void OAICopyMessageRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAICopyMessageRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAICopyMessageRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

OAIForwardMessageRequest_from_chat_id OAICopyMessageRequest::getFromChatId() const {
    return m_from_chat_id;
}
void OAICopyMessageRequest::setFromChatId(const OAIForwardMessageRequest_from_chat_id &from_chat_id) {
    m_from_chat_id = from_chat_id;
    m_from_chat_id_isSet = true;
}

bool OAICopyMessageRequest::is_from_chat_id_Set() const{
    return m_from_chat_id_isSet;
}

bool OAICopyMessageRequest::is_from_chat_id_Valid() const{
    return m_from_chat_id_isValid;
}

qint32 OAICopyMessageRequest::getMessageId() const {
    return m_message_id;
}
void OAICopyMessageRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAICopyMessageRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAICopyMessageRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

qint32 OAICopyMessageRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAICopyMessageRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAICopyMessageRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAICopyMessageRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

qint32 OAICopyMessageRequest::getVideoStartTimestamp() const {
    return m_video_start_timestamp;
}
void OAICopyMessageRequest::setVideoStartTimestamp(const qint32 &video_start_timestamp) {
    m_video_start_timestamp = video_start_timestamp;
    m_video_start_timestamp_isSet = true;
}

bool OAICopyMessageRequest::is_video_start_timestamp_Set() const{
    return m_video_start_timestamp_isSet;
}

bool OAICopyMessageRequest::is_video_start_timestamp_Valid() const{
    return m_video_start_timestamp_isValid;
}

QString OAICopyMessageRequest::getCaption() const {
    return m_caption;
}
void OAICopyMessageRequest::setCaption(const QString &caption) {
    m_caption = caption;
    m_caption_isSet = true;
}

bool OAICopyMessageRequest::is_caption_Set() const{
    return m_caption_isSet;
}

bool OAICopyMessageRequest::is_caption_Valid() const{
    return m_caption_isValid;
}

QString OAICopyMessageRequest::getParseMode() const {
    return m_parse_mode;
}
void OAICopyMessageRequest::setParseMode(const QString &parse_mode) {
    m_parse_mode = parse_mode;
    m_parse_mode_isSet = true;
}

bool OAICopyMessageRequest::is_parse_mode_Set() const{
    return m_parse_mode_isSet;
}

bool OAICopyMessageRequest::is_parse_mode_Valid() const{
    return m_parse_mode_isValid;
}

QList<OAIMessageEntity> OAICopyMessageRequest::getCaptionEntities() const {
    return m_caption_entities;
}
void OAICopyMessageRequest::setCaptionEntities(const QList<OAIMessageEntity> &caption_entities) {
    m_caption_entities = caption_entities;
    m_caption_entities_isSet = true;
}

bool OAICopyMessageRequest::is_caption_entities_Set() const{
    return m_caption_entities_isSet;
}

bool OAICopyMessageRequest::is_caption_entities_Valid() const{
    return m_caption_entities_isValid;
}

bool OAICopyMessageRequest::isShowCaptionAboveMedia() const {
    return m_show_caption_above_media;
}
void OAICopyMessageRequest::setShowCaptionAboveMedia(const bool &show_caption_above_media) {
    m_show_caption_above_media = show_caption_above_media;
    m_show_caption_above_media_isSet = true;
}

bool OAICopyMessageRequest::is_show_caption_above_media_Set() const{
    return m_show_caption_above_media_isSet;
}

bool OAICopyMessageRequest::is_show_caption_above_media_Valid() const{
    return m_show_caption_above_media_isValid;
}

bool OAICopyMessageRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAICopyMessageRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAICopyMessageRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAICopyMessageRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAICopyMessageRequest::isProtectContent() const {
    return m_protect_content;
}
void OAICopyMessageRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAICopyMessageRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAICopyMessageRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAICopyMessageRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAICopyMessageRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAICopyMessageRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAICopyMessageRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

OAIReplyParameters OAICopyMessageRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAICopyMessageRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAICopyMessageRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAICopyMessageRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAISendMessageRequest_reply_markup OAICopyMessageRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAICopyMessageRequest::setReplyMarkup(const OAISendMessageRequest_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAICopyMessageRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAICopyMessageRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAICopyMessageRequest::isSet() const {
...
bool OAICopyMessageRequest::isValid() const {
