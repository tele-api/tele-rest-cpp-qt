...
/*
 * OAI_createInvoiceLink_post_request.h
 *
 * 
 */

#ifndef OAI_createInvoiceLink_post_request_H
#define OAI_createInvoiceLink_post_request_H
...
class OAI_createInvoiceLink_post_request : public OAIObject {
public:
    OAI_createInvoiceLink_post_request();
    OAI_createInvoiceLink_post_request(QString json);
    ~OAI_createInvoiceLink_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_createInvoiceLink_post_request)

#endif // OAI_createInvoiceLink_post_request_H
