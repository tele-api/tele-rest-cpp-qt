...
/*
 * OAIRefundStarPaymentRequest.h
 *
 * Request parameters for refundStarPayment
 */

#ifndef OAIRefundStarPaymentRequest_H
#define OAIRefundStarPaymentRequest_H
...
class OAIRefundStarPaymentRequest : public OAIObject {
public:
    OAIRefundStarPaymentRequest();
    OAIRefundStarPaymentRequest(QString json);
    ~OAIRefundStarPaymentRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIRefundStarPaymentRequest)

#endif // OAIRefundStarPaymentRequest_H
