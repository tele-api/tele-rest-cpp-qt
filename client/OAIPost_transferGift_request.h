...
/*
 * OAIPost_transferGift_request.h
 *
 * 
 */

#ifndef OAIPost_transferGift_request_H
#define OAIPost_transferGift_request_H
...
class OAIPost_transferGift_request : public OAIObject {
public:
    OAIPost_transferGift_request();
    OAIPost_transferGift_request(QString json);
    ~OAIPost_transferGift_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_transferGift_request)

#endif // OAIPost_transferGift_request_H
