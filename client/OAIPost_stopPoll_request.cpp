...
#include "OAIPost_stopPoll_request.h"
...
OAIPost_stopPoll_request::OAIPost_stopPoll_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_stopPoll_request::OAIPost_stopPoll_request() {
    this->initializeModel();
}

OAIPost_stopPoll_request::~OAIPost_stopPoll_request() {}

void OAIPost_stopPoll_request::initializeModel() {
...
void OAIPost_stopPoll_request::fromJson(QString jsonString) {
...
void OAIPost_stopPoll_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_stopPoll_request::asJson() const {
...
QJsonObject OAIPost_stopPoll_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_stopPoll_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_stopPoll_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_stopPoll_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_stopPoll_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIPost_stopPoll_request::getMessageId() const {
    return m_message_id;
}
void OAIPost_stopPoll_request::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIPost_stopPoll_request::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIPost_stopPoll_request::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIPost_stopPoll_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_stopPoll_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_stopPoll_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_stopPoll_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIInlineKeyboardMarkup OAIPost_stopPoll_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_stopPoll_request::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_stopPoll_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_stopPoll_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_stopPoll_request::isSet() const {
...
bool OAIPost_stopPoll_request::isValid() const {
