...
#ifndef OAIMenuButton_H
#define OAIMenuButton_H
...
class OAIMenuButton : public OAIObject {
public:
    OAIMenuButton();
    OAIMenuButton(QString json);
    ~OAIMenuButton() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIMenuButton)

#endif // OAIMenuButton_H
