...
/*
 * OAI_setBusinessAccountGiftSettings_post_request.h
 *
 * 
 */

#ifndef OAI_setBusinessAccountGiftSettings_post_request_H
#define OAI_setBusinessAccountGiftSettings_post_request_H
...
class OAI_setBusinessAccountGiftSettings_post_request : public OAIObject {
public:
    OAI_setBusinessAccountGiftSettings_post_request();
    OAI_setBusinessAccountGiftSettings_post_request(QString json);
    ~OAI_setBusinessAccountGiftSettings_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_setBusinessAccountGiftSettings_post_request)

#endif // OAI_setBusinessAccountGiftSettings_post_request_H
