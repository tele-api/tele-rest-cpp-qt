...
#ifndef OAIChatShared_H
#define OAIChatShared_H
...
class OAIChatShared : public OAIObject {
public:
    OAIChatShared();
    OAIChatShared(QString json);
    ~OAIChatShared() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIChatShared)

#endif // OAIChatShared_H
