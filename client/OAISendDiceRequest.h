...
/*
 * OAISendDiceRequest.h
 *
 * Request parameters for sendDice
 */

#ifndef OAISendDiceRequest_H
#define OAISendDiceRequest_H
...
class OAISendDiceRequest : public OAIObject {
public:
    OAISendDiceRequest();
    OAISendDiceRequest(QString json);
    ~OAISendDiceRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendDiceRequest)

#endif // OAISendDiceRequest_H
