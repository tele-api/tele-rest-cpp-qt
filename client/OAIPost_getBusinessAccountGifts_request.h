...
/*
 * OAIPost_getBusinessAccountGifts_request.h
 *
 * 
 */

#ifndef OAIPost_getBusinessAccountGifts_request_H
#define OAIPost_getBusinessAccountGifts_request_H
...
class OAIPost_getBusinessAccountGifts_request : public OAIObject {
public:
    OAIPost_getBusinessAccountGifts_request();
    OAIPost_getBusinessAccountGifts_request(QString json);
    ~OAIPost_getBusinessAccountGifts_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_getBusinessAccountGifts_request)

#endif // OAIPost_getBusinessAccountGifts_request_H
