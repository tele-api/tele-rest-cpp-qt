...
/*
 * OAIStopPollRequest.h
 *
 * Request parameters for stopPoll
 */

#ifndef OAIStopPollRequest_H
#define OAIStopPollRequest_H
...
class OAIStopPollRequest : public OAIObject {
public:
    OAIStopPollRequest();
    OAIStopPollRequest(QString json);
    ~OAIStopPollRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIStopPollRequest)

#endif // OAIStopPollRequest_H
