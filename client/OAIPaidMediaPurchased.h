...
/*
 * OAIPaidMediaPurchased.h
 *
 * This object contains information about a paid media purchase.
 */

#ifndef OAIPaidMediaPurchased_H
#define OAIPaidMediaPurchased_H
...
class OAIPaidMediaPurchased : public OAIObject {
public:
    OAIPaidMediaPurchased();
    OAIPaidMediaPurchased(QString json);
    ~OAIPaidMediaPurchased() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPaidMediaPurchased)

#endif // OAIPaidMediaPurchased_H
