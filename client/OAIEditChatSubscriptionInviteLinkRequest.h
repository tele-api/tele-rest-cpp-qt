...
/*
 * OAIEditChatSubscriptionInviteLinkRequest.h
 *
 * Request parameters for editChatSubscriptionInviteLink
 */

#ifndef OAIEditChatSubscriptionInviteLinkRequest_H
#define OAIEditChatSubscriptionInviteLinkRequest_H
...
class OAIEditChatSubscriptionInviteLinkRequest : public OAIObject {
public:
    OAIEditChatSubscriptionInviteLinkRequest();
    OAIEditChatSubscriptionInviteLinkRequest(QString json);
    ~OAIEditChatSubscriptionInviteLinkRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIEditChatSubscriptionInviteLinkRequest)

#endif // OAIEditChatSubscriptionInviteLinkRequest_H
