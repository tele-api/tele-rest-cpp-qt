...
#include "OAIPost_editMessageLiveLocation_request.h"
...
OAIPost_editMessageLiveLocation_request::OAIPost_editMessageLiveLocation_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_editMessageLiveLocation_request::OAIPost_editMessageLiveLocation_request() {
    this->initializeModel();
}

OAIPost_editMessageLiveLocation_request::~OAIPost_editMessageLiveLocation_request() {}

void OAIPost_editMessageLiveLocation_request::initializeModel() {
...
void OAIPost_editMessageLiveLocation_request::fromJson(QString jsonString) {
...
void OAIPost_editMessageLiveLocation_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_editMessageLiveLocation_request::asJson() const {
...
QJsonObject OAIPost_editMessageLiveLocation_request::asJsonObject() const {
    QJsonObject obj;
    if (m_latitude_isSet) {
...
double OAIPost_editMessageLiveLocation_request::getLatitude() const {
    return m_latitude;
}
void OAIPost_editMessageLiveLocation_request::setLatitude(const double &latitude) {
    m_latitude = latitude;
    m_latitude_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_latitude_Set() const{
    return m_latitude_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_latitude_Valid() const{
    return m_latitude_isValid;
}

double OAIPost_editMessageLiveLocation_request::getLongitude() const {
    return m_longitude;
}
void OAIPost_editMessageLiveLocation_request::setLongitude(const double &longitude) {
    m_longitude = longitude;
    m_longitude_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_longitude_Set() const{
    return m_longitude_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_longitude_Valid() const{
    return m_longitude_isValid;
}

QString OAIPost_editMessageLiveLocation_request::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIPost_editMessageLiveLocation_request::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIPost_editMessageText_request_chat_id OAIPost_editMessageLiveLocation_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_editMessageLiveLocation_request::setChatId(const OAIPost_editMessageText_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIPost_editMessageLiveLocation_request::getMessageId() const {
    return m_message_id;
}
void OAIPost_editMessageLiveLocation_request::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIPost_editMessageLiveLocation_request::getInlineMessageId() const {
    return m_inline_message_id;
}
void OAIPost_editMessageLiveLocation_request::setInlineMessageId(const QString &inline_message_id) {
    m_inline_message_id = inline_message_id;
    m_inline_message_id_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_inline_message_id_Set() const{
    return m_inline_message_id_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_inline_message_id_Valid() const{
    return m_inline_message_id_isValid;
}

qint32 OAIPost_editMessageLiveLocation_request::getLivePeriod() const {
    return m_live_period;
}
void OAIPost_editMessageLiveLocation_request::setLivePeriod(const qint32 &live_period) {
    m_live_period = live_period;
    m_live_period_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_live_period_Set() const{
    return m_live_period_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_live_period_Valid() const{
    return m_live_period_isValid;
}

double OAIPost_editMessageLiveLocation_request::getHorizontalAccuracy() const {
    return m_horizontal_accuracy;
}
void OAIPost_editMessageLiveLocation_request::setHorizontalAccuracy(const double &horizontal_accuracy) {
    m_horizontal_accuracy = horizontal_accuracy;
    m_horizontal_accuracy_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_horizontal_accuracy_Set() const{
    return m_horizontal_accuracy_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_horizontal_accuracy_Valid() const{
    return m_horizontal_accuracy_isValid;
}

qint32 OAIPost_editMessageLiveLocation_request::getHeading() const {
    return m_heading;
}
void OAIPost_editMessageLiveLocation_request::setHeading(const qint32 &heading) {
    m_heading = heading;
    m_heading_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_heading_Set() const{
    return m_heading_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_heading_Valid() const{
    return m_heading_isValid;
}

qint32 OAIPost_editMessageLiveLocation_request::getProximityAlertRadius() const {
    return m_proximity_alert_radius;
}
void OAIPost_editMessageLiveLocation_request::setProximityAlertRadius(const qint32 &proximity_alert_radius) {
    m_proximity_alert_radius = proximity_alert_radius;
    m_proximity_alert_radius_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_proximity_alert_radius_Set() const{
    return m_proximity_alert_radius_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_proximity_alert_radius_Valid() const{
    return m_proximity_alert_radius_isValid;
}

OAIInlineKeyboardMarkup OAIPost_editMessageLiveLocation_request::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIPost_editMessageLiveLocation_request::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIPost_editMessageLiveLocation_request::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIPost_editMessageLiveLocation_request::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIPost_editMessageLiveLocation_request::isSet() const {
...
bool OAIPost_editMessageLiveLocation_request::isValid() const {
