...
#include "OAIConvertGiftToStarsRequest.h"
...
OAIConvertGiftToStarsRequest::OAIConvertGiftToStarsRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIConvertGiftToStarsRequest::OAIConvertGiftToStarsRequest() {
    this->initializeModel();
}

OAIConvertGiftToStarsRequest::~OAIConvertGiftToStarsRequest() {}

void OAIConvertGiftToStarsRequest::initializeModel() {
...
void OAIConvertGiftToStarsRequest::fromJson(QString jsonString) {
...
void OAIConvertGiftToStarsRequest::fromJsonObject(QJsonObject json) {
...
QString OAIConvertGiftToStarsRequest::asJson() const {
...
QJsonObject OAIConvertGiftToStarsRequest::asJsonObject() const {
    QJsonObject obj;
...
QString OAIConvertGiftToStarsRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIConvertGiftToStarsRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIConvertGiftToStarsRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIConvertGiftToStarsRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

QString OAIConvertGiftToStarsRequest::getOwnedGiftId() const {
    return m_owned_gift_id;
}
void OAIConvertGiftToStarsRequest::setOwnedGiftId(const QString &owned_gift_id) {
    m_owned_gift_id = owned_gift_id;
    m_owned_gift_id_isSet = true;
}

bool OAIConvertGiftToStarsRequest::is_owned_gift_id_Set() const{
    return m_owned_gift_id_isSet;
}

bool OAIConvertGiftToStarsRequest::is_owned_gift_id_Valid() const{
    return m_owned_gift_id_isValid;
}

bool OAIConvertGiftToStarsRequest::isSet() const {
...
bool OAIConvertGiftToStarsRequest::isValid() const {
