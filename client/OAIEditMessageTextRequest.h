...
/*
 * OAIEditMessageTextRequest.h
 *
 * Request parameters for editMessageText
 */

#ifndef OAIEditMessageTextRequest_H
#define OAIEditMessageTextRequest_H
...
class OAIEditMessageTextRequest : public OAIObject {
public:
    OAIEditMessageTextRequest();
    OAIEditMessageTextRequest(QString json);
    ~OAIEditMessageTextRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIEditMessageTextRequest)

#endif // OAIEditMessageTextRequest_H
