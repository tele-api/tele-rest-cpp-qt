...
/*
 * OAIPost_promoteChatMember_request.h
 *
 * 
 */

#ifndef OAIPost_promoteChatMember_request_H
#define OAIPost_promoteChatMember_request_H
...
class OAIPost_promoteChatMember_request : public OAIObject {
public:
    OAIPost_promoteChatMember_request();
    OAIPost_promoteChatMember_request(QString json);
    ~OAIPost_promoteChatMember_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_promoteChatMember_request)

#endif // OAIPost_promoteChatMember_request_H
