...
#include "OAICreateInvoiceLinkRequest.h"
...
OAICreateInvoiceLinkRequest::OAICreateInvoiceLinkRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAICreateInvoiceLinkRequest::OAICreateInvoiceLinkRequest() {
    this->initializeModel();
}

OAICreateInvoiceLinkRequest::~OAICreateInvoiceLinkRequest() {}

void OAICreateInvoiceLinkRequest::initializeModel() {
...
void OAICreateInvoiceLinkRequest::fromJson(QString jsonString) {
...
void OAICreateInvoiceLinkRequest::fromJsonObject(QJsonObject json) {
...
QString OAICreateInvoiceLinkRequest::asJson() const {
...
QJsonObject OAICreateInvoiceLinkRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_title_isSet) {
...
QString OAICreateInvoiceLinkRequest::getTitle() const {
    return m_title;
}
void OAICreateInvoiceLinkRequest::setTitle(const QString &title) {
    m_title = title;
    m_title_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_title_Set() const{
    return m_title_isSet;
}

bool OAICreateInvoiceLinkRequest::is_title_Valid() const{
    return m_title_isValid;
}

QString OAICreateInvoiceLinkRequest::getDescription() const {
    return m_description;
}
void OAICreateInvoiceLinkRequest::setDescription(const QString &description) {
    m_description = description;
    m_description_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_description_Set() const{
    return m_description_isSet;
}

bool OAICreateInvoiceLinkRequest::is_description_Valid() const{
    return m_description_isValid;
}

QString OAICreateInvoiceLinkRequest::getPayload() const {
    return m_payload;
}
void OAICreateInvoiceLinkRequest::setPayload(const QString &payload) {
    m_payload = payload;
    m_payload_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_payload_Set() const{
    return m_payload_isSet;
}

bool OAICreateInvoiceLinkRequest::is_payload_Valid() const{
    return m_payload_isValid;
}

QString OAICreateInvoiceLinkRequest::getCurrency() const {
    return m_currency;
}
void OAICreateInvoiceLinkRequest::setCurrency(const QString &currency) {
    m_currency = currency;
    m_currency_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_currency_Set() const{
    return m_currency_isSet;
}

bool OAICreateInvoiceLinkRequest::is_currency_Valid() const{
    return m_currency_isValid;
}

QList<OAILabeledPrice> OAICreateInvoiceLinkRequest::getPrices() const {
    return m_prices;
}
void OAICreateInvoiceLinkRequest::setPrices(const QList<OAILabeledPrice> &prices) {
    m_prices = prices;
    m_prices_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_prices_Set() const{
    return m_prices_isSet;
}

bool OAICreateInvoiceLinkRequest::is_prices_Valid() const{
    return m_prices_isValid;
}

QString OAICreateInvoiceLinkRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAICreateInvoiceLinkRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAICreateInvoiceLinkRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

QString OAICreateInvoiceLinkRequest::getProviderToken() const {
    return m_provider_token;
}
void OAICreateInvoiceLinkRequest::setProviderToken(const QString &provider_token) {
    m_provider_token = provider_token;
    m_provider_token_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_provider_token_Set() const{
    return m_provider_token_isSet;
}

bool OAICreateInvoiceLinkRequest::is_provider_token_Valid() const{
    return m_provider_token_isValid;
}

qint32 OAICreateInvoiceLinkRequest::getSubscriptionPeriod() const {
    return m_subscription_period;
}
void OAICreateInvoiceLinkRequest::setSubscriptionPeriod(const qint32 &subscription_period) {
    m_subscription_period = subscription_period;
    m_subscription_period_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_subscription_period_Set() const{
    return m_subscription_period_isSet;
}

bool OAICreateInvoiceLinkRequest::is_subscription_period_Valid() const{
    return m_subscription_period_isValid;
}

qint32 OAICreateInvoiceLinkRequest::getMaxTipAmount() const {
    return m_max_tip_amount;
}
void OAICreateInvoiceLinkRequest::setMaxTipAmount(const qint32 &max_tip_amount) {
    m_max_tip_amount = max_tip_amount;
    m_max_tip_amount_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_max_tip_amount_Set() const{
    return m_max_tip_amount_isSet;
}

bool OAICreateInvoiceLinkRequest::is_max_tip_amount_Valid() const{
    return m_max_tip_amount_isValid;
}

QList<qint32> OAICreateInvoiceLinkRequest::getSuggestedTipAmounts() const {
    return m_suggested_tip_amounts;
}
void OAICreateInvoiceLinkRequest::setSuggestedTipAmounts(const QList<qint32> &suggested_tip_amounts) {
    m_suggested_tip_amounts = suggested_tip_amounts;
    m_suggested_tip_amounts_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_suggested_tip_amounts_Set() const{
    return m_suggested_tip_amounts_isSet;
}

bool OAICreateInvoiceLinkRequest::is_suggested_tip_amounts_Valid() const{
    return m_suggested_tip_amounts_isValid;
}

QString OAICreateInvoiceLinkRequest::getProviderData() const {
    return m_provider_data;
}
void OAICreateInvoiceLinkRequest::setProviderData(const QString &provider_data) {
    m_provider_data = provider_data;
    m_provider_data_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_provider_data_Set() const{
    return m_provider_data_isSet;
}

bool OAICreateInvoiceLinkRequest::is_provider_data_Valid() const{
    return m_provider_data_isValid;
}

QString OAICreateInvoiceLinkRequest::getPhotoUrl() const {
    return m_photo_url;
}
void OAICreateInvoiceLinkRequest::setPhotoUrl(const QString &photo_url) {
    m_photo_url = photo_url;
    m_photo_url_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_photo_url_Set() const{
    return m_photo_url_isSet;
}

bool OAICreateInvoiceLinkRequest::is_photo_url_Valid() const{
    return m_photo_url_isValid;
}

qint32 OAICreateInvoiceLinkRequest::getPhotoSize() const {
    return m_photo_size;
}
void OAICreateInvoiceLinkRequest::setPhotoSize(const qint32 &photo_size) {
    m_photo_size = photo_size;
    m_photo_size_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_photo_size_Set() const{
    return m_photo_size_isSet;
}

bool OAICreateInvoiceLinkRequest::is_photo_size_Valid() const{
    return m_photo_size_isValid;
}

qint32 OAICreateInvoiceLinkRequest::getPhotoWidth() const {
    return m_photo_width;
}
void OAICreateInvoiceLinkRequest::setPhotoWidth(const qint32 &photo_width) {
    m_photo_width = photo_width;
    m_photo_width_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_photo_width_Set() const{
    return m_photo_width_isSet;
}

bool OAICreateInvoiceLinkRequest::is_photo_width_Valid() const{
    return m_photo_width_isValid;
}

qint32 OAICreateInvoiceLinkRequest::getPhotoHeight() const {
    return m_photo_height;
}
void OAICreateInvoiceLinkRequest::setPhotoHeight(const qint32 &photo_height) {
    m_photo_height = photo_height;
    m_photo_height_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_photo_height_Set() const{
    return m_photo_height_isSet;
}

bool OAICreateInvoiceLinkRequest::is_photo_height_Valid() const{
    return m_photo_height_isValid;
}

bool OAICreateInvoiceLinkRequest::isNeedName() const {
    return m_need_name;
}
void OAICreateInvoiceLinkRequest::setNeedName(const bool &need_name) {
    m_need_name = need_name;
    m_need_name_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_need_name_Set() const{
    return m_need_name_isSet;
}

bool OAICreateInvoiceLinkRequest::is_need_name_Valid() const{
    return m_need_name_isValid;
}

bool OAICreateInvoiceLinkRequest::isNeedPhoneNumber() const {
    return m_need_phone_number;
}
void OAICreateInvoiceLinkRequest::setNeedPhoneNumber(const bool &need_phone_number) {
    m_need_phone_number = need_phone_number;
    m_need_phone_number_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_need_phone_number_Set() const{
    return m_need_phone_number_isSet;
}

bool OAICreateInvoiceLinkRequest::is_need_phone_number_Valid() const{
    return m_need_phone_number_isValid;
}

bool OAICreateInvoiceLinkRequest::isNeedEmail() const {
    return m_need_email;
}
void OAICreateInvoiceLinkRequest::setNeedEmail(const bool &need_email) {
    m_need_email = need_email;
    m_need_email_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_need_email_Set() const{
    return m_need_email_isSet;
}

bool OAICreateInvoiceLinkRequest::is_need_email_Valid() const{
    return m_need_email_isValid;
}

bool OAICreateInvoiceLinkRequest::isNeedShippingAddress() const {
    return m_need_shipping_address;
}
void OAICreateInvoiceLinkRequest::setNeedShippingAddress(const bool &need_shipping_address) {
    m_need_shipping_address = need_shipping_address;
    m_need_shipping_address_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_need_shipping_address_Set() const{
    return m_need_shipping_address_isSet;
}

bool OAICreateInvoiceLinkRequest::is_need_shipping_address_Valid() const{
    return m_need_shipping_address_isValid;
}

bool OAICreateInvoiceLinkRequest::isSendPhoneNumberToProvider() const {
    return m_send_phone_number_to_provider;
}
void OAICreateInvoiceLinkRequest::setSendPhoneNumberToProvider(const bool &send_phone_number_to_provider) {
    m_send_phone_number_to_provider = send_phone_number_to_provider;
    m_send_phone_number_to_provider_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_send_phone_number_to_provider_Set() const{
    return m_send_phone_number_to_provider_isSet;
}

bool OAICreateInvoiceLinkRequest::is_send_phone_number_to_provider_Valid() const{
    return m_send_phone_number_to_provider_isValid;
}

bool OAICreateInvoiceLinkRequest::isSendEmailToProvider() const {
    return m_send_email_to_provider;
}
void OAICreateInvoiceLinkRequest::setSendEmailToProvider(const bool &send_email_to_provider) {
    m_send_email_to_provider = send_email_to_provider;
    m_send_email_to_provider_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_send_email_to_provider_Set() const{
    return m_send_email_to_provider_isSet;
}

bool OAICreateInvoiceLinkRequest::is_send_email_to_provider_Valid() const{
    return m_send_email_to_provider_isValid;
}

bool OAICreateInvoiceLinkRequest::isIsFlexible() const {
    return m_is_flexible;
}
void OAICreateInvoiceLinkRequest::setIsFlexible(const bool &is_flexible) {
    m_is_flexible = is_flexible;
    m_is_flexible_isSet = true;
}

bool OAICreateInvoiceLinkRequest::is_is_flexible_Set() const{
    return m_is_flexible_isSet;
}

bool OAICreateInvoiceLinkRequest::is_is_flexible_Valid() const{
    return m_is_flexible_isValid;
}

bool OAICreateInvoiceLinkRequest::isSet() const {
...
bool OAICreateInvoiceLinkRequest::isValid() const {
