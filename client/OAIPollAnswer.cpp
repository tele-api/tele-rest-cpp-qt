...
void OAIPollAnswer::initializeModel() {
    ...
    m_voter_chat_isSet = false;
    m_voter_chat_isValid = false;
...
void OAIPollAnswer::fromJsonObject(QJsonObject json) {
    ...
    m_poll_id_isValid = ::tele_rest::fromJsonValue(m_poll_id, json[QString("poll_id")]);
    m_poll_id_isSet = !json[QString("poll_id")].isNull() && m_poll_id_isValid;

    m_option_ids_isValid = ::tele_rest::fromJsonValue(m_option_ids, json[QString("option_ids")]);
    m_option_ids_isSet = !json[QString("option_ids")].isNull() && m_option_ids_isValid;

    m_voter_chat_isValid = ::tele_rest::fromJsonValue(m_voter_chat, json[QString("voter_chat")]);
    m_voter_chat_isSet = !json[QString("voter_chat")].isNull() && m_voter_chat_isValid;
...
QJsonObject OAIPollAnswer::asJsonObject() const {
    QJsonObject obj;
    if (m_poll_id_isSet) {
        obj.insert(QString("poll_id"), ::tele_rest::toJsonValue(m_poll_id));
    }
    if (m_option_ids.size() > 0) {
        obj.insert(QString("option_ids"), ::tele_rest::toJsonValue(m_option_ids));
    }
    if (m_voter_chat.isSet()) {
        obj.insert(QString("voter_chat"), ::tele_rest::toJsonValue(m_voter_chat));
    }
    if (m_user.isSet()) {
...
OAIChat OAIPollAnswer::getVoterChat() const {
    return m_voter_chat;
}
void OAIPollAnswer::setVoterChat(const OAIChat &voter_chat) {
    m_voter_chat = voter_chat;
    m_voter_chat_isSet = true;
}

bool OAIPollAnswer::is_voter_chat_Set() const{
    return m_voter_chat_isSet;
}

bool OAIPollAnswer::is_voter_chat_Valid() const{
    return m_voter_chat_isValid;
}
...
bool OAIPollAnswer::isValid() const {
    ...
    return m_poll_id_isValid && m_option_ids_isValid && true;
}
