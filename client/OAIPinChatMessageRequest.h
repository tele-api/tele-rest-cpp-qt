...
/*
 * OAIPinChatMessageRequest.h
 *
 * Request parameters for pinChatMessage
 */

#ifndef OAIPinChatMessageRequest_H
#define OAIPinChatMessageRequest_H
...
class OAIPinChatMessageRequest : public OAIObject {
public:
    OAIPinChatMessageRequest();
    OAIPinChatMessageRequest(QString json);
    ~OAIPinChatMessageRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPinChatMessageRequest)

#endif // OAIPinChatMessageRequest_H
