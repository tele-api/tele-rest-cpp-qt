...
#ifndef OAIPaidMediaInfo_H
#define OAIPaidMediaInfo_H
...
class OAIPaidMediaInfo : public OAIObject {
public:
    OAIPaidMediaInfo();
    OAIPaidMediaInfo(QString json);
    ~OAIPaidMediaInfo() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPaidMediaInfo)

#endif // OAIPaidMediaInfo_H
