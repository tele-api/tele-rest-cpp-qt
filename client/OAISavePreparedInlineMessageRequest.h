...
/*
 * OAISavePreparedInlineMessageRequest.h
 *
 * Request parameters for savePreparedInlineMessage
 */

#ifndef OAISavePreparedInlineMessageRequest_H
#define OAISavePreparedInlineMessageRequest_H
...
class OAISavePreparedInlineMessageRequest : public OAIObject {
public:
    OAISavePreparedInlineMessageRequest();
    OAISavePreparedInlineMessageRequest(QString json);
    ~OAISavePreparedInlineMessageRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISavePreparedInlineMessageRequest)

#endif // OAISavePreparedInlineMessageRequest_H
