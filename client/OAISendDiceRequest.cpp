...
OAISendDiceRequest::OAISendDiceRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendDiceRequest::OAISendDiceRequest() {
    this->initializeModel();
}

OAISendDiceRequest::~OAISendDiceRequest() {}

void OAISendDiceRequest::initializeModel() {
...
void OAISendDiceRequest::fromJson(QString jsonString) {
...
void OAISendDiceRequest::fromJsonObject(QJsonObject json) {
...
QString OAISendDiceRequest::asJson() const {
...
QJsonObject OAISendDiceRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAISendMessageRequest_chat_id OAISendDiceRequest::getChatId() const {
    return m_chat_id;
}
void OAISendDiceRequest::setChatId(const OAISendMessageRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAISendDiceRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAISendDiceRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

QString OAISendDiceRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAISendDiceRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAISendDiceRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAISendDiceRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

qint32 OAISendDiceRequest::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAISendDiceRequest::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAISendDiceRequest::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAISendDiceRequest::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

QString OAISendDiceRequest::getEmoji() const {
    return m_emoji;
}
void OAISendDiceRequest::setEmoji(const QString &emoji) {
    m_emoji = emoji;
    m_emoji_isSet = true;
}

bool OAISendDiceRequest::is_emoji_Set() const{
    return m_emoji_isSet;
}

bool OAISendDiceRequest::is_emoji_Valid() const{
    return m_emoji_isValid;
}

bool OAISendDiceRequest::isDisableNotification() const {
    return m_disable_notification;
}
void OAISendDiceRequest::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAISendDiceRequest::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAISendDiceRequest::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAISendDiceRequest::isProtectContent() const {
    return m_protect_content;
}
void OAISendDiceRequest::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAISendDiceRequest::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAISendDiceRequest::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAISendDiceRequest::isAllowPaidBroadcast() const {
    return m_allow_paid_broadcast;
}
void OAISendDiceRequest::setAllowPaidBroadcast(const bool &allow_paid_broadcast) {
    m_allow_paid_broadcast = allow_paid_broadcast;
    m_allow_paid_broadcast_isSet = true;
}

bool OAISendDiceRequest::is_allow_paid_broadcast_Set() const{
    return m_allow_paid_broadcast_isSet;
}

bool OAISendDiceRequest::is_allow_paid_broadcast_Valid() const{
    return m_allow_paid_broadcast_isValid;
}

QString OAISendDiceRequest::getMessageEffectId() const {
    return m_message_effect_id;
}
void OAISendDiceRequest::setMessageEffectId(const QString &message_effect_id) {
    m_message_effect_id = message_effect_id;
    m_message_effect_id_isSet = true;
}

bool OAISendDiceRequest::is_message_effect_id_Set() const{
    return m_message_effect_id_isSet;
}

bool OAISendDiceRequest::is_message_effect_id_Valid() const{
    return m_message_effect_id_isValid;
}

OAIReplyParameters OAISendDiceRequest::getReplyParameters() const {
    return m_reply_parameters;
}
void OAISendDiceRequest::setReplyParameters(const OAIReplyParameters &reply_parameters) {
    m_reply_parameters = reply_parameters;
    m_reply_parameters_isSet = true;
}

bool OAISendDiceRequest::is_reply_parameters_Set() const{
    return m_reply_parameters_isSet;
}

bool OAISendDiceRequest::is_reply_parameters_Valid() const{
    return m_reply_parameters_isValid;
}

OAISendMessageRequest_reply_markup OAISendDiceRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAISendDiceRequest::setReplyMarkup(const OAISendMessageRequest_reply_markup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAISendDiceRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAISendDiceRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAISendDiceRequest::isSet() const {
...
bool OAISendDiceRequest::isValid() const {
