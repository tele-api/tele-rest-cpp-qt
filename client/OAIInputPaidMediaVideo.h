...
/*
 * OAIInputPaidMediaVideo.h
 *
 * The paid media to send is a video.
 */

#ifndef OAIInputPaidMediaVideo_H
#define OAIInputPaidMediaVideo_H
...
class OAIInputPaidMediaVideo : public OAIObject {
public:
    OAIInputPaidMediaVideo();
    OAIInputPaidMediaVideo(QString json);
    ~OAIInputPaidMediaVideo() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIInputPaidMediaVideo)

#endif // OAIInputPaidMediaVideo_H
