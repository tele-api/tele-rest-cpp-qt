...
OAI_sendMessage_post_request_reply_markup::OAI_sendMessage_post_request_reply_markup(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAI_sendMessage_post_request_reply_markup::OAI_sendMessage_post_request_reply_markup() {
    this->initializeModel();
}

OAI_sendMessage_post_request_reply_markup::~OAI_sendMessage_post_request_reply_markup() {}

void OAI_sendMessage_post_request_reply_markup::initializeModel() {
...
void OAI_sendMessage_post_request_reply_markup::fromJson(QString jsonString) {
...
void OAI_sendMessage_post_request_reply_markup::fromJsonObject(QJsonObject json) {
...
QString OAI_sendMessage_post_request_reply_markup::asJson() const {
...
QJsonObject OAI_sendMessage_post_request_reply_markup::asJsonObject() const {
    QJsonObject obj;
...
QList<QList<OAIInlineKeyboardButton>> OAI_sendMessage_post_request_reply_markup::getInlineKeyboard() const {
    return m_inline_keyboard;
}
void OAI_sendMessage_post_request_reply_markup::setInlineKeyboard(const QList<QList<OAIInlineKeyboardButton>> &inline_keyboard) {
    m_inline_keyboard = inline_keyboard;
    m_inline_keyboard_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_inline_keyboard_Set() const{
    return m_inline_keyboard_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_inline_keyboard_Valid() const{
    return m_inline_keyboard_isValid;
}

QList<QList<OAIKeyboardButton>> OAI_sendMessage_post_request_reply_markup::getKeyboard() const {
    return m_keyboard;
}
void OAI_sendMessage_post_request_reply_markup::setKeyboard(const QList<QList<OAIKeyboardButton>> &keyboard) {
    m_keyboard = keyboard;
    m_keyboard_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_keyboard_Set() const{
    return m_keyboard_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_keyboard_Valid() const{
    return m_keyboard_isValid;
}

bool OAI_sendMessage_post_request_reply_markup::isRemoveKeyboard() const {
    return m_remove_keyboard;
}
void OAI_sendMessage_post_request_reply_markup::setRemoveKeyboard(const bool &remove_keyboard) {
    m_remove_keyboard = remove_keyboard;
    m_remove_keyboard_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_remove_keyboard_Set() const{
    return m_remove_keyboard_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_remove_keyboard_Valid() const{
    return m_remove_keyboard_isValid;
}

bool OAI_sendMessage_post_request_reply_markup::isForceReply() const {
    return m_force_reply;
}
void OAI_sendMessage_post_request_reply_markup::setForceReply(const bool &force_reply) {
    m_force_reply = force_reply;
    m_force_reply_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_force_reply_Set() const{
    return m_force_reply_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_force_reply_Valid() const{
    return m_force_reply_isValid;
}

bool OAI_sendMessage_post_request_reply_markup::isIsPersistent() const {
    return m_is_persistent;
}
void OAI_sendMessage_post_request_reply_markup::setIsPersistent(const bool &is_persistent) {
    m_is_persistent = is_persistent;
    m_is_persistent_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_is_persistent_Set() const{
    return m_is_persistent_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_is_persistent_Valid() const{
    return m_is_persistent_isValid;
}

bool OAI_sendMessage_post_request_reply_markup::isResizeKeyboard() const {
    return m_resize_keyboard;
}
void OAI_sendMessage_post_request_reply_markup::setResizeKeyboard(const bool &resize_keyboard) {
    m_resize_keyboard = resize_keyboard;
    m_resize_keyboard_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_resize_keyboard_Set() const{
    return m_resize_keyboard_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_resize_keyboard_Valid() const{
    return m_resize_keyboard_isValid;
}

bool OAI_sendMessage_post_request_reply_markup::isOneTimeKeyboard() const {
    return m_one_time_keyboard;
}
void OAI_sendMessage_post_request_reply_markup::setOneTimeKeyboard(const bool &one_time_keyboard) {
    m_one_time_keyboard = one_time_keyboard;
    m_one_time_keyboard_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_one_time_keyboard_Set() const{
    return m_one_time_keyboard_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_one_time_keyboard_Valid() const{
    return m_one_time_keyboard_isValid;
}

QString OAI_sendMessage_post_request_reply_markup::getInputFieldPlaceholder() const {
    return m_input_field_placeholder;
}
void OAI_sendMessage_post_request_reply_markup::setInputFieldPlaceholder(const QString &input_field_placeholder) {
    m_input_field_placeholder = input_field_placeholder;
    m_input_field_placeholder_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_input_field_placeholder_Set() const{
    return m_input_field_placeholder_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_input_field_placeholder_Valid() const{
    return m_input_field_placeholder_isValid;
}

bool OAI_sendMessage_post_request_reply_markup::isSelective() const {
    return m_selective;
}
void OAI_sendMessage_post_request_reply_markup::setSelective(const bool &selective) {
    m_selective = selective;
    m_selective_isSet = true;
}

bool OAI_sendMessage_post_request_reply_markup::is_selective_Set() const{
    return m_selective_isSet;
}

bool OAI_sendMessage_post_request_reply_markup::is_selective_Valid() const{
    return m_selective_isValid;
}

bool OAI_sendMessage_post_request_reply_markup::isSet() const {
...
bool OAI_sendMessage_post_request_reply_markup::isValid() const {
