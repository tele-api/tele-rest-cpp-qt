...
/*
 * OAIMessageOriginChannel.h
 *
 * The message was originally sent to a channel chat.
 */

#ifndef OAIMessageOriginChannel_H
#define OAIMessageOriginChannel_H
...
class OAIMessageOriginChannel : public OAIObject {
public:
    OAIMessageOriginChannel();
    OAIMessageOriginChannel(QString json);
    ~OAIMessageOriginChannel() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIMessageOriginChannel)

#endif // OAIMessageOriginChannel_H
