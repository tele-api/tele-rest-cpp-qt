...
#include "OAIPost_forwardMessages_request.h"
...
OAIPost_forwardMessages_request::OAIPost_forwardMessages_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_forwardMessages_request::OAIPost_forwardMessages_request() {
    this->initializeModel();
}

OAIPost_forwardMessages_request::~OAIPost_forwardMessages_request() {}

void OAIPost_forwardMessages_request::initializeModel() {
...
void OAIPost_forwardMessages_request::fromJson(QString jsonString) {
...
void OAIPost_forwardMessages_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_forwardMessages_request::asJson() const {
...
QJsonObject OAIPost_forwardMessages_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_forwardMessages_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_forwardMessages_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_forwardMessages_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_forwardMessages_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

OAIPost_forwardMessages_request_from_chat_id OAIPost_forwardMessages_request::getFromChatId() const {
    return m_from_chat_id;
}
void OAIPost_forwardMessages_request::setFromChatId(const OAIPost_forwardMessages_request_from_chat_id &from_chat_id) {
    m_from_chat_id = from_chat_id;
    m_from_chat_id_isSet = true;
}

bool OAIPost_forwardMessages_request::is_from_chat_id_Set() const{
    return m_from_chat_id_isSet;
}

bool OAIPost_forwardMessages_request::is_from_chat_id_Valid() const{
    return m_from_chat_id_isValid;
}

QList<qint32> OAIPost_forwardMessages_request::getMessageIds() const {
    return m_message_ids;
}
void OAIPost_forwardMessages_request::setMessageIds(const QList<qint32> &message_ids) {
    m_message_ids = message_ids;
    m_message_ids_isSet = true;
}

bool OAIPost_forwardMessages_request::is_message_ids_Set() const{
    return m_message_ids_isSet;
}

bool OAIPost_forwardMessages_request::is_message_ids_Valid() const{
    return m_message_ids_isValid;
}

qint32 OAIPost_forwardMessages_request::getMessageThreadId() const {
    return m_message_thread_id;
}
void OAIPost_forwardMessages_request::setMessageThreadId(const qint32 &message_thread_id) {
    m_message_thread_id = message_thread_id;
    m_message_thread_id_isSet = true;
}

bool OAIPost_forwardMessages_request::is_message_thread_id_Set() const{
    return m_message_thread_id_isSet;
}

bool OAIPost_forwardMessages_request::is_message_thread_id_Valid() const{
    return m_message_thread_id_isValid;
}

bool OAIPost_forwardMessages_request::isDisableNotification() const {
    return m_disable_notification;
}
void OAIPost_forwardMessages_request::setDisableNotification(const bool &disable_notification) {
    m_disable_notification = disable_notification;
    m_disable_notification_isSet = true;
}

bool OAIPost_forwardMessages_request::is_disable_notification_Set() const{
    return m_disable_notification_isSet;
}

bool OAIPost_forwardMessages_request::is_disable_notification_Valid() const{
    return m_disable_notification_isValid;
}

bool OAIPost_forwardMessages_request::isProtectContent() const {
    return m_protect_content;
}
void OAIPost_forwardMessages_request::setProtectContent(const bool &protect_content) {
    m_protect_content = protect_content;
    m_protect_content_isSet = true;
}

bool OAIPost_forwardMessages_request::is_protect_content_Set() const{
    return m_protect_content_isSet;
}

bool OAIPost_forwardMessages_request::is_protect_content_Valid() const{
    return m_protect_content_isValid;
}

bool OAIPost_forwardMessages_request::isSet() const {
...
bool OAIPost_forwardMessages_request::isValid() const {
