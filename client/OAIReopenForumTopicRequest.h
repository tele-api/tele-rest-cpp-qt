...
/*
 * OAIReopenForumTopicRequest.h
 *
 * Request parameters for reopenForumTopic
 */

#ifndef OAIReopenForumTopicRequest_H
#define OAIReopenForumTopicRequest_H
...
class OAIReopenForumTopicRequest : public OAIObject {
public:
    OAIReopenForumTopicRequest();
    OAIReopenForumTopicRequest(QString json);
    ~OAIReopenForumTopicRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIReopenForumTopicRequest)

#endif // OAIReopenForumTopicRequest_H
