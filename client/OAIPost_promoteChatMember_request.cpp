...
#include "OAIPost_promoteChatMember_request.h"
...
OAIPost_promoteChatMember_request::OAIPost_promoteChatMember_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_promoteChatMember_request::OAIPost_promoteChatMember_request() {
    this->initializeModel();
}

OAIPost_promoteChatMember_request::~OAIPost_promoteChatMember_request() {}

void OAIPost_promoteChatMember_request::initializeModel() {
...
void OAIPost_promoteChatMember_request::fromJson(QString jsonString) {
...
void OAIPost_promoteChatMember_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_promoteChatMember_request::asJson() const {
...
QJsonObject OAIPost_promoteChatMember_request::asJsonObject() const {
    QJsonObject obj;
    if (m_chat_id.isSet()) {
...
OAIPost_sendMessage_request_chat_id OAIPost_promoteChatMember_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_promoteChatMember_request::setChatId(const OAIPost_sendMessage_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_promoteChatMember_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIPost_promoteChatMember_request::getUserId() const {
    return m_user_id;
}
void OAIPost_promoteChatMember_request::setUserId(const qint32 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIPost_promoteChatMember_request::is_user_id_Valid() const{
    return m_user_id_isValid;
}

bool OAIPost_promoteChatMember_request::isIsAnonymous() const {
    return m_is_anonymous;
}
void OAIPost_promoteChatMember_request::setIsAnonymous(const bool &is_anonymous) {
    m_is_anonymous = is_anonymous;
    m_is_anonymous_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_is_anonymous_Set() const{
    return m_is_anonymous_isSet;
}

bool OAIPost_promoteChatMember_request::is_is_anonymous_Valid() const{
    return m_is_anonymous_isValid;
}

bool OAIPost_promoteChatMember_request::isCanManageChat() const {
    return m_can_manage_chat;
}
void OAIPost_promoteChatMember_request::setCanManageChat(const bool &can_manage_chat) {
    m_can_manage_chat = can_manage_chat;
    m_can_manage_chat_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_manage_chat_Set() const{
    return m_can_manage_chat_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_manage_chat_Valid() const{
    return m_can_manage_chat_isValid;
}

bool OAIPost_promoteChatMember_request::isCanDeleteMessages() const {
    return m_can_delete_messages;
}
void OAIPost_promoteChatMember_request::setCanDeleteMessages(const bool &can_delete_messages) {
    m_can_delete_messages = can_delete_messages;
    m_can_delete_messages_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_delete_messages_Set() const{
    return m_can_delete_messages_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_delete_messages_Valid() const{
    return m_can_delete_messages_isValid;
}

bool OAIPost_promoteChatMember_request::isCanManageVideoChats() const {
    return m_can_manage_video_chats;
}
void OAIPost_promoteChatMember_request::setCanManageVideoChats(const bool &can_manage_video_chats) {
    m_can_manage_video_chats = can_manage_video_chats;
    m_can_manage_video_chats_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_manage_video_chats_Set() const{
    return m_can_manage_video_chats_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_manage_video_chats_Valid() const{
    return m_can_manage_video_chats_isValid;
}

bool OAIPost_promoteChatMember_request::isCanRestrictMembers() const {
    return m_can_restrict_members;
}
void OAIPost_promoteChatMember_request::setCanRestrictMembers(const bool &can_restrict_members) {
    m_can_restrict_members = can_restrict_members;
    m_can_restrict_members_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_restrict_members_Set() const{
    return m_can_restrict_members_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_restrict_members_Valid() const{
    return m_can_restrict_members_isValid;
}

bool OAIPost_promoteChatMember_request::isCanPromoteMembers() const {
    return m_can_promote_members;
}
void OAIPost_promoteChatMember_request::setCanPromoteMembers(const bool &can_promote_members) {
    m_can_promote_members = can_promote_members;
    m_can_promote_members_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_promote_members_Set() const{
    return m_can_promote_members_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_promote_members_Valid() const{
    return m_can_promote_members_isValid;
}

bool OAIPost_promoteChatMember_request::isCanChangeInfo() const {
    return m_can_change_info;
}
void OAIPost_promoteChatMember_request::setCanChangeInfo(const bool &can_change_info) {
    m_can_change_info = can_change_info;
    m_can_change_info_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_change_info_Set() const{
    return m_can_change_info_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_change_info_Valid() const{
    return m_can_change_info_isValid;
}

bool OAIPost_promoteChatMember_request::isCanInviteUsers() const {
    return m_can_invite_users;
}
void OAIPost_promoteChatMember_request::setCanInviteUsers(const bool &can_invite_users) {
    m_can_invite_users = can_invite_users;
    m_can_invite_users_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_invite_users_Set() const{
    return m_can_invite_users_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_invite_users_Valid() const{
    return m_can_invite_users_isValid;
}

bool OAIPost_promoteChatMember_request::isCanPostStories() const {
    return m_can_post_stories;
}
void OAIPost_promoteChatMember_request::setCanPostStories(const bool &can_post_stories) {
    m_can_post_stories = can_post_stories;
    m_can_post_stories_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_post_stories_Set() const{
    return m_can_post_stories_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_post_stories_Valid() const{
    return m_can_post_stories_isValid;
}

bool OAIPost_promoteChatMember_request::isCanEditStories() const {
    return m_can_edit_stories;
}
void OAIPost_promoteChatMember_request::setCanEditStories(const bool &can_edit_stories) {
    m_can_edit_stories = can_edit_stories;
    m_can_edit_stories_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_edit_stories_Set() const{
    return m_can_edit_stories_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_edit_stories_Valid() const{
    return m_can_edit_stories_isValid;
}

bool OAIPost_promoteChatMember_request::isCanDeleteStories() const {
    return m_can_delete_stories;
}
void OAIPost_promoteChatMember_request::setCanDeleteStories(const bool &can_delete_stories) {
    m_can_delete_stories = can_delete_stories;
    m_can_delete_stories_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_delete_stories_Set() const{
    return m_can_delete_stories_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_delete_stories_Valid() const{
    return m_can_delete_stories_isValid;
}

bool OAIPost_promoteChatMember_request::isCanPostMessages() const {
    return m_can_post_messages;
}
void OAIPost_promoteChatMember_request::setCanPostMessages(const bool &can_post_messages) {
    m_can_post_messages = can_post_messages;
    m_can_post_messages_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_post_messages_Set() const{
    return m_can_post_messages_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_post_messages_Valid() const{
    return m_can_post_messages_isValid;
}

bool OAIPost_promoteChatMember_request::isCanEditMessages() const {
    return m_can_edit_messages;
}
void OAIPost_promoteChatMember_request::setCanEditMessages(const bool &can_edit_messages) {
    m_can_edit_messages = can_edit_messages;
    m_can_edit_messages_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_edit_messages_Set() const{
    return m_can_edit_messages_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_edit_messages_Valid() const{
    return m_can_edit_messages_isValid;
}

bool OAIPost_promoteChatMember_request::isCanPinMessages() const {
    return m_can_pin_messages;
}
void OAIPost_promoteChatMember_request::setCanPinMessages(const bool &can_pin_messages) {
    m_can_pin_messages = can_pin_messages;
    m_can_pin_messages_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_pin_messages_Set() const{
    return m_can_pin_messages_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_pin_messages_Valid() const{
    return m_can_pin_messages_isValid;
}

bool OAIPost_promoteChatMember_request::isCanManageTopics() const {
    return m_can_manage_topics;
}
void OAIPost_promoteChatMember_request::setCanManageTopics(const bool &can_manage_topics) {
    m_can_manage_topics = can_manage_topics;
    m_can_manage_topics_isSet = true;
}

bool OAIPost_promoteChatMember_request::is_can_manage_topics_Set() const{
    return m_can_manage_topics_isSet;
}

bool OAIPost_promoteChatMember_request::is_can_manage_topics_Valid() const{
    return m_can_manage_topics_isValid;
}

bool OAIPost_promoteChatMember_request::isSet() const {
...
bool OAIPost_promoteChatMember_request::isValid() const {
