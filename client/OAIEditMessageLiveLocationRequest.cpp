...
#include "OAIEditMessageLiveLocationRequest.h"
...
OAIEditMessageLiveLocationRequest::OAIEditMessageLiveLocationRequest(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEditMessageLiveLocationRequest::OAIEditMessageLiveLocationRequest() {
    this->initializeModel();
}

OAIEditMessageLiveLocationRequest::~OAIEditMessageLiveLocationRequest() {}

void OAIEditMessageLiveLocationRequest::initializeModel() {
...
void OAIEditMessageLiveLocationRequest::fromJson(QString jsonString) {
...
void OAIEditMessageLiveLocationRequest::fromJsonObject(QJsonObject json) {
...
QString OAIEditMessageLiveLocationRequest::asJson() const {
...
QJsonObject OAIEditMessageLiveLocationRequest::asJsonObject() const {
    QJsonObject obj;
    if (m_latitude_isSet) {
...
double OAIEditMessageLiveLocationRequest::getLatitude() const {
    return m_latitude;
}
void OAIEditMessageLiveLocationRequest::setLatitude(const double &latitude) {
    m_latitude = latitude;
    m_latitude_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_latitude_Set() const{
    return m_latitude_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_latitude_Valid() const{
    return m_latitude_isValid;
}

double OAIEditMessageLiveLocationRequest::getLongitude() const {
    return m_longitude;
}
void OAIEditMessageLiveLocationRequest::setLongitude(const double &longitude) {
    m_longitude = longitude;
    m_longitude_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_longitude_Set() const{
    return m_longitude_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_longitude_Valid() const{
    return m_longitude_isValid;
}

QString OAIEditMessageLiveLocationRequest::getBusinessConnectionId() const {
    return m_business_connection_id;
}
void OAIEditMessageLiveLocationRequest::setBusinessConnectionId(const QString &business_connection_id) {
    m_business_connection_id = business_connection_id;
    m_business_connection_id_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_business_connection_id_Set() const{
    return m_business_connection_id_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_business_connection_id_Valid() const{
    return m_business_connection_id_isValid;
}

OAIEditMessageTextRequest_chat_id OAIEditMessageLiveLocationRequest::getChatId() const {
    return m_chat_id;
}
void OAIEditMessageLiveLocationRequest::setChatId(const OAIEditMessageTextRequest_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

qint32 OAIEditMessageLiveLocationRequest::getMessageId() const {
    return m_message_id;
}
void OAIEditMessageLiveLocationRequest::setMessageId(const qint32 &message_id) {
    m_message_id = message_id;
    m_message_id_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_message_id_Set() const{
    return m_message_id_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_message_id_Valid() const{
    return m_message_id_isValid;
}

QString OAIEditMessageLiveLocationRequest::getInlineMessageId() const {
    return m_inline_message_id;
}
void OAIEditMessageLiveLocationRequest::setInlineMessageId(const QString &inline_message_id) {
    m_inline_message_id = inline_message_id;
    m_inline_message_id_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_inline_message_id_Set() const{
    return m_inline_message_id_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_inline_message_id_Valid() const{
    return m_inline_message_id_isValid;
}

qint32 OAIEditMessageLiveLocationRequest::getLivePeriod() const {
    return m_live_period;
}
void OAIEditMessageLiveLocationRequest::setLivePeriod(const qint32 &live_period) {
    m_live_period = live_period;
    m_live_period_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_live_period_Set() const{
    return m_live_period_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_live_period_Valid() const{
    return m_live_period_isValid;
}

double OAIEditMessageLiveLocationRequest::getHorizontalAccuracy() const {
    return m_horizontal_accuracy;
}
void OAIEditMessageLiveLocationRequest::setHorizontalAccuracy(const double &horizontal_accuracy) {
    m_horizontal_accuracy = horizontal_accuracy;
    m_horizontal_accuracy_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_horizontal_accuracy_Set() const{
    return m_horizontal_accuracy_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_horizontal_accuracy_Valid() const{
    return m_horizontal_accuracy_isValid;
}

qint32 OAIEditMessageLiveLocationRequest::getHeading() const {
    return m_heading;
}
void OAIEditMessageLiveLocationRequest::setHeading(const qint32 &heading) {
    m_heading = heading;
    m_heading_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_heading_Set() const{
    return m_heading_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_heading_Valid() const{
    return m_heading_isValid;
}

qint32 OAIEditMessageLiveLocationRequest::getProximityAlertRadius() const {
    return m_proximity_alert_radius;
}
void OAIEditMessageLiveLocationRequest::setProximityAlertRadius(const qint32 &proximity_alert_radius) {
    m_proximity_alert_radius = proximity_alert_radius;
    m_proximity_alert_radius_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_proximity_alert_radius_Set() const{
    return m_proximity_alert_radius_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_proximity_alert_radius_Valid() const{
    return m_proximity_alert_radius_isValid;
}

OAIInlineKeyboardMarkup OAIEditMessageLiveLocationRequest::getReplyMarkup() const {
    return m_reply_markup;
}
void OAIEditMessageLiveLocationRequest::setReplyMarkup(const OAIInlineKeyboardMarkup &reply_markup) {
    m_reply_markup = reply_markup;
    m_reply_markup_isSet = true;
}

bool OAIEditMessageLiveLocationRequest::is_reply_markup_Set() const{
    return m_reply_markup_isSet;
}

bool OAIEditMessageLiveLocationRequest::is_reply_markup_Valid() const{
    return m_reply_markup_isValid;
}

bool OAIEditMessageLiveLocationRequest::isSet() const {
...
bool OAIEditMessageLiveLocationRequest::isValid() const {
