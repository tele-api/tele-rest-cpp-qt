...
/*
 * OAI_editMessageReplyMarkup_post_request.h
 *
 * 
 */

#ifndef OAI_editMessageReplyMarkup_post_request_H
#define OAI_editMessageReplyMarkup_post_request_H
...
class OAI_editMessageReplyMarkup_post_request : public OAIObject {
public:
    OAI_editMessageReplyMarkup_post_request();
    OAI_editMessageReplyMarkup_post_request(QString json);
    ~OAI_editMessageReplyMarkup_post_request() override;
    ...
    OAI_editMessageText_post_request_chat_id getChatId() const;
    void setChatId(const OAI_editMessageText_post_request_chat_id &chat_id);
...
private:
    ...
    OAI_editMessageText_post_request_chat_id m_chat_id;
...
Q_DECLARE_METATYPE(tele_rest::OAI_editMessageReplyMarkup_post_request)

#endif // OAI_editMessageReplyMarkup_post_request_H
