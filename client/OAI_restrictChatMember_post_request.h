...
/*
 * OAI_restrictChatMember_post_request.h
 *
 * 
 */

#ifndef OAI_restrictChatMember_post_request_H
#define OAI_restrictChatMember_post_request_H
...
class OAI_restrictChatMember_post_request : public OAIObject {
public:
    OAI_restrictChatMember_post_request();
    OAI_restrictChatMember_post_request(QString json);
    ~OAI_restrictChatMember_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_restrictChatMember_post_request)

#endif // OAI_restrictChatMember_post_request_H
