...
/*
 * OAI_stopPoll_post_request.h
 *
 * 
 */

#ifndef OAI_stopPoll_post_request_H
#define OAI_stopPoll_post_request_H
...
class OAI_stopPoll_post_request : public OAIObject {
public:
    OAI_stopPoll_post_request();
    OAI_stopPoll_post_request(QString json);
    ~OAI_stopPoll_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_stopPoll_post_request)

#endif // OAI_stopPoll_post_request_H
