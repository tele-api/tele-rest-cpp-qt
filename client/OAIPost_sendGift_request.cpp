...
#include "OAIPost_sendGift_request.h"
...
OAIPost_sendGift_request::OAIPost_sendGift_request(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIPost_sendGift_request::OAIPost_sendGift_request() {
    this->initializeModel();
}

OAIPost_sendGift_request::~OAIPost_sendGift_request() {}

void OAIPost_sendGift_request::initializeModel() {
...
void OAIPost_sendGift_request::fromJson(QString jsonString) {
...
void OAIPost_sendGift_request::fromJsonObject(QJsonObject json) {
...
QString OAIPost_sendGift_request::asJson() const {
...
QJsonObject OAIPost_sendGift_request::asJsonObject() const {
    QJsonObject obj;
    if (m_gift_id_isSet) {
...
QString OAIPost_sendGift_request::getGiftId() const {
    return m_gift_id;
}
void OAIPost_sendGift_request::setGiftId(const QString &gift_id) {
    m_gift_id = gift_id;
    m_gift_id_isSet = true;
}

bool OAIPost_sendGift_request::is_gift_id_Set() const{
    return m_gift_id_isSet;
}

bool OAIPost_sendGift_request::is_gift_id_Valid() const{
    return m_gift_id_isValid;
}

qint32 OAIPost_sendGift_request::getUserId() const {
    return m_user_id;
}
void OAIPost_sendGift_request::setUserId(const qint32 &user_id) {
    m_user_id = user_id;
    m_user_id_isSet = true;
}

bool OAIPost_sendGift_request::is_user_id_Set() const{
    return m_user_id_isSet;
}

bool OAIPost_sendGift_request::is_user_id_Valid() const{
    return m_user_id_isValid;
}

OAIPost_sendGift_request_chat_id OAIPost_sendGift_request::getChatId() const {
    return m_chat_id;
}
void OAIPost_sendGift_request::setChatId(const OAIPost_sendGift_request_chat_id &chat_id) {
    m_chat_id = chat_id;
    m_chat_id_isSet = true;
}

bool OAIPost_sendGift_request::is_chat_id_Set() const{
    return m_chat_id_isSet;
}

bool OAIPost_sendGift_request::is_chat_id_Valid() const{
    return m_chat_id_isValid;
}

bool OAIPost_sendGift_request::isPayForUpgrade() const {
    return m_pay_for_upgrade;
}
void OAIPost_sendGift_request::setPayForUpgrade(const bool &pay_for_upgrade) {
    m_pay_for_upgrade = pay_for_upgrade;
    m_pay_for_upgrade_isSet = true;
}

bool OAIPost_sendGift_request::is_pay_for_upgrade_Set() const{
    return m_pay_for_upgrade_isSet;
}

bool OAIPost_sendGift_request::is_pay_for_upgrade_Valid() const{
    return m_pay_for_upgrade_isValid;
}

QString OAIPost_sendGift_request::getText() const {
    return m_text;
}
void OAIPost_sendGift_request::setText(const QString &text) {
    m_text = text;
    m_text_isSet = true;
}

bool OAIPost_sendGift_request::is_text_Set() const{
    return m_text_isSet;
}

bool OAIPost_sendGift_request::is_text_Valid() const{
    return m_text_isValid;
}

QString OAIPost_sendGift_request::getTextParseMode() const {
    return m_text_parse_mode;
}
void OAIPost_sendGift_request::setTextParseMode(const QString &text_parse_mode) {
    m_text_parse_mode = text_parse_mode;
    m_text_parse_mode_isSet = true;
}

bool OAIPost_sendGift_request::is_text_parse_mode_Set() const{
    return m_text_parse_mode_isSet;
}

bool OAIPost_sendGift_request::is_text_parse_mode_Valid() const{
    return m_text_parse_mode_isValid;
}

QList<OAIMessageEntity> OAIPost_sendGift_request::getTextEntities() const {
    return m_text_entities;
}
void OAIPost_sendGift_request::setTextEntities(const QList<OAIMessageEntity> &text_entities) {
    m_text_entities = text_entities;
    m_text_entities_isSet = true;
}

bool OAIPost_sendGift_request::is_text_entities_Set() const{
    return m_text_entities_isSet;
}

bool OAIPost_sendGift_request::is_text_entities_Valid() const{
    return m_text_entities_isValid;
}

bool OAIPost_sendGift_request::isSet() const {
...
bool OAIPost_sendGift_request::isValid() const {
