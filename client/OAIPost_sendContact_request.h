...
/*
 * OAIPost_sendContact_request.h
 *
 * 
 */

#ifndef OAIPost_sendContact_request_H
#define OAIPost_sendContact_request_H
...
class OAIPost_sendContact_request : public OAIObject {
public:
    OAIPost_sendContact_request();
    OAIPost_sendContact_request(QString json);
    ~OAIPost_sendContact_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_sendContact_request)

#endif // OAIPost_sendContact_request_H
