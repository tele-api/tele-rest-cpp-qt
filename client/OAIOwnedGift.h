...
#ifndef OAIOwnedGift_H
#define OAIOwnedGift_H
...
class OAIOwnedGift : public OAIObject {
public:
    OAIOwnedGift();
    OAIOwnedGift(QString json);
    ~OAIOwnedGift() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIOwnedGift)

#endif // OAIOwnedGift_H
