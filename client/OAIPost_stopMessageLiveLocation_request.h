...
/*
 * OAIPost_stopMessageLiveLocation_request.h
 *
 * 
 */

#ifndef OAIPost_stopMessageLiveLocation_request_H
#define OAIPost_stopMessageLiveLocation_request_H
...
class OAIPost_stopMessageLiveLocation_request : public OAIObject {
public:
    OAIPost_stopMessageLiveLocation_request();
    OAIPost_stopMessageLiveLocation_request(QString json);
    ~OAIPost_stopMessageLiveLocation_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_stopMessageLiveLocation_request)

#endif // OAIPost_stopMessageLiveLocation_request_H
