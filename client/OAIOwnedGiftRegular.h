...
/*
 * OAIOwnedGiftRegular.h
 *
 * Describes a regular gift owned by a user or a chat.
 */

#ifndef OAIOwnedGiftRegular_H
#define OAIOwnedGiftRegular_H
...
class OAIOwnedGiftRegular : public OAIObject {
public:
    OAIOwnedGiftRegular();
    OAIOwnedGiftRegular(QString json);
    ~OAIOwnedGiftRegular() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIOwnedGiftRegular)

#endif // OAIOwnedGiftRegular_H
