...
#ifndef OAIMaybeInaccessibleMessage_H
#define OAIMaybeInaccessibleMessage_H
...
class OAIMaybeInaccessibleMessage : public OAIObject {
public:
    OAIMaybeInaccessibleMessage();
    OAIMaybeInaccessibleMessage(QString json);
    ~OAIMaybeInaccessibleMessage() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIMaybeInaccessibleMessage)

#endif // OAIMaybeInaccessibleMessage_H
