...
/*
 * OAISendContactRequest.h
 *
 * Request parameters for sendContact
 */

#ifndef OAISendContactRequest_H
#define OAISendContactRequest_H
...
class OAISendContactRequest : public OAIObject {
public:
    OAISendContactRequest();
    OAISendContactRequest(QString json);
    ~OAISendContactRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendContactRequest)

#endif // OAISendContactRequest_H
