...
/*
 * OAI_readBusinessMessage_post_request.h
 *
 * 
 */

#ifndef OAI_readBusinessMessage_post_request_H
#define OAI_readBusinessMessage_post_request_H
...
class OAI_readBusinessMessage_post_request : public OAIObject {
public:
    OAI_readBusinessMessage_post_request();
    OAI_readBusinessMessage_post_request(QString json);
    ~OAI_readBusinessMessage_post_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAI_readBusinessMessage_post_request)

#endif // OAI_readBusinessMessage_post_request_H
