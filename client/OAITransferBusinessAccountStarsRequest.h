...
/*
 * OAITransferBusinessAccountStarsRequest.h
 *
 * Request parameters for transferBusinessAccountStars
 */

#ifndef OAITransferBusinessAccountStarsRequest_H
#define OAITransferBusinessAccountStarsRequest_H
...
class OAITransferBusinessAccountStarsRequest : public OAIObject {
public:
    OAITransferBusinessAccountStarsRequest();
    OAITransferBusinessAccountStarsRequest(QString json);
    ~OAITransferBusinessAccountStarsRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAITransferBusinessAccountStarsRequest)

#endif // OAITransferBusinessAccountStarsRequest_H
