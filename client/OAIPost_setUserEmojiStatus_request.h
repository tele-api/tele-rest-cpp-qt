...
/*
 * OAIPost_setUserEmojiStatus_request.h
 *
 * 
 */

#ifndef OAIPost_setUserEmojiStatus_request_H
#define OAIPost_setUserEmojiStatus_request_H
...
class OAIPost_setUserEmojiStatus_request : public OAIObject {
public:
    OAIPost_setUserEmojiStatus_request();
    OAIPost_setUserEmojiStatus_request(QString json);
    ~OAIPost_setUserEmojiStatus_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_setUserEmojiStatus_request)

#endif // OAIPost_setUserEmojiStatus_request_H
