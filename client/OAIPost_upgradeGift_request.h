...
/*
 * OAIPost_upgradeGift_request.h
 *
 * 
 */

#ifndef OAIPost_upgradeGift_request_H
#define OAIPost_upgradeGift_request_H
...
class OAIPost_upgradeGift_request : public OAIObject {
public:
    OAIPost_upgradeGift_request();
    OAIPost_upgradeGift_request(QString json);
    ~OAIPost_upgradeGift_request() override;
...
Q_DECLARE_METATYPE(tele_rest::OAIPost_upgradeGift_request)

#endif // OAIPost_upgradeGift_request_H
