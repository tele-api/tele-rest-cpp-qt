...
/*
 * OAISendVenueRequest.h
 *
 * Request parameters for sendVenue
 */

#ifndef OAISendVenueRequest_H
#define OAISendVenueRequest_H
...
class OAISendVenueRequest : public OAIObject {
public:
    OAISendVenueRequest();
    OAISendVenueRequest(QString json);
    ~OAISendVenueRequest() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISendVenueRequest)

#endif // OAISendVenueRequest_H
