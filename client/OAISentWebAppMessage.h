...
class OAISentWebAppMessage : public OAIObject {
public:
    OAISentWebAppMessage();
    OAISentWebAppMessage(QString json);
    ~OAISentWebAppMessage() override;
...
Q_DECLARE_METATYPE(tele_rest::OAISentWebAppMessage)

#endif // OAISentWebAppMessage_H
